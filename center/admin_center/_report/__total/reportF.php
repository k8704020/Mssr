...
//-------------------------------------------------------
    ...
    //啟用ajax設置
        ...
        for(key in arrys_class_code){
            ...
            ////學生閱讀登記平均本數
            //ajax($url,$type,$datatype,'s_read_group',class_code);
            //
            ////學生推薦平均本數
            //ajax($url,$type,$datatype,'s_rec_group',class_code);
            ...
            ////家長推薦總本數
            //ajax($url,$type,$datatype,'f_rec_group',class_code);
            //
            ////家長有推薦本的人數
            //ajax($url,$type,$datatype,'f_rec_cno',class_code);
        }
