...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['a']['query']['m_forum_use_analysis']['filter']        查詢條件式
    //$_SESSION['a']['query']['m_forum_use_analysis']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['a']['query']['m_forum_use_analysis']['query_fields']=$query_fields;
        $_SESSION['a']['query']['m_forum_use_analysis']['filter']=$filter;

        if(1==2){//除錯用
            echo $_SESSION['a']['query']['m_forum_use_analysis']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['a']['query']['m_forum_use_analysis']['query_fields']);
            echo "</pre>";
            die();
        }
