...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $year=date("Y");
            $query_year=(isset($_SESSION['a']['query']['m_forum_analysis']['query_year']))?(int)$_SESSION['a']['query']['m_forum_analysis']['query_year']:(int)date("Y");
...
<Head>
    ...
    <div id="header">
        ...
        <ul id="navbar">
            <li><a href="#" class="current"><span>聊書使用分析(非活耀)&nbsp;</span></a></li>
                            ...
                            <tr>
                                <td align="left" valign="middle" class="menu_dot">
                                    <span class="menu_cont">
                                        ...
                                        <span class="fc_gray0" style="margin:0 3px;">&gt;&gt;</span>
                                        <a href="javascript:void(0);">聊書使用分析(非活耀)</a>
                                    </span>
                                </td>
                            </tr>
                        </table>
