...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        if(isset($_SESSION['a']['query']['m_user_member_analysis']['filter'])){
            $filter=trim($_SESSION['a']['query']['m_user_member_analysis']['filter']);
        }
        if(isset($_SESSION['a']['query']['m_user_member_analysis']['query_fields'])){
            $query_fields=$_SESSION['a']['query']['m_user_member_analysis']['query_fields'];
        }
        //echo "<Pre>";
        //print_r($filter);
        //echo "</Pre>";
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        $query_year=(isset($_SESSION['a']['query']['m_user_member_analysis']['query_year']))?(int)$_SESSION['a']['query']['m_user_member_analysis']['query_year']:(int)date("Y");
        $total=0;
        ...
        foreach($db_results as $db_result){
            ...
            $total        =$total+$rs_cno;
            $arry_build_time_info[$rs_build_time]=$total;
        }
        ...
        <td width="80%" height="300px" align="center" valign="top">
            ...
            <table align="center" border="1" width="100%" class="table_style9" style="position:relative;margin-top:30px;">
                <tr align="center" class="bg_gray1" height="45px">
                    <td>目前星球共有<span style="color:red;font-size:18pt;"> <?php echo $total;?> </span>個帳號</td>
                </tr>
