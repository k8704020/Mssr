...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        if(isset($_SESSION['a']['query']['m_all_sys_analysis']['filter'])){
            $filter=trim($_SESSION['a']['query']['m_all_sys_analysis']['filter']);
        }
        if(isset($_SESSION['a']['query']['m_all_sys_analysis']['query_fields'])){
            $query_fields=$_SESSION['a']['query']['m_all_sys_analysis']['query_fields'];
        }
        //echo "<Pre>";
        //print_r($filter);
        //echo "</Pre>";
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        $query_year_start=(isset($_SESSION['a']['query']['m_all_sys_analysis']['query_year_start']))?(int)$_SESSION['a']['query']['m_all_sys_analysis']['query_year_start']:(int)date("Y");
        $query_month_start=(isset($_SESSION['a']['query']['m_all_sys_analysis']['query_month_start']))?(int)$_SESSION['a']['query']['m_all_sys_analysis']['query_month_start']:(int)date("m");
        $query_year_end=(isset($_SESSION['a']['query']['m_all_sys_analysis']['query_year_end']))?(int)$_SESSION['a']['query']['m_all_sys_analysis']['query_year_end']:(int)date("Y");
        $query_month_end=(isset($_SESSION['a']['query']['m_all_sys_analysis']['query_month_end']))?(int)$_SESSION['a']['query']['m_all_sys_analysis']['query_month_end']:(int)date("m");
