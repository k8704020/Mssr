...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $year=date("Y");
            $query_year=(isset($_SESSION['a']['query']['m_all_sys_analysis']['query_year']))?(int)$_SESSION['a']['query']['m_all_sys_analysis']['query_year']:(int)date("Y");
...
<Head>
    ...
    <div id="header">
        ...
        <ul id="navbar">
            <li><a href="#" class="current"><span>全系統使用分析(非活耀)&nbsp;</span></a></li>
                            ...
                            <tr>
                                <td align="left" valign="middle" class="menu_dot">
                                    <span class="menu_cont">
                                        ...
                                        <span class="fc_gray0" style="margin:0 3px;">&gt;&gt;</span>
                                        <a href="javascript:void(0);">全系統使用分析(非活耀)</a>
                                    </span>
                                </td>
                            </tr>
                        </table>
