...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $year=date("Y");
            $query_year=(isset($_SESSION['a']['query']['m_bookstore_analysis']['query_year']))?(int)$_SESSION['a']['query']['m_bookstore_analysis']['query_year']:(int)date("Y");
...
<Head>
    ...
    <div id="header">
        ...
        <ul id="navbar">
            <li><a href="#" class="current"><span>閱讀使用分析(非活耀)&nbsp;</span></a></li>
        ...
        <table id="datalist_tbl" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left" valign="middle" width="317px">
                    <!-- 路徑選單 開始 -->
                    <div id="center_path">
                        <table id="center_path_cont" border="0" width="400px">
                            <tr>
                                <td align="left" valign="middle" class="menu_dot">
                                    <span class="menu_cont">
                                        ...
                                        <span class="fc_gray0" style="margin:0 3px;">&gt;&gt;</span>
                                        <a href="javascript:void(0);">閱讀使用分析(非活耀)</a>
                                    </span>
                                </td>
                            </tr>
                        </table>
                ...
                <!-- 查詢模式 開始 -->
                <td width='425px' align="center" valign="middle" class='fc_blue0'>
                ...
                <td align="right" valign="middle">
                    ...
                    起始：
                    <select class="form_select year_start" style="position:relative;">
                    ...
                    <select class="form_select month_start" style="position:relative;">
                        <option value="0" readonly>請選擇月份
                        <?php for($i=1; $i<=12;$i++):?>
                            <option value="<?php echo $i;?>"><?php echo $i;?>
                        <?php endfor;?>
                    </select>
                    ...
                    終止：
                    <select class="form_select year_end" style="position:relative;">
                        <option value="0" readonly>請選擇年份
                        <?php for($i=$year; $i>=2013;$i--):?>
                            <option value="<?php echo $i;?>"><?php echo $i;?>
                        <?php endfor;?>
                    ...
                    <select class="form_select month_end" style="position:relative;"
                    onchange="sel_month();void(0);">
                        <option value="0" readonly>請選擇月份
                        <?php for($i=1; $i<=12;$i++):?>
                            <option value="<?php echo $i;?>"><?php echo $i;?>
                        <?php endfor;?>
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        function sel_month(){
            ...
            var month_start=parseInt($('.month_start').val());
            var month_end  =parseInt($('.month_end').val());
