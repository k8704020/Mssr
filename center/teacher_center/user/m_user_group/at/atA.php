    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                //一組人數
                $size=ceil(count($arrys_user)/count($arrys_group));
                $arrys_user=array_chunk($arrys_user,$size);

                foreach($arrys_group as $inx=>$arry_group){
                    $arrys_group_user[$arry_group]=$arrys_user[$inx];
                }

                foreach($arrys_group_user as $inx1=>$arry_group_user){
                    foreach($arry_group_user as $inx2=>$user_id){
                        $new_arrys_group_user[][$inx1]=$user_id;
                    }
                }
