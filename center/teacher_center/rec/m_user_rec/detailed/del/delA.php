...
//-------------------------------------------------------
    ...
    //date_filter       時間條件
        ...
        //初始化, 是否有評論得錢
        $has_coin=false;
        if(isset($_GET['comment_coin'])){
            $_GET['comment_coin']=trim($_GET['comment_coin']);
            $has_coin=true;
        }
    ...
    //date_filter       時間條件
        ...
        $comment_type   =trim($_GET[trim('comment_type     ')]);
        $comment_content=trim($_GET[trim('comment_content  ')]);
        $comment_score  =trim($_GET[trim('comment_score    ')]);
        $has_del_rec    =trim($_GET[trim('has_del_rec      ')]);
        ...
        if(isset($_GET[trim('date_filter')])){
            ...
            if(!in_array($date_filter,array("today","three_day","one_week","two_week"))){
                $date_filter='';
            }
        }else{
            $date_filter='';
