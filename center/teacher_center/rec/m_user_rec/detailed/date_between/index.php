...
//-------------------------------------------------------
    ...
    //date_filter   時間條件
        ...
        $abnormal    =(isset($_GET[trim('abnormal')]))?1:0;
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            //連結路徑
            $sys_url ="";
            $sys_page=str_repeat("../",4)."index.php";
            $sys_arg =array(
        ...
        <div id="content_bottom">
            <table id="teacher_datalist_tbl" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="2">
                        <!-- 資料列表 開始 -->
                        <iframe id="IFC" name="IFC" src="content.php?date_filter=<?php echo $date_filter;?>&semester_start=<?php echo $get_semester_start;?>&semester_end=<?php echo $get_semester_end;?>&abnormal=<?php echo $abnormal;?>" frameborder="0"
...
<!-- 切換身份區塊 開始 -->
<div id="choose_identity">
<?php //echo choose_identity($rd=4);?>
</div>
<!-- 切換身份區塊 結束 -->

<!-- 切換班級區塊 開始 -->
<div id="choose_class_code">
<?php //echo choose_class_code($rd=4);?>
</div>
<!-- 切換班級區塊 結束 -->
