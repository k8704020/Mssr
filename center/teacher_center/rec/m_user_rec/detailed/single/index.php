    ...
    <div id="content">
        ...
        <div id="content_top">
            ...
            <div id="logo">
                明日書店
                <span id="logo_min">
                    <span class="fc_blue0"><?php echo htmlspecialchars($rs_user_name);?></span>
        ...
        <div id="content_bottom">
            <table id="teacher_datalist_tbl" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="2">
                        <!-- 資料列表 開始 -->
                        <iframe id="IFC" name="IFC" src="content.php?user_id=<?php echo $user_id;?>" frameborder="0"
                        style="width:100%;height:1000px;overflow:hidden;overflow-y:auto"></iframe>
                        <!-- 資料列表 結束 -->
                    </td>
                </tr>
            </table>
