...
<form id='Form1' name='Form1' method='post' onsubmit="return false;">
    <table align="center" border="0" width="550px" class="table_style0" style="position:relative;top:30px;">
        ...
        <tr class="fc_gray0">
            ...
            <td class="gr_dashed">
                <input type="text" id="book_donor" name="book_donor" value="" size="10" maxlength="10"
                tabindex="8" class="form_text" style="width:250px">
            </td>
        </tr>
        ...
        <tr>
            <td align="right" colspan="2">
                ...
                <input type="hidden" id="book_no" name="book_no" value="" size="10" maxlength="30" class="form_text" style="width:250px;">
...
//-------------------------------------------------------
    ...
    db_txt('book_no',(int)$rs_book_no,$arry_op=array('readonly'=>1,'disabled'=>0));
    ...
    db_txt('book_donor',trim($rs_book_donor),$arry_op=array('readonly'=>0,'disabled'=>0));
?>
<script type="text/javascript">
//-------------------------------------------------------
//頁面初始
//-------------------------------------------------------
    ...
    //送出
        ...
        if((trim(obook_isbn_10.value)==='')&&(trim(obook_isbn_13.value)==='')){
            arry_err.push('請輸入正確的ISBN10碼, 或是ISBN13碼, 其中一項!');
        }
        ...
        if(arry_err.length!=0){
            ...
            if(confirm('若修改了ISBN10碼, 或是ISBN13碼,請確認過書籍上的條碼也是正確的, 你確定要修改嗎?')){
