    ...
    <table align="center" border="0" width="525px" class="table_style0" style="position:relative;top:30px;">
        ...
        <tr class="fc_gray0">
            ...
            <td class="b_line gr_dashed">
                ...
                tabindex="1" class="form_text" style="width:150px"><!-- <br/><br/> -->
                <input type="checkbox" id="borrow_tmp_flag" name="borrow_tmp_flag" value="1" checked onclick="borrow_tmp(this);void(0);" style="display:none;">
                <span class="fc_red1" style="display:none;">用條碼槍借還書籍時，我要保留完整借還紀錄。</span>
            </td>
        </tr>
...
//-------------------------------------------------------
    ...
    var school_code='<?php echo $_SESSION['school_code'];?>';
   console.log("1");
    ...
    //送出
        ...
        if(arry_err.length!=0){
            ...
            if(school_code=='idc'){
                ...
                oForm1.action='../../search_book/book_class/addA.php'
                oForm1.submit();
                return true;
            }
    ...
    function check_book(book_code){
            var url = "ajax/check_book.php";
            var dataVal = {
              book_isbn:             book_code  
            };
            ...
            $.ajax({
                       ...
                       success: function(data) {
                            ...
                            if(data_array.length != 0){
                                ...
                                alert("這本書已經登記過了;請把書拿給中央大學網學所負責人");
