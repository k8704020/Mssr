...
//-------------------------------------------------------
    ...
    //book_donor        書籍捐贈者
        ...
        //GET
        $borrow_tmp_flag=(isset($_GET['borrow_tmp_flag']))?(int)$_GET['borrow_tmp_flag']:0;
        ...
        $book_donor      =trim($_GET[trim('book_donor    ')]);
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $book_sid_class     =book_class_sid($create_by,mb_internal_encoding());
        ...
        //-----------------------------------------------
            ...
            switch($search_type){
                case 'local':
                    $sql="
                        # for mssr_book_class
                        INSERT INTO `mssr_book_class` SET
                            `create_by`         =  {$create_by          } ,
                            `edit_by`           =  {$edit_by            } ,
    ...
    //---------------------------------------------------
        ...
        //
        //    //圖片路徑設定
        //    $_root=str_repeat("../",7)."info/book/{$book_sid_class}/img/front/simg/";
        //    $_img_name="";
        //    $_img_name.="1.jpg";
...
<?php function page_ok($book_name,$book_no) {?>
<?php
//-------------------------------------------------------
//page_ok 區塊 -- 開始
//-------------------------------------------------------
            ...
            <table border="0" width="100%" cellpadding="5" cellspacing="0" style="position:relative;top:50px;" class="table_style2">
                ...
                <tr>
                    <td height="350px" align="center" valign="middle">
                        ...
                        <?php if(((int)$book_no>1)&&($borrow_tmp_flag===1)):?>
                            <h1 class="fc_red1">請貼上<?php echo (int)$book_no;?>號貼紙</h1><br/>
                            <img src="../../../../../img/obj/labels.jpg" width="225" height="175" border="0" alt="標籤貼紙"
                            style='position:relative;'/>
                            <div style='position:absolute;top:155px;right:380px;'><h2 class='fc_red1' style='font-size:20px;'>
                                <?php echo (int)$book_no;?>
                            </h2></div>
                        <?php else:?>
                            <h1 class="fc_red1">不需貼上貼紙</h1><br/>
                        <?php endif?>
