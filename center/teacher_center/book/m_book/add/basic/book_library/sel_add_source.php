    ...
    <table align="center" border="0" width="525px" class="table_style0" style="position:relative;top:30px;">
        ...
        <tr class="fc_gray0">
            ...
            <td class="b_line gr_dashed">
                ...
                onclick="location.href='sel_add_type.php?psize=<?php echo $psize;?>&pinx=<?php echo $pinx;?>&book_source=school';"/>
                    <tr align="center">
                        <td height="120px">
                            <span class='fc_gray0'>學校圖書館</span>
                        </td>
                    </tr>
                </table>
                ...
                style="background-color:#c6ecff;border-color:#c6ecff;position:relative;margin:30px 15px;"
                onmouseover="this.style.cursor='pointer'"
                onclick="location.href='sel_add_type.php?psize=<?php echo $psize;?>&pinx=<?php echo $pinx;?>&book_source=other';"/>
                    <tr align="center">
                        <td height="120px">
                            <span class='fc_gray0'>其他機構圖書館</span>
                        </td>
                    </tr>
                </table>
