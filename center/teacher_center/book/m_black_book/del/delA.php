...
//-------------------------------------------------------
    ...
    //book_nonumbering          書籍識別碼
        ...
        //GET
        $book_nonumbering=trim($_GET[trim('book_nonumbering      ')]);
    ...
    //---------------------------------------------------
        ...
        //book_nonumbering          書籍識別碼
            ...
            $book_nonumbering=mysql_prep($book_nonumbering);
        ...
        //-----------------------------------------------
            ...
            $sess_user_id    =(int)$sess_user_id;
            $book_nonumbering=mysql_prep(strip_tags($book_nonumbering));
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                WHERE 1=1
                    AND `book_nonumbering`= '{$book_nonumbering}'
