...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_black_book']['filter']        查詢條件式
    //$_SESSION['m_black_book']['query_fields']  查詢欄位,顯示用
        ...
        if(isset($_GET['adscription'])&&(trim($_GET['adscription']==='self'))){
            ...
            $_SESSION['m_black_book']['adscription']='self';
        }else{
            $_SESSION['m_black_book']['adscription']='school';
        }

        $_SESSION['m_black_book']['query_fields']=$query_fields;
        $_SESSION['m_black_book']['filter']=$filter;

        if(1==2){//除錯用
            echo $_SESSION['m_black_book']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_black_book']['query_fields']);
            echo "</pre>";
            die();
        }
