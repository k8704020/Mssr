...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_book_borrow_search']['filter']        查詢條件式
    //$_SESSION['m_book_borrow_search']['query_fields']  查詢欄位,顯示用
        ...
        if(isset($_GET['adscription'])&&(trim($_GET['adscription']==='self'))){
            ...
            $_SESSION['m_book_borrow_search']['adscription']='self';
        }else{
            $_SESSION['m_book_borrow_search']['adscription']='school';
        }

        $_SESSION['m_book_borrow_search']['query_fields']=$query_fields;
        $_SESSION['m_book_borrow_search']['filter']=$filter;

        if(1==2){//除錯用
            echo $_SESSION['m_book_borrow_search']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_book_borrow_search']['query_fields']);
            echo "</pre>";
            die();
        }
