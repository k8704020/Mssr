...
//-------------------------------------------------------
    ...
    //99    管理者
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_isbn_code_create');
        }
...
//-------------------------------------------------------
    ...
    function barcode(obj,code){
        var code=$.trim(code);
        $(obj).barcode(code,"code128",{showHRI:false,barHeight:50});
    }
...
<table id="tbl_borrow_book" width="100%" border="0" cellpadding="0" cellspacing="0" align="center"/>
    <tr>
        ...
        <td width="100%" height="350px" align="center" valign="top">
            <!-- 內容 -->
            <table border="0" width="100%" cellpadding="5" cellspacing="0" style="position:relative;margin-top:20px;" class="table_style2">
                <tr align="center" valign="middle" class="bg_gray1">
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td height="280px" align="center" valign="middle">
                        ...
                        <?php for($i=1;$i<=$rows;$i++):?>
                            ...
                            ?>
                                <td>
                                    ...
                                    ?>
                                        <div style='width:183px;border:#999999 solid 0px;padding:8px 0px;margin:3px 1px;'>
                                            <span style='font-size:16px;'><?php echo htmlspecialchars($isbn);?></span>
                                            <!-- <br>
                                            <img width="200" src='data:image/png;base64,<?php echo $barcode_img;?>'
                                            style="position:relative;right:0px;"> -->
                                        </div>
                                        <div class='barcode39' code="<?php echo htmlspecialchars($isbn);?>"><?php echo htmlspecialchars($isbn);?></div>
                                    <?php endif;?>
                                </td>
                            <?php endfor;?>
                            </tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;margin-top:20px;"/>
    <tr align="center" valign="middle">
        <td height="50px" align="center">
            <input type="button" value="列印" class="ibtn_gr6030" onclick="window.print();" onmouseover="this.style.cursor='pointer'"
