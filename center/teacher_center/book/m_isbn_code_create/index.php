                ...
                <td colspan="2">
                    <!-- 資料列表 開始 -->
                        ...
                        <table id="tbl_borrow_book" width="100%" border="0" cellpadding="0" cellspacing="0" align="center"/>
                            <tr>
                                <!-- 在此設定寬高 -->
                                <td width="100%" height="150px" align="center" valign="top">
                                    <!-- 內容 -->
                                                ...
                                                <form id='Form1' name='Form1' action='' method='post' onsubmit="return false">
                                                    ...
                                                    <?php for($i=1;$i<=$rows;$i++):?>
                                                        ...
                                                        <?php  for($j=1;$j<=$cols;$j++):?>
                                                            <td>
                                                                <input type="text" id="" name="t<?php echo $i.$j;?>" value="" size="20" maxlength="20" class="form_text" tabindex="1"
                                                                style="width:120px;position:relative;margin:10px 0;">
                                                            </td>
                                                        <?php endfor;?>
                                                        </tr>
                                                    <?php endfor;?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;margin-top:20px;"/>
                            <tr align="center" valign="middle">
                                <td height="50px" align="center">
                                    <input id="BtnS" name="BtnS" type="button" value="列印" class="ibtn_gr6030" onmouseover="this.style.cursor='pointer'"
                                    style="position:relative;margin-left:10px;">
                                    <input id="BtnR" name="BtnR" type="button" value="清除" class="ibtn_gr6030" onmouseover="this.style.cursor='pointer'"
