...
//-------------------------------------------------------
    ...
    //99    管理者
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_pptv');
        }
    ...
    //---------------------------------------------------
        ...
        //目標班級
        $goal_class_code='';
        if(isset($_SESSION['tc']['t|dt']['arrys_class_code'][0]['class_code'])){
            $goal_class_code=trim($_SESSION['tc']['t|dt']['arrys_class_code'][0]['class_code']);
        }
    ...
    <div id="content">
        ...
        <div id="content_bottom">
            ...
            <table class="teacher_datalist_tbl" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <iframe id="IFC" name="IFC" src="/mssr/service/pptv/mange.php<?php if($goal_class_code!=='')echo "?class_code={$goal_class_code}";?>"
                        height="600" width="1015" style="overflow-x:hidden;overflow-y:auto;"></iframe>
                    </td>
                </tr>
            </table>
            <!-- 資料列表 結束 -->
