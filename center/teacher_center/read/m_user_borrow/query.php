...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_user_borrow']['filter']        查詢條件式
    //$_SESSION['m_user_borrow']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['m_user_borrow']['query_fields']=$query_fields;
        $_SESSION['m_user_borrow']['filter']=$filter;
        if($school_code!=='')$_SESSION['m_user_borrow']['school_code']=$school_code;
        $_SESSION['m_user_borrow']['class_code']=$class_code;

        if(1==2){//除錯用
            echo $_SESSION['m_user_borrow']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_user_borrow']['query_fields']);
            echo "</pre>";
            die();
        }
