...
//-------------------------------------------------------
    ...
    //user_id       使用者主索引
        ...
        //GET
        $num_of_days=trim($_GET[trim('num_of_days   ')]);
    ...
    //user_id       使用者主索引
        ...
        if($num_of_days===''){
           $arry_err[]='天數條件,未輸入!';
            ...
            if(!in_array($num_of_days,array(0,14))){
                $arry_err[]='天數條件,錯誤!';
            }
        }
    ...
    //---------------------------------------------------
        ...
        //---------------------------------------------------
            ...
            if($num_of_days>0){
                $query_sql.="
                    AND `keyin_cdate` < NOW()-INTERVAL {$num_of_days} DAY
                ";
            }
            $query_sql.="
                ...
                <div class="mod_data_tbl_outline" style="margin-top:35px;">
                    <table id="mod_data_tbl" border="0" width="95%" cellpadding="5" cellspacing="0" style="margin-top:30px;" class="table_style3">
                        <tr align="center" valign="middle" class="fsize_18">
                            <th width="100px" height="40px">排序    </th>
                            <th width="150px" height="40px">姓名    </th>
                            <th width="250px" height="40px">書本名稱</th>
                            <th width="150px" height="40px">借閱日期</th>
                        ...
                        //---------------------------------------------------
                            ...
                            //-----------------------------------------------
                                ...
                                $rs_user_name='<span class="fc_red1">查無人名!</span>';
                            ...
                            //-----------------------------------------------
                                ...
                                if(!empty($get_book_info)){
                                    ...
                                    if(mb_strlen($rs_book_name)>20){
                                        ...
                                        $rs_book_name=htmlspecialchars($rs_book_name);
                                    }
                        ...
                        <tr class="fsize_16">
                            <td height="30px" align="center" valign="middle">
                                <?php if($pinx!==1):?>
                                    第<?php echo $inx+1+(($pinx-1)*$psize);?>本
                                <?php else:?>
                                    第<?php echo $inx+1;?>本
                                <?php endif;?>
                            </td>
