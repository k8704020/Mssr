...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_user_read_group']['filter']        查詢條件式
    //$_SESSION['m_user_read_group']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['m_user_read_group']['query_fields']=$query_fields;
        $_SESSION['m_user_read_group']['filter']=$filter;
        if($school_code!=='')$_SESSION['m_user_read_group']['school_code']=$school_code;
        $_SESSION['m_user_read_group']['class_code']=$class_code;

        if(1==2){//除錯用
            echo $_SESSION['m_user_read_group']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_user_read_group']['query_fields']);
            echo "</pre>";
            die();
        }
