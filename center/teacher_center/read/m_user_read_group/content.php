...
//-------------------------------------------------------
    ...
    //99    管理者
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_user_read_group');
        }
    ...
    //---------------------------------------------------
        ...
        if(isset($_SESSION['m_user_read_group']['filter'])){
            $filter=$_SESSION['m_user_read_group']['filter'];
            if(isset($_SESSION['m_user_read_group']['class_code'])&&(trim($_SESSION['m_user_read_group']['class_code'])!=='')){
                $q_class_code=mysql_prep(trim($_SESSION['m_user_read_group']['class_code']));
            }
        }
        if(isset($_SESSION['m_user_read_group']['query_fields'])){
            $query_fields=$_SESSION['m_user_read_group']['query_fields'];
        }
        ...
        if(isset($_SESSION['m_user_read_group']['class_code'])&&trim($_SESSION['m_user_read_group']['class_code'])!==''){
            $_SESSION['teacher_center']['class_code']=trim($_SESSION['m_user_read_group']['class_code']);
        }
...
<Body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
            ...
            <!-- 內容 -->
                <!-- 統計資料表格 開始 -->
                <div class="mod_data_tbl_outline" style="margin-top:35px;display:none;">
