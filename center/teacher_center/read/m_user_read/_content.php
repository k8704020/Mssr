    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
            ...
            <!-- 內容 -->
                    ...
                    <table id="mod_data_tbl" border="0" width="99%" height="40px" cellpadding="5" cellspacing="0" style="" class="font-weight1 font-family1 fc_green0">
                        <tr align="center" valign="middle" class="fsize_16">
                            ...
                            <td align="right" valign="middle">
                                剩餘<span id="sec" class="fc_red0">60</span>秒將會自動更新本頁面 !
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <!-- 統計資料表格 開始 -->
                <div id="data_statistics" class="mod_data_tbl_outline" style="margin-top:35px;height:150px;">
                ...
                <div class="mod_data_tbl_outline" style="margin-top:35px;">
                    ...
                    <table id="mod_data_tbl" border="0" width="95%" cellpadding="5" cellspacing="0" style="margin-top:30px;" class="table_style3">
                        ...
                        <tr align="center" valign="middle" class="fsize_18">
                            ...
                            <th width="45px" height="40px">登記本數 </th>
                            <th width="45px" height="40px">登記次數 </th>
...
//-------------------------------------------------------
    ...
    //歷程
        var url ='';
        var page=str_repeat('../',0)+'view/course/index.php';
        var arg ={
            'user_id':user_id
        };
        var _arg=[];
    ...
    //書單
        var url ='';
        var page=str_repeat('../',0)+'view/book_list/index.php';
        var arg ={
            'user_id':user_id
        };
        var _arg=[];
    ...
    //啟用ajax設置
        ...
        for(key in arrys_user){
            ...
            //ajax呼叫, 本數
            ajax_read_group_cno_semester(user_id,semester_start,semester_end,key,numrow);

            //ajax呼叫, 次數
            ajax_read_frequency_cno_semester(user_id,semester_start,semester_end,key,numrow);
        }
    ...
    //ajax載入進度
        ...
        if((img_read_group.length===0)&&(img_read_frequency.length===0)){
            ...
            //回填平均本數
            $(oread_group_avg).append(Math.ceil(read_group_cno/arry_read_group_cno_semester.length));
