        ...
        <div id="content_bottom">
            <table id="teacher_datalist_tbl" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="2">
                        <!-- 資料列表 開始 -->
                        <iframe id="IFC" name="IFC" src="content.php?grade_goal=<?php echo $grade_goal;?>&classroom_goal=<?php echo $classroom_goal;?>" frameborder="0"
                        style="width:100%;height:1500px;overflow:hidden;overflow-y:auto"></iframe>
                        <!-- 資料列表 結束 -->
                    </td>
                </tr>
            </table>
