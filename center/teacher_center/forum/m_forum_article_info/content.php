...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        if(!isset($q_class_code)||trim($q_class_code)==='')$q_class_code=trim($sess_class_code);
            ...
            <!-- 內容 -->
                <div class="mod_data_tbl_outline" style="margin-top:35px;">
                    <table id="mod_data_tbl" border="0" width="99%" height="40px" cellpadding="5" cellspacing="0" style="" class="font-weight1 font-family1 fc_green0">
                        ...
                        <tr>
                        <td align="center">
                            <input type="button" value="觀看累計資料" class="ibtn_gr9030" onclick="window.open('../m_forum_info/index.php?q_class_code=<?php echo addslashes($q_class_code);?>')" onmouseover="this.style.cursor='pointer'" style="cursor: pointer;">
                        </td>
                        </tr>
                    </table>
                    <table id="mod_data_tbl" border="0" width="95%" cellpadding="5" cellspacing="0" style="margin-top:0px;" class="table_style3">
                        <thead>
                        <tr align="center" valign="middle" class="fsize_18">
                            ...
                            <th width="70px" height="40px">其他</th>
                        </tr>
                        </thead>
                        ...
                        <tr class="fsize_16">
                                ...
                                ?>
                                    ...
                                    ">
                                        <?php if(isset($arrys_article_cno[$date]['po'.$rs_uid])):?>
                                            <?php echo $arrys_article_cno[$date]['po'.$rs_uid];
                                                 $len = $arrys_article_cno[$date]['len'.$rs_uid];
                                               ?>發<?php else: $len =0; ?>0發<?php endif;?><?php if(isset($arrys_article_cno[$date]['repo'.$rs_uid])):?>:<?php echo $arrys_article_cno[$date]['repo'.$rs_uid];
                                                  $relen = $arrys_article_cno[$date]['relen'.$rs_uid];?>回<?php else:$relen = 0;?>:0回
                                        <?php endif;?>
                            ...
                            <td height="30px" align="center" valign="middle">
                                <input type="button" value="討論清單" class="ibtn_gr6030"
