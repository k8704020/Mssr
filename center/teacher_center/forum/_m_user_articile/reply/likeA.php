...
//-------------------------------------------------------
    ...
    //like_code     讚代號
        ...
        $like_code =trim($_GET[trim('like_code  ')]);
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $sql="
                        SELECT
                            `log_id`
                        FROM `mssr_forum_article_reply_log`
                        WHERE 1=1
                            AND `user_id`    = {$user_id    }
                            AND `reply_id`   = {$reply_id   }
            ...
            switch($like_code){
                ...
                case 2:
                    $sql="
                        ...
                        # for mssr_forum_article_reply_like_log
                        DELETE FROM `mssr_forum_article_reply_like_log`
                        WHERE 1=1
