...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_class_forum_info']['filter']        查詢條件式
    //$_SESSION['m_class_forum_info']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['m_class_forum_info']['query_fields']=$query_fields;
        $_SESSION['m_class_forum_info']['filter']=$filter;
        if($school_code!=='')$_SESSION['m_class_forum_info']['school_code']=$school_code;
        $_SESSION['m_class_forum_info']['class_code']=$class_code;

        if(1==2){//除錯用
            echo $_SESSION['m_class_forum_info']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_class_forum_info']['query_fields']);
            echo "</pre>";
            die();
        }
