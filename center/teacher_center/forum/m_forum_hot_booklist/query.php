...
//-------------------------------------------------------
    ...
    //$_SESSION['mod_sample']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['m_forum_hot_booklist']['query_fields']=$query_fields;
        $_SESSION['m_forum_hot_booklist']['filter']=$filter;
        if($school_code!=='')$_SESSION['m_forum_hot_booklist']['school_code']=$school_code;
        $_SESSION['m_forum_hot_booklist']['class_code']=$class_code;

        if(1==2){//除錯用
            echo $_SESSION['m_forum_hot_booklist']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_forum_hot_booklist']['query_fields']);
            echo "</pre>";
            die();
        }
