...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        $q_class_code='';
        if(isset($_GET['q_class_code'])){
            $q_class_code=trim($_GET['q_class_code']);
        }
    ...
    <div id="content">
        ...
        <div id="content_bottom">
            ...
            <table class="teacher_datalist_tbl" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <iframe id="IFC" name="IFC" src="content.php?q_class_code=<?php echo addslashes($q_class_code);?>" frameborder="0"
