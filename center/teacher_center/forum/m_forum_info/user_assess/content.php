            ...
            <!-- 統計資料表格 開始 -->
                ...
                <?php foreach($students as $student_k =>$student_v){ ?>
                        ...
                        <tr class="fsize_16" align="center">
                            ...
                            <td>
                                請求:<?php echo $accept[$student_k]?> 成功率 <?php echo $accept_success[$student_k]?>%
                            </td>
                            <td>
                                邀請:<?php echo $request[$student_k]?> 接受率 <?php echo $request_success[$student_k]?>%
                            </td>
                        </tr>
                <?php } ?>
