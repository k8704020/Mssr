    ...
    //---------------------------------------------------
        ...
        if(isset($sess_login_info['responsibilities'])){
            ...
            if(in_array($auth_sys_check_lv,array(5,14,16,22))){
                ...
                if((!in_array(trim($sess_class_code),array('test_2014_2_1_1','gcp_2014_2_5_5','gcp_2014_2_5_1','gcp_2014_2_5_2')))){
                    die();
                }
        ...
        //-----------------------------------------------
            ...
            for($i=0;$i<7;$i++){
                ...
                $sql="
                    SELECT
                        `sqry`.`user_id`,
                        SUM(`sqry`.`article_cno`) AS `article_cno`
                    FROM (
                        SELECT
                            `user_id`,
                            COUNT(`user_id`) AS `article_cno`
                ...
                if(!empty($db_results)){
                    foreach($db_results as $db_result){
                        $arrys_article_cno[$date][$db_result['user_id']]=(int)$db_result['article_cno'];
                    }
                }
            }
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
            ...
            <!-- 內容 -->
                ...
                <!-- 資料表格 開始 -->
                <div class="mod_data_tbl_outline" style="margin-top:35px;">
                    <!-- <table cellpadding="0" cellspacing="0" border="0" width="100%" style='position:relative;top:15px;'/>
                        <tr align='center'>
                            <td class="fsize_18 font-weight1 font-family1 fc_green0" valign='middle'>
                    ...
                    <table id="mod_data_tbl" border="0" width="95%" cellpadding="5" cellspacing="0" style="margin-top:30px;" class="table_style3">
                        ...
                        <tr align="center" valign="middle" class="fsize_18">
                            ...
                            <?php endif;?>
                            <th width="<?php if($is_now_semester){echo '45px';}else{echo '250px';}?>" height="40px">發文次數 </th>
                            <th width="" height="40px">詳細資料         </th>
                        </tr>
                        </thead>
                        ...
                        <tr class="fsize_16">
                            ...
                            <?php if($is_now_semester):?>
                                ...
                                ?>
                                    ...
                                    class="
                                        <?php if(!isset($arrys_article_cno[$date][$rs_uid]))echo 'bg_orange0';?>
                                        <?php if(isset($arrys_article_cno[$date][$rs_uid])&&($arrys_article_cno[$date][$rs_uid]===0))echo 'bg_orange0';?>
                                    ">
                                        <?php if(isset($arrys_article_cno[$date][$rs_uid])):?>
                                            <?php echo $arrys_article_cno[$date][$rs_uid];?>
                                        <?php else:?>
                                            0
                                        <?php endif;?>
                                    </td>
                            ...
                            <td height="30px" align="center" valign="middle">
                                ...
                                onclick="window.open('/mssr/service/forum/mssr_forum_people_myreply.php?user_id=<?php echo $rs_uid;?>');"
