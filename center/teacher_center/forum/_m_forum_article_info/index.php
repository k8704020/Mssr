                            ...
                            <select id="school_code" name="school_code" style="width:95px;" onchange="sel_school(this.options[this.options.selectedIndex].value);void(0);">
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <?php echo htmlspecialchars($country_code_name);?>-【<?php echo htmlspecialchars($rs_region_name);?>地區】
            ...
            <!-- <div style='position:relative;top:30px;right:25px;float:right;font-family:"微軟正黑體","標楷體","新細明體";font-size:16px;font-weight:700;color:#87CDDC;border:0px solid #f00;'>
                ...
                <select size="" style="border:1px solid #87CDDC;" onchange="sel_leader_class(this);void(0);">
                    ...
                    <?php
                        ...
                        $arry_rs_semester_code=explode('_',$rs_semester_code_replace);
                        $rs_semester_year=(int)$arry_rs_semester_code[0]-1911;
                        $rs_semester_term=(int)$arry_rs_semester_code[1];
                    ?>
                    <option value="<?php echo addslashes($rs_semester_code);?>"><?php echo $rs_semester_year;?>學年第<?php echo $rs_semester_term;?>學期
                    <?php endforeach;?>
                </select>
