...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_user_read']['filter']        查詢條件式
    //$_SESSION['m_user_read']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['m_user_read']['query_fields']=$query_fields;
        $_SESSION['m_user_read']['filter']=$filter;
        if($school_code!=='')$_SESSION['m_user_read']['school_code']=$school_code;
        $_SESSION['m_user_read']['class_code']=$class_code;
        $_SESSION['teacher_center']['class_code']=trim($class_code);

        if(1==2){//除錯用
            echo $_SESSION['m_user_read']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_user_read']['query_fields']);
            echo "</pre>";
            die();
        }
