...
//-------------------------------------------------------
    ...
    function arrys_book_class($conn='',$school_code='',$arry_conn){
    //---------------------------------------------------
    //函式: arrys_book_class()
    //用途: 班級書籍陣列
    //---------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        if(!$conn){
            ...
            try{
                ...
                $err ='ARRYS_BOOK_CLASS:CONNECT FAIL';
                die($err);
            }
        }else{
            $has_conn=false;
        ...
        if($school_code!==''){
            $sql="
                ...
                WHERE 1=1
                    AND `mssr_book_class`.`school_code`='{$school_code}'
            ";
            //echo "{$sql}"."<p>";
        }else{
            $sql="
        ...
        //資料庫
        $err='ARRYS_BOOK_CLASS:QUERY FAIL';
