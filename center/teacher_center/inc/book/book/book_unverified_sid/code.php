<?php
//-------------------------------------------------------
//函式: book_unverified_sid()
//用途: 未檢核的書籍.識別碼
//-------------------------------------------------------

    function book_unverified_sid($create_by,$encode){
    //---------------------------------------------------
    //函式: book_unverified_sid()
    //用途: 未檢核的書籍.識別碼
    //---------------------------------------------------
    ...
    //
    //---------------------------------------------------
    //字首: mbu + create_by(建立者) + YYYYMMDDhhiiss + 亂數組成，共25碼，
    //      mbu + 1 + 20130101000000 + 0000001
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            if($size>0){
                $book_unverified_sid=$prefix.$create_by.$datetime.$rnd;
            }else{
                $book_unverified_sid=$prefix.$create_by.$datetime;
            }

            return "{$book_unverified_sid}";
    }
?>