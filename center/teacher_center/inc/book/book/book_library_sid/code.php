...
//-------------------------------------------------------
    ...
    function book_library_sid($create_by,$encode){
    //---------------------------------------------------
    //函式: book_library_sid()
    //用途: 圖書館書籍.識別碼
    //---------------------------------------------------
    ...
    //
    //---------------------------------------------------
    //字首: mbl + create_by(建立者) + YYYYMMDDhhiiss + 亂數組成，共25碼，
    //      mbl + 1 + 20130101000000 + 0000001
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            if($size>0){
                $book_library_sid=$prefix.$create_by.$datetime.$rnd;
            }else{
                $book_library_sid=$prefix.$create_by.$datetime;
            }

            return "{$book_library_sid}";
    }
?>