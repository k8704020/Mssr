...
//-------------------------------------------------------
    ...
    //rec_en_input  英文輸入條件
        ...
        //GET
        $rec_en_input=trim($_GET[trim('rec_en_input')]);
    ...
    //rec_en_input  英文輸入條件
        ...
        if($rec_en_input===''){
           $arry_err[]='英文輸入條件,未輸入!';
            ...
            $rec_en_input=trim($rec_en_input);
            if(!in_array($rec_en_input,array("yes","no"))){
                $arry_err[]='英文輸入條件,錯誤!';
            }
        }
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //設定, 推薦英文輸入鎖定條件
        $bookstore_rec_en_input=$arry_rec_en_input[trim($rec_en_input)];
    ...
    <table align="center" border="0" width="700px" class="table_style0" style="position:relative;top:30px;">
        ...
        <tr class="fc_gray0">
            ...
            <td width="300px" height="150px" class="b_line gr_dashed">
                <?php foreach($arry_rec_en_input as $key=>$val):?>
                    <input type="radio" value="<?php echo $key;?>" name="rec_en_input"
                    <?php echo ($key===$rec_en_input)?'checked':'';?>>
                    <?php echo $val;?><br/><br/>
                <?php endforeach;?>
            </td>
        </tr>
