...
//-------------------------------------------------------
    ...
    //99    管理者
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_rec_en_input');
        }
    ...
    //---------------------------------------------------
        ...
        //---------------------------------------------------
            ...
            update_rec_en_input($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$sess_user_id);
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        $arry_rec_en_input=array(
            "yes"=>"開放輸入英文",
            "no" =>"禁止輸入英文"
        );

        //設定, 推薦英文輸入鎖定條件
        $bookstore_rec_en_input=$arry_rec_en_input[trim($arrys_this_teacher['auth']['rec_en_input'])];
?>
<!-- 該名老師資訊  開始 -->
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;top:20px;"/>
    ...
    <tr align="left" valign="middle">
        ...
        <td width="275px" height="50px">
            <span style="position:relative;left:10px;" class="fc_gray0">推薦英文輸入鎖定條件：</span>
            <span style="position:relative;left:5px;" class="fc_blue0">
                <?php echo htmlspecialchars($bookstore_rec_en_input);?>
            </span>
        </td>
        ...
        <td height="50px">
            <input type="button" value="修改英文輸入條件" class="ibtn_gr12030" onclick="edit('<?php echo addslashes(trim($arrys_this_teacher['auth']['rec_en_input']));?>');void(0);" onmouseover="this.style.cursor='pointer'">
        </td>
    </tr>
</table>
<!-- 該名老師資訊  結束 -->
        ...
        <!-- 內容 -->
            <table id="mod_data_tbl" border="0" width="100%" cellpadding="5" cellspacing="0" class="table_style2">
                ...
                //---------------------------------------------------
                    ...
                    if(@$arry_rec_en_input[trim($rs_auth['rec_en_input'])]){
                        $rs_rec_en_input=$arry_rec_en_input[trim($rs_auth['rec_en_input'])];
                    }
                ...
                //---------------------------------------------------
                    ...
                    update_rec_en_input($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$rs_user_id);
                ?>
                <tr>
                    ...
                    <td width="" height="20px" align="center" valign="middle">
                        <?php if(isset($rs_rec_en_input)&&(($rs_rec_en_input!==false))):?>
                            <?php echo htmlspecialchars($rs_rec_en_input);?>
                        <?php else:?>
                            開放輸入英文
                        <?php endif;?>
                    </td>
