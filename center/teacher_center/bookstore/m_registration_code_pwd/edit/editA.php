...
//-------------------------------------------------------
    ...
    //99    管理者
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_registration_code_pwd');
        }
    ...
    //chk_pwd       確認密碼
        ...
        //GET
        $pwd    =trim($_GET[trim('pwd    ')]);
        $chk_pwd=trim($_GET[trim('chk_pwd')]);
    ...
    //---------------------------------------------------
        ...
        //chk_pwd       確認密碼
            ...
            $pwd             =mysql_prep($pwd                );
            $chk_pwd         =mysql_prep($chk_pwd            );

            //-------------------------------------------
            //更新閱讀登記條碼版專用密碼條件
            //-------------------------------------------

                update_registration_code_pwd($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$sess_user_id);
        ...
        //-----------------------------------------------
            ...
            $pwd         =mysql_prep(strip_tags($pwd));
            $chk_pwd     =mysql_prep(strip_tags($chk_pwd));
