                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;top:20px;"/>
                            ...
                            <tr align="center" valign="middle">
                                <td height="80px" align="center">
                                    <span style="position:relative;left:-15px;" class="fc_blue0">設定專用密碼：</span>
                                    <input type="password" id="pwd" name="pwd" value="" size="16" maxlength="16"
                                    class="form_text" style="position:relative;width:120px;right:17px;" tabindex="1">


                                    <br/><br/>

                                    <span style="position:relative;left:2px;" class="fc_blue0">確認專用密碼：</span>
                                    <input type="password" id="chk_pwd" name="chk_pwd" value="" size="16" maxlength="16"
                                    class="form_text" style="width:120px;" tabindex="2">

                                    <input type="button" value="送出" class="ibtn_gr3020"
                                    onclick="add();void(0);" onmouseover="this.style.cursor='pointer'">
                                </td>
                            </tr>
                        </table>
                    <!-- 資料列表 結束 -->
...
//-------------------------------------------------------
    ...
    var ochk_pwd=document.getElementById('chk_pwd');
    ...
    //送出
        ...
        if(trim(ochk_pwd.value)===''){
            alert('請輸入確認密碼!');
            return false;
        }

        if((trim(opwd.value))!==(trim(ochk_pwd.value))){
            alert('2次密碼不一致!');
            return false;
        }
