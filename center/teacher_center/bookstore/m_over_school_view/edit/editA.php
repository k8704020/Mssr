...
//-------------------------------------------------------
    ...
    //class_code        班級代號
        ...
        //POST
        $over_school_view=trim($_GET[trim('over_school_view ')]);
    ...
    //---------------------------------------------------
        ...
        //class_code        班級代號
            ...
            $over_school_view=trim($over_school_view);
        ...
        //-----------------------------------------------
            ...
            $auth['over_school_view']=trim($over_school_view);
            $class_code              =addslashes(trim($class_code));
            $auth                    =serialize($auth);
