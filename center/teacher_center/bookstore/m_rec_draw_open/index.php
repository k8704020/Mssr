...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //---------------------------------------------------
            ...
            update_rec_draw_open($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$sess_user_id);
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //設定, 推薦畫圖開放條件
        $bookstore_rec_draw_open=$arry_rec_draw_open[trim($arrys_this_teacher['auth']['rec_draw_open'])];
?>
<!-- 該名老師資訊  開始 -->
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;top:20px;"/>
    ...
    <tr align="left" valign="middle">
        ...
        <td width="275px" height="50px">
            <span style="position:relative;left:10px;" class="fc_gray0">推薦畫圖開放條件：</span>
            <span style="position:relative;left:5px;" class="fc_blue0">
                <?php echo htmlspecialchars($bookstore_rec_draw_open);?>
            </span>
        </td>
        ...
        <td height="50px">
            <input type="button" value="修改畫圖開放條件" class="ibtn_gr12030"
            onclick="edit('<?php echo addslashes(trim($arrys_this_teacher['auth']['rec_draw_open']));?>');void(0);" onmouseover="this.style.cursor='pointer'">
        </td>
    </tr>
</table>
<!-- 該名老師資訊  結束 -->
        ...
        <!-- 內容 -->
            <table id="mod_data_tbl" border="0" width="100%" cellpadding="5" cellspacing="0" class="table_style2">
                ...
                //---------------------------------------------------
                    ...
                    if(@$arry_rec_draw_open[trim($rs_auth['rec_draw_open'])]){
                        $rs_rec_draw_open=$arry_rec_draw_open[trim($rs_auth['rec_draw_open'])];
                    }
                ...
                //---------------------------------------------------
                    ...
                    update_rec_draw_open($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$rs_user_id);
                ?>
                <tr>
                    ...
                    <td width="" height="20px" align="center" valign="middle">
                        <?php if(isset($rs_rec_draw_open)&&(($rs_rec_draw_open!==false))):?>
                            <?php echo htmlspecialchars($rs_rec_draw_open);?>
                        <?php else:?>
                            開放推薦畫圖功能
                        <?php endif;?>
                    </td>
