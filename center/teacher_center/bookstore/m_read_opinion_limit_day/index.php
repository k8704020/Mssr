...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //---------------------------------------------------
            ...
            update_read_opinion_limit_day($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$sess_user_id);
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //設定, 閱讀登記期限條件
        $bookstore_read_opinion_limit_day=(int)$arrys_this_teacher['auth']['read_opinion_limit_day'];
?>
<!-- 該名老師資訊  開始 -->
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;top:20px;"/>
    ...
    <tr align="left" valign="middle">
        ...
        <td width="215px" height="50px">
            <span style="position:relative;left:10px;" class="fc_gray0">閱讀登記期限條件：</span>
            <span style="position:relative;left:5px;" class="fc_blue0">
                <?php echo ($bookstore_read_opinion_limit_day);?>天
            </span>
        </td>
        <td width="215px" height="50px">
        ...
        <td height="50px">
            <input type="button" value="修改登記期限" class="ibtn_gr9030" onclick="edit(<?php echo (int)$bookstore_read_opinion_limit_day;?>);void(0);" onmouseover="this.style.cursor='pointer'">
        </td>
    </tr>
</table>
<!-- 該名老師資訊  結束 -->
        ...
        <!-- 內容 -->
            <table id="mod_data_tbl" border="0" width="100%" cellpadding="5" cellspacing="0" class="table_style2">
                ...
                //---------------------------------------------------
                    ...
                    $rs_read_opinion_limit_day=(int)$rs_auth['read_opinion_limit_day'];

                //---------------------------------------------------
                //更新閱讀登記期限條件
                //---------------------------------------------------

                    update_read_opinion_limit_day($db_type='mysql',$arry_conn_mssr,$APP_ROOT,$rs_user_id);
                ?>
                <tr>
                    ...
                    <td width="" height="20px" align="center" valign="middle">
                        <?php if(isset($rs_read_opinion_limit_day)&&(($rs_read_opinion_limit_day!==false))&&($rs_read_opinion_limit_day!==0)):?>
                            <?php echo ($rs_read_opinion_limit_day);?>天
                        <?php else:?>
                            14天
                        <?php endif;?>
                    </td>
...
//-------------------------------------------------------
    ...
    function edit(read_opinion_limit_day){
    //修改登記期限
        var url ='';
        ...
        var arg ={
            'psize':psize,
            'pinx' :pinx,
            'read_opinion_limit_day':read_opinion_limit_day
        };
        var _arg=[];
        for(var key in arg){
