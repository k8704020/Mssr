...
//-------------------------------------------------------
    ...
    //read_opinion_limit_day  閱讀登記期限條件
        ...
        //GET
        $read_opinion_limit_day=(int)$_GET[trim('read_opinion_limit_day')];
    ...
    <table align="center" border="0" width="700px" class="table_style0" style="position:relative;top:30px;">
        ...
        <tr class="fc_gray0">
            ...
            <td width="300px" height="150px" class="b_line gr_dashed">
                <select id="read_opinion_limit_day" name="read_opinion_limit_day" class="form_select" tabindex="1">
                <?php for($i=1;$i<=60;$i++):?>
                    <option value="<?php echo $i;?>" <?php if($i===$read_opinion_limit_day)echo 'selected';?>><?php echo $i;?>
                <?php endfor;?>
                </select>
                天
            </td>
