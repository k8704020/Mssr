...
//-------------------------------------------------------
    ...
    //99    管理者
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_registration_code_opinion');
        }
    ...
    //---------------------------------------------------
        ...
        //---------------------------------------------------
            ...
            //---------------------------------------------------
                ...
                $registration_code_opinion=trim('no');
                ...
                if(!empty($db_results)){
                    ...
                    if((!empty($auth))&&(isset($auth['registration_code_opinion']))){
                        ...
                        $auth['registration_code_opinion']=$registration_code_opinion;
                        $auth=serialize($auth);
                    ...
                    $auth        =serialize(array('registration_code_opinion'=>$registration_code_opinion));
                    $keyin_cdate ='NOW()';
                    $keyin_mdate ='NULL';
                    $keyin_ip    =get_ip();
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;top:20px;"/>
    ...
    <tr align="center" valign="middle">
        ...
        <!-- <td width="235px" height="50px">
            <span style="position:relative;left:10px;" class="fc_gray0">閱讀登記條碼版登記功能：</span>
            <span style="position:relative;left:5px;" class="fc_blue0">
                <?php echo htmlspecialchars($arry_registration_code_opinion[$registration_code_opinion]);?>
            </span>
        </td> -->
        <!-- <td width="" height="50px">
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_style2" style="position:relative;top:40px;"/>
    <tr align="left" valign="middle">
        <td width="100%" height="100px" align="center">
            <!-- 重新設定： -->
            <select id="registration_code_opinion" name="registration_code_opinion" class="form_select" style="position:relative;"
            onchange="edit(this);void(0);">
                <option value="yes" <?php if($registration_code_opinion==='yes')echo 'selected';?>><?php echo htmlspecialchars($arry_registration_code_opinion['yes']);?>
                <option value="no" <?php if($registration_code_opinion==='no')echo 'selected';?>><?php echo htmlspecialchars($arry_registration_code_opinion['no']);?>
            </select>
        </td>
    </tr>
</table>
...
//-------------------------------------------------------
    ...
    //修改條件
        ...
        var arg ={
            'psize':psize,
            'pinx' :pinx,
            'registration_code_opinion':encodeURI(obj.value),
