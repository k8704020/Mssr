...
//-------------------------------------------------------
    ...
    //接收參數
    //---------------------------------------------------
    //registration_code_opinion 條件
    //class_code                班級代號

        $get_chk=array(
            'registration_code_opinion  ',
            'class_code                 '
        );
    ...
    //class_code                班級代號
        ...
        //POST
        $registration_code_opinion =trim($_GET[trim('registration_code_opinion  ')]);
    ...
    //---------------------------------------------------
        ...
        //class_code                班級代號
            ...
            $registration_code_opinion=trim($registration_code_opinion);
