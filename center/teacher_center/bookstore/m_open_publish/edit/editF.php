...
//-------------------------------------------------------
    ...
    //open_publish  上架條件
        ...
        //GET
        $open_publish=(int)$_GET[trim('open_publish')];
...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        $arrys_open_publish=$config_arrys['bookstore_open_publish'];
?>
<!-- 內容 開始 -->
    ...
    <table align="center" border="0" width="700px" class="table_style0" style="position:relative;top:30px;">
        ...
        <tr class="fc_gray0">
            ...
            <td width="300px" height="150px" class="b_line gr_dashed">
                <?php foreach($arrys_open_publish as $key=>$val):?>
                    <input type="radio" value="<?php echo $key;?>" name="open_publish"
                    <?php echo ($key===$open_publish)?'checked':'';?>>
                    <?php echo $val;?><br/><br/>
                <?php endforeach;?>
            </td>
        </tr>
