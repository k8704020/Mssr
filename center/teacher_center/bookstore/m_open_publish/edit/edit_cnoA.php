...
//-------------------------------------------------------
    ...
    //22    老師帶多個班
        ...
        if(!empty($sess_login_info)){
            $auth_sys_check_lv=auth_sys_check($sess_login_info['responsibilities'],'m_open_publish_cno');
        }

    //---------------------------------------------------
    //接收參數
    //---------------------------------------------------
    //open_publish_cno    上架數量條件
    //class_code            班級代號
    ...
    //class_code            班級代號
        ...
        //POST
        $open_publish_cno=(int)$_GET[trim('open_publish_cno')];
    ...
    //class_code            班級代號
        ...
        if($open_publish_cno===''){
           ...
           $open_publish_cno=(int)$open_publish_cno;
           if($open_publish_cno===0){
              $arry_err[]='上架數量條件,不為整數!';
           }
        }
        if($class_code===''){
           $arry_err[]='班級代號,未輸入!';
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $auth['open_publish_cno']=(int)$open_publish_cno;
            $class_code              =addslashes(trim($class_code));
            $auth                    =serialize($auth);
