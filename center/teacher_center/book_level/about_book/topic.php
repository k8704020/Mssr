                             ...
                             $log_sql="
                                ...
                                if(!empty($log_result)){
                                        ...
                                        foreach ($log_result as $index_key => $array_log) {
                                                    ...
                                                    $array_output[$key]['major_topic'][$index_key]=$array_log['major_topic'];
                                                    $array_output[$key]['sub_topic'][$index_key]=$array_log['sub_topic'];
                                                    $array_output[$key]['minor_topic'][$index_key]=$array_log['minor_topic'];
