                ...
                <?php foreach ($array_output as $key => $value) {  ?>
                        <?php if($value['avg_status']==="0"&&$value['need_read_again']==='0'&& $value['about_level']<=6){?>
                            <tr class="data_content" id="data_one_<?php echo $key?>"> 
                                        ...
                                        <td rowspan="2"  class="change" id="change_<?php echo $key?>" style="height: 40px;">    
                                            
                                            <div class="avg">
                                                <span class="avg_level" id="avg_level_<?php echo $key?>"><?php echo $value['last_avg'];?></span>
                                                <input type="text" value="<?php echo $value['last_avg'];?>" class="input_text" id="change_text_<?php echo $key?>" style="display: none;width: 30px;" size="3" maxlength="3"  >
...
$(".read_checkbox input:checkbox").change(function(){
    ...
    if($this.is(":checked")){ 
        ...
        console.log(hhh_id);
        var book_level=$('#avg_level_'+str).text();
        console.log(book_level);
        

        $("#"+www_id).remove();
        $("#"+hhh_id).remove();
        var status="true";
        read(book_sid,status,book_level);
    }
...
function read(book_sid,status,book_level){
