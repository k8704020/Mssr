...
<Body>
    ...
    <div id="pt_work">
            ...
            <div id="pt_table">
                 <div class="time">
                    <div class="start">
                        <label for="date_start">起始日期：</label><input type="date" id="date_start" >
                    </div>
                    <div class="end">
                        <label for="date_end">結束日期：</label><input type="date" id="date_end">
                    </div>
