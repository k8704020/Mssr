            ...
            <div id="read_again_table">
                    <table border="1" cellpadding="5" style="border:1px #aaa solid;text-align:center;margin: 20px auto;">
                            ...
                            <?php foreach ($array_output as $key => $value) { ?>
                                <?php if($value['avg_status']<"3"&&$value['need_read_again']==='1'){?>
       ...
       <!--                                                  // $string=trim($value['book_name']); 
                                                ...
                                                <td class="read_again_checkbox" rowspan="4" style="height: 40px;"> 
                                                    ...
                                                    <div class="save">
                                                        ...
                                                        <input type="text"  class="input_text" id="text_<?php echo $key?>" style="width: 30px;" size="3" maxlength="3"  >
                                    ...
                                    <tr class="data_content" id="data_three_<?php echo $key?>">
                                                ...
                                                <td style="height: 20px;"> 
                                                    <?php
                                                     if(!empty($value['one_person_level'][2])){
                                                     echo $value['one_person_level'][2]; }
                                                    ?>
                                    ...
                                    <tr class="data_content" id="data_four_<?php echo $key?>">
                                                ...
                                                <td style="height: 20px;"> 
                                                    <?php
                                                     if(!empty($value['one_person_level'][3])){
                                                     echo $value['one_person_level'][3]; }
                                                    ?>
