...
//-------------------------------------------------------
    ...
    //儲存條件式
    //---------------------------------------------------
    //$_SESSION['m_user_borrow_library_export']['filter']        查詢條件式
    //$_SESSION['m_user_borrow_library_export']['query_fields']  查詢欄位,顯示用
        ...
        $_SESSION['m_user_borrow_library_export']['query_fields']=$query_fields;
        $_SESSION['m_user_borrow_library_export']['filter']=$filter;

        if((isset($class_code))&&(trim($class_code)!=='')){
            $_SESSION['m_user_borrow_library_export']['class_code']=$class_code;
        }

        if(1==2){//除錯用
            echo $_SESSION['m_user_borrow_library_export']['filter'].'<p>';
            echo "<pre>";
            print_r($_SESSION['m_user_borrow_library_export']['query_fields']);
            echo "</pre>";
            die();
        }
