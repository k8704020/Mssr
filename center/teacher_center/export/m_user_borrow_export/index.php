...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        $m_user_borrow_export_class_code='';

        if(isset($_SESSION['m_user_borrow_export']['filter'])){
            $filter=$_SESSION['m_user_borrow_export']['filter'];
        }
        if(isset($_SESSION['m_user_borrow_export']['query_fields'])){
            $query_fields=$_SESSION['m_user_borrow_export']['query_fields'];
        }
        if((isset($_SESSION['m_user_borrow_export']['class_code']))&&(trim($_SESSION['m_user_borrow_export']['class_code'])!=='')){
            $m_user_borrow_export_class_code=$_SESSION['m_user_borrow_export']['class_code'];
        }
    ...
    //---------------------------------------------------
        ...
        //目標班級
        $goal_class_code='';
        if((isset($m_user_borrow_export_class_code))&&(trim($m_user_borrow_export_class_code)!=='')){
            $goal_class_code=$m_user_borrow_export_class_code;
        }
        ...
        //-----------------------------------------------
            ...
            if((isset($m_user_borrow_export_class_code))&&(trim($m_user_borrow_export_class_code)!=='')){
                $sql="
                    ...
                    WHERE 1=1
                        AND `class`.`class_code`='{$m_user_borrow_export_class_code}'
                ";
                    ...
                    <!-- 資料列表 開始 -->
                        <table cellpadding="0" cellspacing="0" border="1" width="100%" class="table_style2" style="position:relative;top:20px;"/>
                            ...
                            <tr align="center" valign="middle">
                                <td width="550px" height="150px" align="center">
                                <?php
                                //1     校長
                                //3     主任
                                //5     帶班老師
                                ...
                                ?>
                                    ...
                                    <?php elseif(in_array($auth_sys_check_lv,array(1,3,14,16,22,99,20,24))):?>
                                        ...
                                        <span id="span_class_code" style="position:relative;" class="">
                                            <select id="semester_year" class="form_select" tabindex="1" style="position:relative;width:70px;" onchange="sel_semester_year(this);void(0);">
                                                <option value="">請選擇
                                            ...
                                            <select id="semester_term" name="semester_term" class="form_select" tabindex="2" style="position:relative;width:70px;"
                                            ...
                                            <select id="grade" name="grade" class="form_select" tabindex="3" style="position:relative;width:70px;"
                                            ...
                                            <select id="class_code" name="class_code" class="form_select" tabindex="4" style="position:relative;width:70px;"
                                    ...
                                    <?php if($goal_class_code!==''):?>
                                        <?php if(in_array($auth_sys_check_lv,array(1,3,14,16,22,99,20,24))):?><br><br>
                                            <input type="button" value="重新選擇班級" class="reset _ibtn_gr3020" onclick="reset_sel();void(0);"
                                            onmouseover="this.style.cursor='pointer'"
                                            style="position:relative;left:10px;">
                                        <?php endif;?>
                                        <input type="button" value="請點我匯出" class="export _ibtn_gr3020" onclick="borrow_export();void(0);"
                                        onmouseover="this.style.cursor='pointer'"
                                        style="position:relative;left:15px;">
                                    <?php endif;?>
                                </td>
                                <td height="50px" align="center">
                                    <span id='success' style='display:none;position:relative;right:-20px;' class="fc_blue1 fsize_16 font-family1 font-weight1"
