...
<body>
    ...
    <div id="text_author" style="position:absolute; height:30px; width:192px; top:344px; left:70px;" class="text"></div>
	<div id="text_publisher" style="position:absolute; height:30px; width:166px; top:367px; left:85px;" class="text"></div>
    <div id="text_donor" style="position:absolute; height:30px; width:166px; top:390px; left:112px;" class="text"></div>

    <div id="out_b" style="position:absolute; top:10px; left:981px; width:37px; height:46px; background-color:#F8C967"></div>
    <!-- 改過 -->
