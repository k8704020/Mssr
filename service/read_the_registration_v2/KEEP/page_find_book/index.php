...
<body>
	...
	<!-- 改過 -->
	<div style="position:absolute; top:402px; left:800px; width:150px; height:46px; background-color:#F8C967"></div>
	<!-- 改過 -->
    <a id="out_btn" onClick="go_page('menu')"  style="position:absolute; top:370px; left:815px; cursor:pointer;"></a>
</body>
