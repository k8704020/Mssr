	...
	function finish_mission(x,y,w){//x:任務編號; y:任務主題; w:傳遞人uid	
		...
		var add ="";
			...
			add += "<tr>";
			add += "<td rowspan='8' style='width:140px;background-Color:#CCEEFF;'><div class='circle' style='top:20%'><div class='inner' >任務已完成</div></div></td>";
			...
			add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/arrow1.png'>&nbsp;&nbsp;本次活動文章的「按讚』、「回覆」與「傳遞」狀況：<td></tr>";
			...
			add += "<tr><td colspan='2' class='mission_step3' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/three.png'>&nbsp;&nbsp;任務已經傳給[<span style='color:red'>"+deliver_cno+"</span>]人 </td></tr>";
			add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB'><img src='img/mission_icon/money.png'>&nbsp;&nbsp;任務總獲得獎勵：<span style='color:red'>"+total_score+"</span> 分</td></tr>";
			add += "<tr>";
			add += "<td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB'><img src='img/mission_icon/time.png'>&nbsp;&nbsp;任務完成時間："+end_time+""; 
			add += "</tr>";
			add += "</table>";
			...
			"success": function(data){
				...
				//-----------------------------------------
					/* if(Date.parse(new Date()).valueOf() > Date.parse(end_time).valueOf()){//時間到後，即放棄任務
						...
						add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB'><img src='img/mission_icon/friend_money.png'>&nbsp;&nbsp;完成後可獲得獎勵："+step_score+" 分</td></tr>";
						add += "<tr>";
				...
				//-----------------------------------------	
					/* if(Date.parse(new Date()).valueOf() > Date.parse(end_time).valueOf()){//時間到後，自動提交任務
						...
						add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB'><img src='img/mission_icon/money.png'>&nbsp;&nbsp;目前累積獎勵：<span style='color:red'>"+parseInt(30+expect_score)+"</span> 分(30<span style='color:red'>+"+expect_score+"</span>)</td></tr>";
						add += "<tr>";
						add += "<td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB'><img src='img/mission_icon/time.png'>&nbsp;&nbsp;任務截止時間："+end_time+"<div class='m-button' style='float:right;margin-right:20px'><span name='submit'>提交任務</span></div></td>";
						add += "</tr>";
						add += "</table>";
...
/* 					if(Date.parse(new Date()).valueOf() > Date.parse(mission_finish_time).valueOf()){//時間到後，放棄任務
					...
					add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB'><img src='img/mission_icon/money.png'>&nbsp;&nbsp;目前累積獎勵：<span style='color:red'>"+parseInt(30+total_score)+"</span> 分</td></tr>";
					add += "<tr>";
		...
		$.ajax({
			...
			"success": function(data){
				...
				if(article_id!=0){//朋友有發表文章
					...
					add += "<tr><td class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/deliver.png'>&nbsp;&nbsp;任務接受人：<span style='color:blue'>「"+fn+"」</span></td></tr>";
	...
	function finish_friend_mission(x,y,f,fn){//x:任務編號; y:任務主題; f:朋友的uid; fn:朋友的name
		...
		var add ="";
			...
			add += "<tr>";
			add += "<td rowspan='8' style='width:140px;background-Color:#CCEEFF;'><div class='circle' style='top:24%'><div class='inner' >任務已完成</div></div></td>";
			add += "<td colspan='2' class='mission_step1' style='background-Color:#FFFFBB;color:black;'><img src='img/mission_icon/topic.png'>&nbsp;&nbsp;主題：『"+y+"』</td>";
			add += "</tr>";
			add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/deliver.png'>&nbsp;&nbsp;任務接受人：<span style='color:blue'>「"+fn+"」</span><td></tr>";
			add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/article.png'>&nbsp;&nbsp;文章標題：「"+article_title+"」&nbsp;─&nbsp;點此前往&nbsp;[<a href='../_dev_group_mission.php?get_from=3&group_task_id="+x+"&article_id="+article_id+"' target='_blank'>文章討論頁面</a>]</td></tr>";
 			add += "<tr><td colspan='2' class='mission_step3' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/one.png'>&nbsp;&nbsp;朋友的文章取得按讚[<span style='color:red'>"+article_like_cno+"</span>]個<td></tr>";
			add += "<tr><td colspan='2' class='mission_step3' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/two.png'>&nbsp;&nbsp;朋友的文章取得回覆[<span style='color:red'>"+article_reply_cno+"</span>]個 </td></tr>";
			add += "<tr><td colspan='2' class='mission_step3' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/three.png'>&nbsp;&nbsp;朋友的任務已傳給[<span style='color:red'>"+deliver_cno+"</span>]人 </td></tr>";
			add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB;'><img src='img/mission_icon/money.png'>&nbsp;&nbsp;任務總獲得獎勵：<span style='color:red'>"+total_score+"</span> 分</td></tr>";
			add += "<tr>";
			add += "<td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;background-Color:#FFFFBB;'><img src='img/mission_icon/time.png'>&nbsp;&nbsp;任務完成時間："+end_time+""; 
			add += "</tr>";
