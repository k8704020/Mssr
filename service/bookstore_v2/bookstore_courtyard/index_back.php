...
<Head>
    ...
    <style>
		.feri_friend{
			...
			width:30px;
			height:30px;
			background: url('../img/feri2.png') -5px -50px;
		}
		.feri_friend:hover {
    		background: url('../img/feri2.png') -5px -134px;
		}
		.feri_friend_n{
			position:absolute;
			width:30px;
			height:30px;
			background: url('../img/feri2.png') -5px -8px;
		}
		.feri_friend_n:hover {
    		background: url('../img/feri2.png') -5px -94px;
		}
		...
		.feri_good{
			...
			width:33px;
			height:30px;
			background: url('../img/feri2.png') -38px -47px;
		}
		.feri_good:hover {
    		background: url('../img/feri2.png') -38px -133px;
		}
		.feri_good_n{
			position:absolute;
			width:33px;
			height:31px;
			background: url('../img/feri2.png') -38px -5px;
		}
		.feri_good_n:hover {
    		background: url('../img/feri2.png') -38px -90px;
		}
		.feri_home{
			position:absolute;
			width:32px;
...
<body>
	...
	<!-- 內頁內容 -->
    <img src="./img/backgrand.png"  style="position:absolute; top:29px; left:2px;" border="0">
 	<img src="./img/but.png"  style="position:absolute; top:112px; left:2px;" border="0">
    <a id="fire_pin_ling" style="position:absolute; top:30px; left:864px;"></a>
    <a id="put" onClick=""  style="position:absolute; top:31px; left:658px; display:none;"></a>
	...
	<a id="home_ling" onClick=""  style="position:absolute; top:20px; left:375px;"></a>


	<!-- 圖片圖層 -->
        <div id="linttt" style="position: absolute; top:382px; left:0px; width:1033px; height:59px; z-index:601;">
	  		
            <img src="../img/the_1.png" style="position:absolute; top:-55px; left:182px;">
            <img src="../img/UI_2.png" style="position:absolute; top:-17px;">
   	  	  <div style="position:absolute; top:-55px; left:-36px; height:33px; width:300px; background-image: url(../img/the_2.png);"></div>
          <div id="name" style="position:absolute; top:-63px; left:11px; width: 345px; height: 52px; text-align:center; white-space:nowrap; overflow:hidden; font-size:30px;" class="number_bar"></div>
 		  	
       	  <div id="coin"  style="position:absolute; top:-1px; left:-43px; width: 193px; height: 42px;display:none;" class="number_bar2">0</div>
	     	<div id="score_exp" style="position:absolute; top:-1px; left:132px; width: 193px; height: 42px;display:none;" class="number_bar2">0</div>
    ...
    <div id="box_bar" style="position:absolute; top:-8px; left:-8px; display:none;">
        ...
        <a id="coin_img" class="coin_img"  style="position:absolute; top:339px; left:8px;" border="0">
        <a class="btn_re"  style="position:absolute; top:403px; left:932px;" border="0"></a>
        <a id="inventory_btn_off" class="btn_c_box" onClick="set_page_close()" style="position:absolute; top:312px; left:875px;" ></a>
  	  <div id="coin_box" style="position:absolute; text-align:right; left:-31px; top:349px; width: 179px;" class="number_bar2">0</div>
        <div id="page_box" style="position:absolute; text-align:center; left:698px; top:350px; width: 179px;" class="number_bar2">0</div>
      <!-- 箱子上物件 -->
	...
	<div id="map" style="position:absolute; top:0px; left:0px; ">
     ...
     <!-- 高階按鈕曾 -->
    <div id="hight_btn" style="position:absolute; top:-36px; left:-10px; width:1000px; height:480px;; z-index:887">
        <a id="home_ling_btn" onClick="go_page('home')"  style="position:absolute; top:20px; left:375px; cursor:pointer;"></a>
        <a id="fire_pin_ling_btn" onClick="go_page('space')"  style="position:absolute; top:30px; left:864px; cursor:pointer;"></a>
        <a id="ebook_door_btn" onClick="go_ebook_door()" style="position:absolute; top:29px; left:226px;display:none;cursor:pointer;"></a>
    
        <a id="put_btn"  onClick="go_page('communication')" style="position:absolute; top:31px; left:658px; cursor:pointer; display:none;"></a>
        <a id="trans_btn" onClick="" style="position:absolute; top:70px; left:16px;display:;cursor:pointer; display:none;"></a>
    </div>
	<!-- 好友按按 -->
...
<div id="high_btm" style="position:absolute; left:-8px; top:0px; z-index:888">
  <div id="other_store" style="position:absolute; top:290px; left:216px;display:;">
               <img src="../img/firend_bar.png" style="position:absolute; top:-141px; left: -231px;">
               <a id="feri_friend" class="feri_friend" onClick="set_track()" style="cursor:pointer; position:absolute; top:-120px; left:-210px;display:;"></a>
               <a id="feri_good" class="feri_good" onClick="set_good()" style="cursor:pointer; position:absolute; top:-80px; left:-210px;display:;"></a>
  ...
  <a id="coin_img" class="coin_img" onClick="cover('<a style=\'color:#903;\'>葵幣:購買裝飾品的貨幣</a><BR>做推薦與販賣書籍獲得，也可由教師給予',1)" style="cursor:pointer; position:absolute; top:324px; left:7px;display:;" border="0"></a>
       	<a id="score_exp_img" class="score_exp_img" onClick="cover('<a style=\'color:#903;\'>經驗值:經營書店的經驗值</a><BR>越努力經營書店數值越高',1)"   style="cursor:pointer; position:absolute; top:324px; left:159px;display:;" border="0"></a>
  <a id="home_btn" class="btn_bst" onClick="go_page('home')"  style="position:absolute; top:298px; left:369px; cursor:pointer;"></a>
  <a id="fire_pin_btn" class="btn_nuv" onClick="go_page('space')"  style="position:absolute; top:298px; left:457px; cursor:pointer;" ></a>
  <a id="communication_btn" class="btn_communication" onClick="go_page('communication')"  style="position:absolute; top:298px; left:545px; display:none; cursor:pointer;" ></a>
  <a id="out_btn" class="btn_outgame" onClick="go_page('menu')"  style="position:absolute; top:298px; left:888px; cursor:pointer;"></a>
  <a id="box_btn" class="btn_o_box" onClick="set_box_page(0)"  style="position:absolute; cursor:pointer; top:298px; left:714px; display:none;"></a>
  <a id="shop_btn" class="btn_shop" onClick="go_page('shop')"  style="position:absolute; cursor:pointer; top:298px; left:634px;display:none;"></a>
  </div>
    <!-- 賣東西葉面 --> 
    <div id="sell_item" style="position:absolute; left:-8px; top:0px; z-index:890; display:none;">
     ...
     <!-- 說明頁面 -->
   		<img id="book_store_help" onClick="close_help()" src="./img/go_help.png" style="position:absolute; top:-6px; left:-6px;  cursor:pointer; z-index:9998; display:none;" border="0">
