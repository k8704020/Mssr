...
<head>
    ...
    <style>
	 /*蘭標題特效效用*/
        ...
        {
            text-shadow:
                        1px 1px 0px rgba(0,0,153,1),
                        1px 0px 0px rgba(0,0,153,1),
                        0px 1px 0px rgba(0,0,153,1),
                        -1px -1px 0px rgba(109,148,253,1);
            font-weight:bold;
            color:#6d94fd;
            letter-spacing:0pt;
...
<body class="aa">
    ...
    <span id="up_data" class='btn btn-success' onClick="" style="position:absolute; top:250px; left:873px;">上傳</span>
    <span id="donw_data" class='btn btn-success' style="position:absolute; top:250px; left:927px;">下載</span>
...
<? echo $array['rec_record_score'];?>
    ...
    <div id = "updata_page" style=" position:absolute; display:none; top:0px; left:0px;">
      ...
      <div style="background-color:#f6e5bc; position:absolute; top:125px; left:250px; width:500px; height:230px;  "></div>
        <div style="background-color:#fff; position:absolute; top:134px; left:293px; width:416px; height:157px;"></div>
        <div class="blue_bar" style="position:absolute; top:133px; left:224px; width:183px; color:#6d94fd; font-family: Microsoft JhengHei; font-size:36px; height: 49px;">上傳說明</div>
    </div>
    <article>
