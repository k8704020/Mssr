...
<Head>
    ...
    <style>
		...
		.madal_1{
			...
			width:77px;
			height:163px;
			background: url('./img/medal.png') 0 0;
		}
		.madal_1:hover {
    		background: url('./img/medal.png') 0 -163px;
		}
		.madal_2{
			position:absolute;
			width:77px;
			height:163px;
			background: url('./img/medal.png') -77px 0;
		}
		.madal_2:hover {
    		background: url('./img/medal.png') -77px -163px;
		}
		.madal_3{
			position:absolute;
			width:77px;
			height:163px;
			background: url('./img/medal.png') -154px 0;
		}
		.madal_3:hover {
    		background: url('./img/medal.png') -154px -163px;
		}
		.madal_4{
			position:absolute;
			width:77px;
			height:163px;
			background: url('./img/medal.png') -231px 0;
		}
		.madal_4:hover {
    		background: url('./img/medal.png') -231px -163px;
		}
		.madal_5{
			position:absolute;
			width:77px;
			height:163px;
			background: url('./img/medal.png') -308px 0;
		}
		.madal_5:hover {
    		background: url('./img/medal.png') -308px -163px;
		}
...
<div style="position:absolute; top:0px; left:0px; width:1000px; height:480px; background-color:#000000; opacity:0.8;" onClick=""></div>
    <img src="../img/book_page_back2.png" style="position:absolute; top:5px; left:36px; width:947px; height:480px;"  border="0">
...
<div id="iframe"  style="position:absolute;top:0px;left:0px;"></div>
    ...
    <a id="l_btn" class=" btn_arrow_l" onClick="set_page(-1,0)" style="position:absolute; top:191px; left:59px; cursor:pointer;" border="0"></a>
    <a id="r_btn" class=" btn_arrow_r" onClick="set_page(1,0)" style="position:absolute; top:191px; left:879px; cursor:pointer;" border="0"></a>
	
    <!-- 快樂的老師評語 -->

    <textarea   id="rec_star_comment" class="comment_box_on" cols=34 rows=9 style="position:absolute; font-size:20px; resize: none;  display:none;" readOnly></textarea>
    <a id="rec_star_badge" class="madal_4" onClick="comment_box_click()"  style="display:none;position: absolute;	top:310px;left:33px; " ></a>
    
    <!-- 標籤 -->    
    <a class="btn_help" onClick="open_helper(7)" style="position:absolute; top:-3px; left:920px; cursor:pointer;"></a>

    <a id="flag_l_0" onClick="set_page(0,1)" style="position:absolute; top:2px; left:83px; cursor:pointer;" border="0"></a>
    <a id="flag_l_1" onClick="set_page(1,1)" style="position:absolute; top:39px; left:83px; cursor:pointer;" border="0"></a>
    <a id="flag_l_2" onClick="set_page(2,1)" style="position:absolute; top:77px; left:83px; cursor:pointer;" border="0"></a>
    <a id="flag_l_3" onClick="set_page(3,1)" style="position:absolute; top:114px; left:83px; cursor:pointer;" border="0"></a>
    
    <a id="flag_r_0" onClick="set_page(0,1)" style="position:absolute; top:2px; left:869px; cursor:pointer;" class="flipx"></a>
    <a id="flag_r_1" onClick="set_page(1,1)" style="position:absolute; top:39px; left:869px; cursor:pointer;" class="flipx"></a>
    <a id="flag_r_2" onClick="set_page(2,1)" style="position:absolute; top:77px; left:869px; cursor:pointer;" class="flipx"></a>
    <a id="flag_r_3" onClick="set_page(3,1)" style="position:absolute; top:114px; left:869px; cursor:pointer;" class="flipx" ></a>
   	<? if($forum_flag){?>
    <a id="flag_l_4" onClick="set_page(4,1)" style="position:absolute; top:153px; left:82px; cursor:pointer;" border="0"></a>
    <a id="flag_r_4" onClick="set_page(4,1)" style="position:absolute; top:153px; left:868px; cursor:pointer;" class="flipx"></a>
    <? } ?>
</div>
...
<!--  --><script>
	...
	*/
	...
	//設定 快樂的老師評語 
	function set_content(text,score)
	{
		if(score==0)
		{
		...
		else
		{
			...
			window.document.getElementById("rec_star_comment").className = "comment_box_of";
			window.document.getElementById("rec_star_comment").value = text;
