...
<body style="overflow:hidden;">
    ...
    <div style="position:absolute; top:11px; left:139px; width: 377px;">
        ...
        <BR>
        標題：<input  id="haha" type="text"  name="mssr_input_box_name_title" size="40" maxlength="40"/>
        <BR>
...
<script>
	...
	function article_input_text(value)
	{
		...
		if(ques!=3)window.document.getElementById("chs_2").style.visibility = "";
	...
	function sel_list_open(value)
	{
		...
		else if(value == 2)	
		{
			...
			window.alert(real_ation +"  "+real_scaffolding);
			if(real_ation==0)
			{
