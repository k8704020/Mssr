...
<body>
   ...
   -->
	...
	{ 	
		...
		if( $i+1 == sizeof($array))
		{	if($forum_flag){
				echo "<td class='td_line_l_d' style=' width:251.5px; '>";
			}else{
				echo "<td class='td_line_l_d' style=' width:300px; '>";
			}
			echo $array[$i]["book_name"];
			echo "</td>";
			
			echo "<td align='center' class='td_line_d' style='width:50px;position:relative'>";
			if($array[$i]["stat_txt"]=="○")echo $p[3];
			echo "</td>";
			
			if($array[$i]["draw_s"]>0) echo "<td align='left' class='td_line_d' style='width:50px;position:relative'>";
			else echo"<td align='center' class='td_line_d' style='width:51.5px;position:relative'>";
			...
			if($array[$i]["text_s"]>0) echo "<td align='left' class='td_line_d' style='width:50px;position:relative'>";
			else echo"<td align='center' class='td_line_d' style='width:50px;position:relative'>";
			...
			if($array[$i]["record_s"]>0) echo "<td align='left' class='td_line_d' style='width:50px;position:relative'>";
			else echo "<td align='center' class='td_line_d' style='width:50px;position:relative'>";
		...
		{	
			if($forum_flag){
				echo "<td class='td_line_l'style=' width:250px; '>";
			}else{
				echo "<td class='td_line_l'style=' width:300px; '>";	
			}
			echo $array[$i]["book_name"];
			echo "</td>";
			
			echo "<td align='center' class='td_line' style='width:50px;position:relative'>";
			if($array[$i]["stat_txt"]=="○")echo $p[3];
			echo "</td>";
			
			if($array[$i]["draw_s"]>0) echo "<td align='left' class='td_line' style='width:50px;position:relative'>";
			else echo"<td align='center' class='td_line' style='width:50px;position:relative'>";
			if($array[$i]["draw_s"]>0)echo $array[$i]["draw_s"]."分";
			if($array[$i]['open']==0)
			{
				if($array[$i]["draw_txt"]=="○")echo $p[3];
			...
			if($array[$i]["text_s"]>0) echo "<td align='left' class='td_line' style='width:50px;position:relative'>";
			else echo"<td align='center' class='td_line' style='width:50px;position:relative'>";
			if($array[$i]["text_s"]>0)echo $array[$i]["text_s"]."分";
			if($array[$i]['open']==0)
			{
			...
			if($array[$i]["record_s"]>0) echo "<td align='left' class='td_line' style='width:50px;position:relative'>";
			else echo"<td align='center' class='td_line' style='width:50px;position:relative'>";
			if($array[$i]["record_s"]>0)echo $array[$i]["record_s"]."分";
			if($array[$i]['open']==0)
			{
...
<!-- </div>-->
	...
	var count = 0;
	var book_count = <? echo sizeof($array); ?>;
	window.parent.select_book = new Array();
	window.parent.books_count = <? echo sizeof($array); ?>;
	for(var i = 0 ; i < <? echo sizeof($array); ?> ; i++)
	{
		window.parent.select_book[i] = 0;	
	}
	...
	for(var key in array_data)
	{
		...
		window.parent.book_sid[key] = array_data[key].book_sid;	
	}
	...
	function click_bar(value)
	{
		...
		if (window.document.getElementById("br_"+value).className == 'click_br_3')
		{
			if(window.parent.select_count >=12)
			{
				window.alert("最多不得超過12個");
			}
			else{
				window.parent.select_count++;
				window.document.getElementById("br_"+value).className = 'click_br_2';
				window.parent.select_book[value] = 1 ;
			}
		}else if (window.document.getElementById("br_"+value).className == 'click_br_2')
		{
			window.parent.select_count--;
			window.document.getElementById("br_"+value).className = 'click_br_3';
			window.parent.select_book[value] = 0 ;
		}
