...
//-------------------------------------------------------
    ...
    //權限,與判斷
    //---------------------------------------------------
		if($_SESSION["uid"] != $_GET['user_id'])die();
...
*/
    ...
    //user_id   使用者主索引
        ...
        $arry_book_sid  =(isset($_POST["try"]))?explode("_",$_POST["try"]):array();
		/*print_r($arry_book_sid);
		echo "<BR>";
...
/*
    ...
    //---------------------------------------------------
        ...
        //處理欄位
        //---------------------------------------------------
			//$arry_book_sid_ = explode("_",$arry_book_sid);
        ...
        //---------------------------------------------------
            ...
            //-----------------------------------------------
                ...
                if(!empty($rec_draw_info)){
                    ...
                    $root           =str_repeat("../",4)."info/user/".(int)$user_id."/book";
					...
					$ftp_path_bimg="{$ftp_root}/{$user_id}/book/{$rs_book_sid}/draw/bimg";
					$http_path="http://".$arry_ftp1_info['host']."/mssr/info/user/{$user_id}/book/{$rs_book_sid}";
					$file_list = array();
					...
					if(in_array($ftp_path_bimg."/1.jpg",$arry_ftp_file))
					{
						$draw_path=$http_path."/draw/bimg/1.jpg";
						 $has_draw=true;
					}
        ...
        ";
                        if($has_draw){
                            $body.="
                                <img src=\"{$draw_path}\" width=\"205px\" height=\"190px\" border=\"0\" alt=\"畫圖資訊\">
                            ";
                        }else{
                            $body.="
