...
//-------------------------------------------------------
	...
	//-------------------------------------------
			 ...
			 $dadad = date("Y-m-d");
		 "<BR>";
		$dadad = date("Y-m-d",strtotime($dadad."-30 day"));
	...
	//-------------------------------------------
        ...
        $day30=date('Y-m-d H:i:s',strtotime(date('Y-m-d H:i:s') . "-30 days"));
