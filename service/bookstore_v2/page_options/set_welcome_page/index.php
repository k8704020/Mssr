...
<Body>
	<div style="position:absolute; left: 171px; top:-1px; width:452px; height:70px;font-size:24px; font-weight:bold; color: #B66923">你可以在這邊訓練店員<br>讓他店員用你的方式招呼客人</div>
      ...
      <div style="position:absolute; left: 11px; top:76px; width:529px; height:54px;" class="box1">
            ...
            <input id="t1" type="text"  name="t1" onChange="key_d('t1')" onFocus="key_d('t1')" onkeydown="window.setTimeout( function(){ key_d('t1')}, 30)"  onkeyup="checkBadWords('t1')"  style="position:absolute; left: 131px; top:9px; width: 388px; height: 36px; font-size:24px">
        ...
        <div style="position:absolute; left: 11px; top:131px; width:529px; height:54px;" class="box1">
            ...
            <input id="t2" type="text" name="t2" onChange="key_d('t2')" onFocus="key_d('t2')" onkeydown="window.setTimeout( function(){ key_d('t2')}, 30)"  onkeyup="checkBadWords('t2')"  style="position:absolute; left: 131px; top:9px; width: 388px; height: 36px; font-size:24px">
        ...
        <div style="position:absolute; left: 11px; top:186px; width:529px; height:54px;" class="box1">
          <div style="position:absolute; left: 14px; top:7px; width:112px; height:40px; font-size:24px; font-weight:bold;" class="world_bar2">招呼語３</div>
           <input id="t3" type="text" name="t3"  onChange="key_d('t3')" onFocus="key_d('t3')" onkeydown="window.setTimeout( function(){ key_d('t3')}, 30)"  onkeyup="checkBadWords('t3')"  style="position:absolute; left: 131px; top:9px; width: 388px; height: 36px; font-size:24px">
        ...
        <div style="position:absolute; left: 11px; top:241px; width:529px; height:54px;" class="box1">
            ...
            <input id="t4" type="text" name="t4" onChange="key_d('t4')" onFocus="key_d('t4')" onkeydown="window.setTimeout( function(){ key_d('t4')}, 30)"  onkeyup="checkBadWords('t4')" style="position:absolute; left: 131px; top:9px; width: 388px; height: 36px; font-size:24px">
      ...
      <div style="position:absolute; left: 11px; top:296px; width:529px; height:54px;" class="box1">
            ...
            <input id="t5" type="text" name="t5" onChange="key_d('t5')" onFocus="key_d('t5')" onkeydown="window.setTimeout( function(){ key_d('t5')}, 30);" onkeyup="checkBadWords('t5')" style="position:absolute; left: 131px; top:9px; width: 388px; height: 36px; font-size:24px">
  ...
  //     
	...
	function go_save(fun,value)
	{
		...
		{    
			...
			var input=window.document.getElementById("t"+i);
			...
			// var inputId= window.document.getElementsByName("t"+i)[0].id;

			if(!checkBadWords("t"+i)){
				// console.log(i);
				cover("招呼語"+i+"偵測到含有不適合的詞彙!!",1);
				return false;
			...
			// console.log("inputIdVal:",inputId.value);
		...
		cover("存檔中");
		window.parent.parent.set_action_bookstore_log(window.parent.parent.user_id,'e30',window.parent.parent.action_on);
