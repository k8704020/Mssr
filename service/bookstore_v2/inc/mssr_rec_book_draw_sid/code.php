<?php
//-------------------------------------------------------
//函式: mssr_rec_book_draw_sid()
//用途: 推薦畫圖.識別碼
//-------------------------------------------------------

    function mssr_rec_book_draw_sid($create_by,$encode){
    //---------------------------------------------------
    //函式: mssr_rec_book_draw_sid()
    //用途: 閱讀畫圖.識別碼
    //---------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            if($size>0){
                $mssr_rec_book_draw_sid=$prefix.$create_by.$datetime.$rnd;
            }else{
                $mssr_rec_book_draw_sid=$prefix.$create_by.$datetime;
            }

            return "{$mssr_rec_book_draw_sid}";
    }
?>