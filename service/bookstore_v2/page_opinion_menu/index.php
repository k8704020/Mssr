...
<div style="position:absolute; top:0px; left:0px; width:1000px; height:500px; background-color:#000000; opacity:0.8;" onClick=""></div>
	...
	*/
	...
	function set_page(value)
	{
		...
		window.document.getElementById("iframe").innerHTML ='<iframe src="./manu.php?page='+window.parent.page_list["opinion"]+'&uid='+window.parent.home_id+'&auth_read_opinion_limit_day='+window.parent.auth_read_opinion_limit_day+'" frameborder="0" width="500" height="287" style="position:absolute; top:113px; left:236px; " ></iframe>';
		cover("");
	}
