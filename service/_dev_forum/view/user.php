...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $sql="
                    SELECT `user`.`school`.`school_name`, `user`.`class`.`grade`, `user`.`class_name`.`class_name`
                    FROM `user`.`class`
        ...
        //-----------------------------------------------
            ...
            if(!empty($book_results)&&(isset($sess_school_code))&&(trim($sess_school_code)!=='')){
                $sql="
            ...
            <div class="user_lefe_side col-xs-12 col-sm-10 col-md-10 col-lg-10">
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade <?php if($tab===1)echo 'in active';?>" id="home" aria-labelledBy="home-tab">
                        ...
                        <!-- 個人資訊 -->
                        <div class="tab_title hidden"><?php echo htmlspecialchars($user_name);?>&nbsp;的個人資訊<!-- &nbsp;<?php for($i=0;$i<15;$i++):?>‧<?php endfor;?> --></div>
                        <div class="media hidden">
                            <img class="media-object pull-left" src="<?php echo $user_img;?>" alt="media-object" width="64" height="64" border="0">
                            <div class="media-body">
                                ...
                                <p>自我介紹：<?php echo htmlspecialchars($user_content);?></p>
                            </div>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade <?php if($tab===3)echo 'in active';?>" id="article" aria-labelledBy="profile-tab">
                        <table class="user_lefe_side_tab1 table table-striped user_article">
                            <thead><tr class="second_tr" align="left">
                                <td width="225px" class="hidden-xs"><span>討論類型(書籍/小組)  </span></td>
                                <td><span>發表的內容(發文/回覆)</span></td>
                                <td width="100px"><span>發表時間             </span></td>
                            ...
                            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                                <div class="thumbnail" style="height:250px;">
                                    ...
                                    <div class="caption">
                                        ...
                                        <?php endif;?>
                                        <?php echo htmlspecialchars($rs_group_name);?>(<?php echo htmlspecialchars($rs_group_state_html);?>)
                                        <br>
                                        <?php if($rs_group_state!==3):?>
                                            <?php echo htmlspecialchars($user_name);?>
                                            <br>
