    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="wall col-xs-12 col-sm-8 col-md-8 col-lg-8">
                <div style="font-size:14px;color:#4e4e4e;">
                        ...
                        <div class="media" style="overflow:visible;">
                            ...
                            <div class="media-body" style="overflow:visible;">
                                ...
                                <p>
                                    ...
                                    <div class="btn-group" style="position:relative;margin:0 1px;">
                    ...
                    ?>
                        <div class="media">
                            <a class="pull-left" href="article.php?get_from=2&group_id=<?php echo addslashes($rs_group_id);?>">
                                <img class="media-object" src="../img/default/group.png" width="64" height="64" alt="Media">
                            </a>
                            <div class="media-body">
                                <h5 class="media-heading">
