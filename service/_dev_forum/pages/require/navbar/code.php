    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                if(trim($PAGE_SELF)==='index.php'||trim($PAGE_SELF)==='query.php'){
                    $html="
                        <!-- 導覽列,容器,start -->
                            ...
                            <div class='container'>
                                ...
                                <div class='navbar-header mx-navbar-header'>
                                    ...
                                    <span class='navbar-brand mx-navbar-brand'>
                                        <a href='{$rd}view/index.php?user_id={$sess_user_id}' class='navbar-link'>
                                ...
                                <div class='collapse navbar-collapse' id='navbar-collapse-1'>
                                    ...
                                    <ul class='nav navbar-nav navbar-right mx-navbar-nav'>
                                        ...
                                        <li class=''>
                                            <a href='{$rd}view/index.php?user_id={$sess_user_id}'><em class='glyphicon glyphicon glyphicon-th-large'></em> 動態牆</a>
                                        </li>
                                        ...
                                        <li class='dropdown hidden-xs'>
                                            <a id='' href='javascript:void(0);' class='dropdown-toggle' aria-haspopup='true' aria-expanded='false'
