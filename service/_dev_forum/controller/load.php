                    ...
                    if(!empty($db_results)){
                        ...
                        if(!empty($article_reply_results)){
                            ...
                            foreach($article_reply_results as $article_reply_result){
                                ...
                                $json_html[0].="
                                    <tr align='left' cno='{$cno}' style='background-color:{$tr_color};'>
                                        <td class='hidden-xs' style='border:0px;word-break:break-all;'>
                                            <span style='position:relative;left:8px;'>
                                ";
                                    if($rs_group_id===0){
                                        $json_html[0].="
                                            <a href='article.php?get_from=1&book_sid={$rs_book_sid}'>
                                                書籍：{$rs_book_name}
                                            </a>
                                        ";
                                    }else{
                                ...
                                $json_html[0].="
                                        ...
                                        <td style='border:0px;word-break:break-all;'>
                                            ...
                                            <a target='_blank' href='reply.php?get_from={$get_from}&article_id={$rs_article_id}'>
                                                標題：{$rs_article_title}<br>
                                ";
                                    if($rs_type==='article'){
                                        $json_html[0].="
                                            發文：{$rs_article_content}
                                        ";
                                    }else{
                                        $json_html[0].="
                                            回覆：{$rs_reply_content}
                                ...
                                $json_html[0].="
                                        ...
                                        <td style='border:0px;'><span style='position:relative;left:8px;'>{$rs_keyin_mdate}</span></td>
                                        <td class='hidden-xs' style='border:0px;'><span style='position:relative;left:8px;'>{$rs_like_cno}</span></td>
                                    </tr>
                                ";
                                $cno++;
                            }
                                ...
                                foreach($wall_results as $rs_time=>$wall_result){
                                    ...
                                    if(!$is_forum_friend){
                                        ...
                                        $html.="
                                                                    ...
                                                                    <div class='media-body'>
                                                                        <h5 class='media-heading submedia-heading'>{$rs_content_2}</h5>
                                        ...
                                        $html.="
                                                                    ...
                                                                    <div class='media-body'>
                                                                        <h5 class='media-heading submedia-heading'>
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $oright_side=new right_side($sess_user_id,$conn_user,$conn_mssr,$arry_conn_user,$arry_conn_mssr);
                    $json_html  ='';
                    ...
                    //側邊欄類型
                        ...
                        //側欄-人(登入者看到自己)
                            ...
                            $arrys_member_self=$oright_side->member_self($sess_user_id,$conn_user,$conn_mssr,$arry_conn_user,$arry_conn_mssr);
                                                    ...
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_member_self['submain'][$inx])&&!empty($arry_member_self['submain'])){
                                                            if(trim($arry_member_self['submain'][$inx])!==''){
                                                                $json_html.="
                                                                    <br/>你們共同讀過：{$arry_member_self['submain'][$inx]}
                                                                ";
                                                            }
                                                        }
                                                        $json_html.="
                                                    ...
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_member_self['submain'][$inx]['user_id'])&&!empty($arry_member_self['submain'][$inx])){
                                                            if(trim($arry_member_self['submain'][$inx]['user_id'])!==''){
                                                                $json_html.="
                                                                    <br/>{$arry_member_self['submain'][$inx]['user_id']}
                                                                ";
                                                            }
                                                        }
                                            ...
                                            if(!empty($arry_val1)){
                                                foreach($arry_val1 as $inx=>$val1){
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_member_self['submain'][$inx])&&!empty($arry_member_self['submain'])){
                                                            $json_html.="
                                                                <br/>{$arry_member_self['submain'][$inx]}也加入此小組
                                                            ";
                                                        }
                                                        $json_html.="
                                                            </td></tr>
                        ...
                        //側欄-人(登入者看到其他人)
                            ...
                            $arrys_member_other=$oright_side->member_other($sess_user_id,$user_id,$conn_user,$conn_mssr,$arry_conn_user,$arry_conn_mssr);
                                                    ...
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_member_other['submain'][$inx])&&!empty($arry_member_other['submain'])){
                                                            if(trim($arry_member_other['submain'][$inx])!==''){
                                                                $json_html.="
                                                                    <br/>你們共同讀過：{$arry_member_other['submain'][$inx]}
                                                                ";
                                                            }
                                                        }
                                                        $json_html.="
                                                    ...
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_member_other['submain'][$inx]['user_id'])&&!empty($arry_member_other['submain'][$inx])){
                                                            if(trim($arry_member_other['submain'][$inx]['user_id'])!==''){
                                                                $json_html.="
                                                                    <br/>{$arry_member_other['submain'][$inx]['user_id']}
                                                                ";
                                                            }
                                                        }
                                            ...
                                            if(!empty($arry_val1)){
                                                foreach($arry_val1 as $inx=>$val1){
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_member_other['submain'][$inx])&&!empty($arry_member_other['submain'])){
                                                            $json_html.="
                                                                <br/>{$arry_member_other['submain'][$inx]}也加入此小組
                                                            ";
                                                        }
                                                        $json_html.="
                                                            </td></tr>
                        ...
                        //側欄-書
                            ...
                            $arrys_book=$oright_side->book($sess_user_id,$book_sid,$conn_user,$conn_mssr,$arry_conn_user,$arry_conn_mssr);
                            if(!empty($arrys_book)){
                                                    ...
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_book['submain'][$inx]['user_id'])&&!empty($arry_book['submain'][$inx])){
                                                            if(trim($arry_book['submain'][$inx]['user_id'])!==''){
                                                                $json_html.="
                                                                    <br/>{$arry_book['submain'][$inx]['user_id']}
                                                                ";
                                                            }
                                                        }
                                            ...
                                            if(!empty($arry_val1)){
                                                foreach($arry_val1 as $inx=>$val1){
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_book['submain'][$inx])&&!empty($arry_book['submain'])){
                                                            $json_html.="
                                                                <br/>他們也討論{$arry_book['submain'][$inx]}
                                                            ";
                                                        }
                                                        $json_html.="
                                                            </td></tr>
                        ...
                        //側欄-組
                            ...
                            $arrys_group=$oright_side->group($sess_user_id,$group_id,$conn_user,$conn_mssr,$arry_conn_user,$arry_conn_mssr);
                                            ...
                                            if(!empty($arry_val1)){
                                                foreach($arry_val1 as $inx=>$val1){
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_group['submain'][$inx])&&!empty($arry_group['submain'])){
                                                            $json_html.="
                                                                <br/>共討論了{$arry_group['submain'][$inx]}次
                                                            ";
                                                        }
                                                        $json_html.="
                                                            </td></tr>
                                                    ...
                                                    if($key2==='main'){
                                                        ...
                                                        if(isset($arry_group['submain'][$inx]['user_id'])&&!empty($arry_group['submain'][$inx])){
                                                            if(trim($arry_group['submain'][$inx]['user_id'])!==''){
                                                                $json_html.="
                                                                    <br/>{$arry_group['submain'][$inx]['user_id']}
                                                                ";
                                                            }
                                                        }
                                ...
                                foreach($article_results as $inx=>$article_result){
                                    ...
                                    $json_html[].="
                                        <tr align='left' style='background-color:{$tr_color};'>
                                            <!-- 討論,大解析度,start -->
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$rs_book_name}         </span></td>
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$rs_article_title}     </span></td>
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$rs_user_name}         </span></td>
                                            ...
                                            <td class='hidden-sm hidden-md hidden-lg'>
                                                <span style='position:relative;top:-5px;left:8px;font-size:16px;'>{$rs_article_title}</span><br>
                                                <span style='position:relative;top:3px;left:8px;'>
                                                    {$rs_book_name}&nbsp;&nbsp;|&nbsp;&nbsp;{$rs_user_name}
                                                </span>
                                            </td>
                                            <!-- 討論,小解析度,end -->
                                        </tr>
                                ...
                                foreach($article_results as $inx=>$article_result){
                                    ...
                                    $json_html[].="
                                        <tr align='left' style='background-color:{$tr_color};'>
                                            ...
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$rs_user_name}         </span></td>
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$rs_keyin_mdate}       </span></td>
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$rs_like_cno}          </span></td>
                                            <td class='hidden-xs'><span style='position:relative;left:8px;'>{$reply_article_cno}    </span></td>
                                            <!-- 討論,大解析度,end -->
