			...
			?>
                     <tr class="even">
                        <td><?php if($numrow_arrys_teacher!==0){?>
                			...
                			<?php }?>
                            書籍：<a href='mssr_forum_book_discussion.php?book_sid=<?php echo $book_sid?>'><?php echo $book_name?></a></td>
						<td>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p2',<?php echo $sess_uid?>,<?php echo $user_id?>,0,'<?php echo $book_sid?>',0,0,0,<?php echo $article_id;?>,0,'mssr_forum_book_reply.php?article_id=<?php echo $article_id?>')">標題：<?php echo  filter($arrys_result_title[0]['article_title']);?></a><br/>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p2',<?php echo $sess_uid?>,<?php echo $user_id?>,0,'<?php echo $book_sid?>',0,0,0,<?php echo $article_id;?>,0,'mssr_forum_book_reply.php?article_id=<?php echo $article_id?>')">發文：<?php echo  filter($article_content);?></a>
				...
				//-----------------------------------------------
					...
					<tr class="even">
                        ...
                        書籍：<a href='mssr_forum_book_discussion.php?book_sid=<?php echo $book_sid?>'><?php echo $book_name?></a></td>
						<td>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p3',<?php echo $sess_uid?>,<?php echo $user_id?>,0,'<?php echo $book_sid?>',0,0,0,<?php echo $article_id;?>,<?php echo $reply_id;?>,'mssr_forum_book_reply.php?article_id=<?php echo $article_id?>')">標題：<?php echo filter($arrys_result_title[0]['article_title']);?></a><br/>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p3',<?php echo $sess_uid?>,<?php echo $user_id?>,0,'<?php echo $book_sid?>',0,0,0,<?php echo $article_id;?>,<?php echo $reply_id;?>,'mssr_forum_book_reply.php?article_id=<?php echo $article_id?>')">#RE：<?php echo  filter($article_content);?></a>
				...
				//-----------------------------------------------
					...
					$forum_id 		= $arrys_result_forum_name[0]['forum_id'];
...
//echo "</Pre>";
					...
					<tr class="even">
						<td><?php if($numrow_arrys_teacher!==0){?>
                                ...
                                onclick="delete_article('article',<?php echo $user_id;?>,<?php echo $article_id;?>);void(0);"/>
                			<?php }?>
                        聊書小組：<a href='mssr_forum_group_index.php?forum_id=<?php echo $forum_id?>'><?php echo $arrys_result_forum_name[0]['forum_name']?></a></td>
						<td>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p4',<?php echo $sess_uid?>,<?php echo $user_id?>,0,0,0,<?php echo $book_sid; ?>,0,<?php echo $article_id;?>,0,'mssr_forum_group_reply.php?article_id=<?php echo $article_id?>')">標題：<?php echo filter($arrys_result_title[0]['article_title'])?></a><br/>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p4',<?php echo $sess_uid?>,<?php echo $user_id?>,0,0,0,<?php echo $book_sid; ?>,0,<?php echo $article_id;?>,0,'mssr_forum_group_reply.php?article_id=<?php echo $article_id?>')">發文：<?php echo filter($article_content)?></a>
                        </td>
						<td><?php echo $keyin_cdate?></td>
...
//echo "</Pre>";
					...
					<tr class="even">
                        ...
                        聊書小組：<a href='mssr_forum_group_index.php?forum_id=<?php echo $forum_id?>'><?php echo $arrys_result_forum_name[0]['forum_name']?></a></td>
						<td>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p5',<?php echo $sess_uid?>,<?php echo $user_id?>,0,0,0,<?php echo $book_sid; ?>,0,<?php echo $article_id;?>,<?php echo $reply_id;?>,'mssr_forum_group_reply.php?article_id=<?php echo $article_id?>')">標題：<?php echo  filter($arrys_result_title[0]['article_title'])?></a><br/>
                            <a onclick="logFuc('inc/add_action_forum_log/code.php','p5',<?php echo $sess_uid?>,<?php echo $user_id?>,0,0,0,<?php echo $book_sid; ?>,0,<?php echo $article_id;?>,<?php echo $reply_id;?>,'mssr_forum_group_reply.php?article_id=<?php echo $article_id?>')">#RE：<?php  echo  filter($article_content)?></a>
                        </td>
						<td><?php echo $keyin_cdate?></td>
