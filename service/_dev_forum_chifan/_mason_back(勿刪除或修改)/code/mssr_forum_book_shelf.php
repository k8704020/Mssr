...
<script>
	...
	$(document).ready(function() {
		...
		url_args={
			'pinx_name' :'pinx',
			'psize_name':'psize',
			'page_name' :'mssr_forum_book_shelf.php',
			'page_args' :{
				'book_sid':book_sid
			}
		}
...
<header>
	...
	<nav>
    	<ul>
            ...
            <li><a href="mssr_forum_book_shelf.php?book_sid=<?php echo $_GET["book_sid"];?>" style="background-image:url(image/icon_circle.png); background-repeat:no-repeat; background-position:center">看過這本書的人也看過</a></li>
