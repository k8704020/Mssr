...
<script>
	...
	$(document).ready(function() {
		...
		url_args={
			'pinx_name' :'pinx',
			'psize_name':'psize',
			'page_name' :'mssr_forum_book_discussion.php',
			'page_args' :{
				'book_sid':book_sid
			}
		}
...
<header>
    ...
    <div class="header_info">
        ...
        <p id="header_info_bookinfo">這本書有，<b><?php echo $numrow_book_article?></b>篇發文，<br/><b><?php echo $numrow_book_reply?></b>篇回覆，<b><?php echo $numrow_aside?></b>個人看<br/>過這本書，其中有<?php echo count($rs_arrys_result_friend_also_look)?>位朋友。<br/>還沒看過趕快來看呦！</p>
    </div>
	...
	<nav>
    	<ul>
            ...
            <li><a href="mssr_forum_book_discussion.php?book_sid=<?php echo $_GET["book_sid"];?>" style="background-image:url(image/icon_circle.png); background-repeat:no-repeat; background-position:center">討論</a></li>
            <li><a href="mssr_forum_book_shelf.php?book_sid=<?php echo $_GET["book_sid"];?>" >看過這本書的人也看過</a></li>
            <li><a href="mssr_forum_book_member.php?book_sid=<?php echo $_GET["book_sid"];?>">誰也看過?</a></li>
        </ul>
    </nav>
</header>
	...
	if(empty($arrys_result_article)){
		...
		for($i=0; $i<count($arrys_result_article); $i++){
            ...
            <tr class="even">
                ...
                <td class="table_bg_1">
                    <a onclick="action_log('inc/add_action_forum_log/code.php','b7',<?php echo $_SESSION["uid"];?>,<?php echo $user_id;?>,0,'<?php echo $_GET["book_sid"];?>','',0,0,<?php echo $article_id;?>,0,'mssr_forum_reply.php?article_id=<?php echo $article_id;?>');void(0);"
        	...
        	for($i=0; $i<count($arrys_result_aside); $i++){
                ...
                <figure id="book_aside_people_info">
					...
					if($get_user_info[0]['sex']==1){?>
                    	<a onclick="action_log('inc/add_action_forum_log/code.php','b4',<?php echo $_SESSION["uid"];?>,<?php echo $user_id;?>,0,'<?php echo $_GET["book_sid"];?>','',0,0,0,0,'mssr_forum_people_shelf.php?user_id=<?php echo $user_id?>');void(0);"
                    ...
                    onclick="action_log('inc/add_action_forum_log/code.php','b4',<?php echo $_SESSION["uid"];?>,<?php echo $user_id;?>,0,'<?php echo $_GET["book_sid"];?>','',0,0,0,0,'mssr_forum_people_shelf.php?user_id=<?php echo $user_id?>');void(0);"
		...
		if(count($arry_book_sid_list)!==0){
			for($i=0; $i<count($arry_list); $i++){
                ...
                <figure id="book_aside_book_info">
                    ...
                    <a onclick="action_log('inc/add_action_forum_log/code.php','b5',<?php echo $_SESSION["uid"];?>,0,0,'<?php echo $_GET["book_sid"];?>','<?php echo $book_sid;?>',0,0,0,0,'mssr_forum_book_discussion.php?book_sid=<?php echo $book_sid?>');void(0);"
                    ...
                    onclick="action_log('inc/add_action_forum_log/code.php','b5',<?php echo $_SESSION["uid"];?>,0,0,'<?php echo $_GET["book_sid"];?>','<?php echo $book_sid;?>',0,0,0,0,'mssr_forum_book_discussion.php?book_sid=<?php echo $book_sid?>');void(0);"
		...
		if(count($arrys_result_which_group)!==0){
			for($i=0; $i<count($arrys_result_which_group); $i++){
                ...
                <figure id="book_aside_group_info">
                    ...
                    <a onclick="action_log('inc/add_action_forum_log/code.php','b6',<?php echo $_SESSION["uid"];?>,0,0,'<?php echo $_GET["book_sid"];?>','',<?php echo $forum_id;?>,0,0,0,'mssr_forum_group_discussion.php?forum_id=<?php echo $forum_id?>');void(0);"
                    ...
                    onclick="action_log('inc/add_action_forum_log/code.php','b6',<?php echo $_SESSION["uid"];?>,0,0,'<?php echo $_GET["book_sid"];?>','',<?php echo $forum_id;?>,0,0,0,'mssr_forum_group_discussion.php?forum_id=<?php echo $forum_id?>');void(0);"
