...
<body>
		...
		<!--顯示BAR條-->
       	<div style="left:140px; top:0px; position: absolute;"> 
            ...
            <!-- 頭像位置"img/btn/ui_1.png",
					...
					"img/btn/head_m.png" -->
            <div>
            	<div align="left" style="position:absolute; left:-78px; top:78px; width:280px; height:40px; background-color:#4B1E0A; opacity:0.7;" class="ba_1"></div>
            	<div id = "branch_name" align="left" style="left:-51px; top:70px; width:280px; font:bold; font-size:36px; position: absolute; color:#FFF" class="world_bar2"></div>
          ...
          <div style="left:71px; top:114px; width:600px; position: absolute;">
            <table>
            	<tr>
                    ...
                    <td width="108" style=" font-size:22px">
                    	 - 升級所需
                    </td>
                    <td id= "up_branch_need_coin" width="80" style=" font-size:22px; color:#F00 ">
                    	 
                    </td>
                    <td width="49" style=" font-size:22px">
                    	剩餘
                    </td>
		...
		<!--顯示按鈕列表-->
       	<div style="left:0px; top:0px; position: absolute;"> 
            ...
            <!--升級-->
            <img src= "img/btn/btn_up_branch.png" onClick="open_lv_up_branch()"  style="left:19px; top:256px; position: absolute; cursor: pointer;">
        	<!--回到大地圖-->
		...
		<div id="mission" style="left:0px; top:0px; display:none; position: absolute;" >
            ...
            <img src= "img/person/saver_f.png" style="left:334px; top:180px; position: absolute;">
            ...
            根據市場調查。<BR>最近客人比較喜歡買<div style="color:#FF0000;display:inline;font-size:30px;" id="mission_content_branch">生活</div>
            <BR>類的書籍。<BR>
			右邊為幾位客人的意見。<BR>
			<BR>
			店長您覺得哪位的意見<BR>比較好呢？
...
<script>
		...
		function open_mission(value,value_2)
		{
			...
			//367 設定文字說明
			window.document.getElementById("mission_content_tittle").innerHTML = mission_array[value]['task_name'];
		...
		function set_scene(lv,type)
		{
			...
			if(lv == 1)
			{
				...
				'<div id="layer_person_3"></div><div id="layer_person_2"></div><img src= "img/Scene/LV_1_back.png" style="left:0px; top:0px; position: absolute;"><img src= "img/person/saver_m.png" style="left:452px; top:161px; position: absolute;"><div id = "layer_person_1"></div>';
			}else if(lv == 2)
			{
				window.document.getElementById("scene").innerHTML = 
           		'<img src= "img/Scene/LV_2_3_back.png" style="left:0px; top:0px; position: absolute;"><img src= "img/Scene/LV_2_3_layer1.png" style="left:142px; top:119px; position: absolute;"><div id="layer_person_3"></div><img src= "img/Scene/LV_2_3_layer2.png" style="left:386px; top:116px; position: absolute;"><div id="layer_person_2"></div><img src= "img/person/saver_m.png" width="100" ="100px" style="left:257px; top:186px; position: absolute;"><img src= "img/Scene/LV_2_3_layer3.png" style="left:197px; top:300px; position: absolute;"><img src= "img/Scene/branch_2/LV_2_door.png" style="left:0px; top:0px; position: absolute;"><div id="layer_person_1"></div>';
		...
		function set_person()
		{
			...
			}
			{
				...
				person_list[tmp]["left"] = new Array("290","646","568");
		...
		function set_lv_up_branch()
		{
			...
			if(up_branch_spent_coin == -1 )
			{
				...
				window.document.getElementById("up_branch_help").innerHTML= "商店已升級最高階";
			} 
		...
		{
			window.location="../branch/index_php.php?user_id="+user_id+"&branch_id="+branch_id+"";
		}
		...
		function show_prompt(value,mode)
		{
			...
			{//書本提示貼紙
				...
				window.document.getElementById('prompt_pic_'+branch_rank).src = "img/mission/"+branch_rank+".png";
			}
