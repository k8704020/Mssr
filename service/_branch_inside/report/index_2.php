...
<Body>
    ...
    <div id="container">
        ...
        <div id="navbar">
            <table cellpadding="0" cellspacing="0" border="0" width="800px" height="50px" style="color:#000099;font-size:14pt;"/>
                <tr align="center">
                    ...
                    <td width="200px" valign="middle" bgcolor="#ffdabd" onmouseover="mouse_over(this);void(0);"style="border:1px solid #ff0000;">書籍推薦   </td>
        ...
        <!-- 內容區塊 開始 -->
        <table cellpadding="0" cellspacing="0" border="0" width="800px" style='font-size:14pt;'/>
            <tr align="center" style="color:#000099; border:0px solid #ffdabd;">
                <td width="" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">書籍名稱       </td>

                <td width="70px" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">評星      </td>
                <td width="70px" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">繪圖      </td>
                <td width="70px" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">文字      </td>
                <td width="70px" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">朗讀      </td>
                <td width="110px" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">進貨日期  </td>
                <!-- <td width="" valign="middle" height="30px" bgcolor="#ffffff" style="border:0px solid #ffdabd;">推薦期限       </td> -->
            </tr>
            <tr align="center">
                <td valign="middle" height="300px" colspan="6" bgcolor="#ffdabd">
                    <iframe id="IFC" name="IFC" src="book/rec.php?branch_id=<?php echo (int)$branch_id;?>&user_id=<?php echo (int)$user_id;?>" frameborder="0"
