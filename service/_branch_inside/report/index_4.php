    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            if(!empty($arrys_result)){
                $user_branch_cs=(int)($arrys_result[0]['branch_cs']);
                $branch_rank   =(int)($arrys_result[0]['branch_rank']);
            }else{
                $user_branch_cs=(int)0;
                $branch_rank   =(int)1;
            }
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                WHERE 1=1
                    AND `branch_id`  ={$branch_id  }
                    AND `branch_rank`={$branch_rank}+1
                LIMIT 1;
            ";
            $arrys_result=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
            if(!empty($arrys_result)){
                $branch_cs =(int)($arrys_result[0]['branch_cs']);
                $spent_coin=(int)($arrys_result[0]['spent_coin']);
            }else{
                $branch_cs ='--';
                $spent_coin='--';
            }
...
<Body>
    ...
    <div id="container">
        ...
        <div id="navbar">
            <table cellpadding="0" cellspacing="0" border="0" width="800px" height="50px" style="color:#000099;font-size:14pt;"/>
                <tr align="center">
                    ...
                    <td width="200px" valign="middle" bgcolor="#c9dbfd" onmouseover="mouse_over(this);void(0);" onclick="change_page(3)">分店概況           </td>
                    <td width="200px" valign="middle" bgcolor="#caf3ff" onmouseover="mouse_over(this);void(0);" style="border:1px solid #ff0000;">營收報表  </td>
                </tr>
            </table>
        </div>
        <!-- 導航區塊 結束 -->
        ...
        <!-- 內容區塊 開始 -->
        <div id="content_4">
            <table cellpadding="0" cellspacing="0" border="0" width="800px" height="330px" style="color:#000099;font-size:14pt;"/>
                <tr align="center">
                    <td valign="middle" height="30px" style="border:2px solid #caf3ff;" colspan='4'>每週營業額</td>
                </tr>
                <tr align="center">
                    <td valign="middle" width='200px' height="30px" bgcolor="#caf3ff" style='color:#000000;'>
                        時間
                    </td>
                    <td valign="middle" width='200px' height="30px" bgcolor="#caf3ff" style='color:#000000;'>
                        顧客量
                    ...
                    <td valign="middle" width='200px' height="30px" bgcolor="#91C0E3" style='color:#000000;'>
                        營業額
                    </td>
                </tr>
                <tr align="center">
                    <td valign="middle" height="240px" bgcolor="#caf3ff" colspan='4'>
                        <iframe id="task_doing" src="revenue/revenue.php?branch_id=<?php echo (int)$branch_id;?>&user_id=<?php echo (int)$user_id;?>" frameborder="0"
                        style="width:100%;height:230px;overflow:hidden;overflow-y:auto;"></iframe>
                    </td>
                </tr>
                <!-- <tr align="center">
                    <td valign="middle" width='250px' height="30px" bgcolor="#ffffff" colspan='2' style="border:2px solid #caf3ff;">
                        升店條件
                    </td>
                    <td valign="middle" width='250px' height="30px" bgcolor="#ffffff" style="border:2px solid #caf3ff;">
                        <img src="../img/bar/star.png" width="20px" height="20px" border="0" alt="滿意度"/>
                        <?php echo $user_branch_cs;?>/<?php echo $branch_cs;?>
                    </td>
                    <td valign="middle" width='' height="30px" bgcolor="#ffffff" style="border:1px solid #caf3ff;">
                        <img src="../img/bar/coin.png" width="20px" height="20px" border="0" alt="葵幣"/>
                        <?php echo $user_coin;?>/<?php echo $spent_coin;?>
                    </td>
                </tr> -->
            </table>
        </div>
