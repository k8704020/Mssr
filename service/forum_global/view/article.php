    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_article_book_rev`.`book_sid`='{$get_book_sid}'
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_from`     =1 -- 文章來源
            ...
            $sql="
                ...
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_reply_book_rev`.`book_sid`='{$get_book_sid}'
                    AND `mssr_forum_global`.`mssr_forum_reply`.`reply_from`       =1 -- 回文來源
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    ...
                    `mssr_forum_global`.`mssr_forum_article`.`article_like_cno`,
                    `mssr_forum_global`.`mssr_forum_article`.`article_report_cno`,
                ...
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_from` =1 -- 文章來源
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_type` =1 -- 文章類型
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_state`=1 -- 文章狀態
            ";
            if($book_isbn_10!=='')$sql.="AND `mssr_forum_global`.`mssr_forum_article_book_rev`.`book_isbn_10`='{$book_isbn_10}'";
            if($book_isbn_13!=='')$sql.="AND `mssr_forum_global`.`mssr_forum_article_book_rev`.`book_isbn_13`='{$book_isbn_13}'";
            if($book_isbn_10===''&&$book_isbn_13==='')$sql.="AND `mssr_forum_global`.`mssr_forum_article_book_rev`.`book_sid`='{$get_book_sid}'";
            $sql.="ORDER BY `mssr_forum_global`.`mssr_forum_article`.`keyin_cdate` DESC";
            ...
            if(isset($sess_user_id)){
                $sql="
                    ...
                    WHERE 1=1
                        ...
                        AND `mssr_forum_global`.`mssr_forum_hot_booklist`.`book_sid`  ='{$get_book_sid}'
            ...
            if(isset($sess_user_id)){
                $sql="
                    ...
                    WHERE 1=1
                        ...
                        AND `mssr_forum_global`.`mssr_forum_track_book`.`book_sid`  ='{$get_book_sid}'
                ";
            ...
            if(isset($sess_user_id)){
                $sql="
                    ...
                    WHERE 1=1
                        ...
                        AND `mssr_forum_global`.`mssr_forum_article_draft`.`book_sid`='{$get_book_sid  }'
                        AND `mssr_forum_global`.`mssr_forum_article_draft`.`group_id`= {$get_group_id  }
                ";
                                ...
                                foreach($article_results as $inx=>$article_result):
                                    ...
                                    $sql="
                                        ...
                                        FROM `mssr_forum_global`.`mssr_forum_reply_book_rev`
                                            ...
                                            `mssr_forum_global`.`mssr_forum_reply_book_rev`.`reply_id`=`mssr_forum_global`.`mssr_forum_reply`.`reply_id`
                                        WHERE 1=1
                                            AND `mssr_forum_global`.`mssr_forum_reply_book_rev`.`article_id`= {$rs_article_id}
                                            AND `mssr_forum_global`.`mssr_forum_reply`.`reply_state`=1
                                    ";
                                    $reply_article_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
                                    $reply_article_cno=(int)($reply_article_results[0]['cno']);
                            ?>
                                            ...
                                            <form id="Form1"  name="Form1" method="post" onsubmit="return false;">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                                                        <div class="form-group">
                                                            <textarea class="form-control article_content" id="article_content[]" name="article_content[]" rows="10" placeholder="2.請輸入文章內容"></textarea>
                                                        </div>
                                                    </div>
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    ...
                    `mssr_forum_global`.`mssr_forum_group`.`group_content`,
                    `mssr_forum_global`.`mssr_forum_group`.`group_rule`,
                    `mssr_forum_global`.`mssr_forum_group`.`group_type`,
                    `mssr_forum_global`.`mssr_forum_group`.`group_state`
                FROM `mssr_forum_global`.`mssr_forum_group`
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_group`.`group_id`={$get_group_id}
            ";
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_group`.`group_id`={$get_group_id}
                    AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_id`={$sess_user_id}
        ...
        //-----------------------------------------------
            ...
            $sql="
                    SELECT
                        ...
                        `mssr_forum_global`.`mssr_forum_article_book_rev`.`book_sid`,
                        `mssr_forum_global`.`mssr_forum_article_book_rev`.`country_code` AS `book_country_code`,

                        `mssr_forum_global`.`mssr_forum_article`.`user_id`,
                        `mssr_forum_global`.`mssr_forum_article`.`user_country_code`,
                    ...
                    FROM `mssr_forum_global`.`mssr_forum_article_book_rev`
                        ...
                        `mssr_forum_global`.`mssr_forum_article`.`user_id`=`user`.`member`.`uid`
                    WHERE 1=1
                        AND `mssr_forum_global`.`mssr_forum_article`.`article_from` =2 -- 文章來源
                        AND `mssr_forum_global`.`mssr_forum_article`.`article_state`=1 -- 文章狀態
                        AND `mssr_forum_global`.`mssr_forum_article`.`group_id`     ={$get_group_id}
                ...
                UNION ALL
                    ...
                    SELECT
                        ...
                        `mssr_forum_global`.`mssr_forum_reply_book_rev`.`country_code` AS `book_country_code`,

                        `mssr_forum_global`.`mssr_forum_reply`.`user_id`,
                        `mssr_forum_global`.`mssr_forum_reply`.`user_country_code`,
                    ...
                    FROM `mssr_forum_global`.`mssr_forum_reply_book_rev`
                        ...
                        `mssr_forum_global`.`mssr_forum_article`.`article_id`=`mssr_forum_global`.`mssr_forum_article_detail`.`article_id`
                    WHERE 1=1
                        AND `mssr_forum_global`.`mssr_forum_reply`.`reply_from` =2 -- 文章來源
                        AND `mssr_forum_global`.`mssr_forum_article`.`article_state`=1 -- 文章狀態
                        AND `mssr_forum_global`.`mssr_forum_reply`.`reply_state`=1 -- 回文狀態
                        AND `mssr_forum_global`.`mssr_forum_reply`.`group_id`   ={$get_group_id}
            ...
            if(!empty($db_results)){
                ...
                foreach($db_results as $db_result){
                    ...
                    $rs_book_country_code   =trim($rs_book_country_code);
                    $rs_user_country_code   =trim($rs_user_country_code);
                    $rs_user_account        =trim($rs_account);
                    ...
                    $article_reply_results[$rs_keyin_time][trim('book_country_code  ')]=$rs_book_country_code;
                    $article_reply_results[$rs_keyin_time][trim('user_country_code  ')]=$rs_user_country_code;
                    $article_reply_results[$rs_keyin_time][trim('user_account       ')]=$rs_user_account;

                    if(in_array($rs_user_country_code,array('sg','hk'))){
                        $tmp_user_id[]=$rs_user_id;
                    }
                }
                //時間排序
                krsort($article_reply_results);

                $tmp_user_id=implode(",",$tmp_user_id);
                if($tmp_user_id!==''){
                    $sql="
                        SELECT
                            `uid`,`name`,`sex`,`account`
                        FROM `user`.`member`
                        WHERE 1=1
                            AND `user`.`member`.`uid` IN ({$tmp_user_id})
                    ";
                    $db_results=db_result($conn_type='pdo','',$sql,array(),$arry_conn_mssr_hk);
                    if(!empty($db_results)){
                        foreach($db_results as $db_result){
                            $rs_user_id=(int)$db_result['uid'];
                            $rs_user_name=trim($db_result['name']);
                            $rs_user_account=trim($db_result['account']);
                            $rs_user_sex =(int)$db_result['sex'];
                            if($rs_user_sex===1)$rs_user_img='../img/default/user_boy.png';
                            if($rs_user_sex===2)$rs_user_img='../img/default/user_girl.png';
                            foreach($article_reply_results as $inx=>$article_reply_result){
                                $article_reply_user_id=(int)$article_reply_result['user_id'];
                                if($rs_user_id===$article_reply_user_id){
                                    $article_reply_results[$inx]['user_name']=$rs_user_name;
                                    $article_reply_results[$inx]['user_account']=$rs_user_account;
                                }
                            }
                        }
                    }
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_reply`.`group_id`   ={$get_group_id}
                    AND `mssr_forum_global`.`mssr_forum_reply`.`reply_from` =2 -- 回文來源
                    AND `mssr_forum_global`.`mssr_forum_reply`.`reply_state`=1 -- 回文狀態
            ";
            $reply_article_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
            $reply_article_cno=(int)($reply_article_results[0]['cno']);
            ...
            ";
            $db_results=db_result($conn_type='pdo',$conn_mssr_country,$sql,array(),$arry_conn_mssr_country);
            if(!empty($db_results)){
                $tmp_arry_class_code=[];
                foreach($db_results as $db_result){
                    $tmp_arry_class_code[]=trim($db_result['class_code']);
                }
                $tmp_arry_class_code=implode("','",$tmp_arry_class_code);
            }

            if($tmp_arry_class_code!==''){
                $sql="
                        SELECT `user`.`student`.`uid`, `user`.`member`.`name`
                        FROM `user`.`member`
                            INNER JOIN `user`.`student` ON
                            `user`.`member`.`uid`=`user`.`student`.`uid`
                        WHERE 1=1
                            AND `user`.`student`.`end`>=NOW()
                            AND `user`.`student`.`class_code` IN ('{$tmp_arry_class_code}')

                    UNION

                        SELECT `user`.`teacher`.`uid`, `user`.`member`.`name`
                        FROM `user`.`member`
                            INNER JOIN `user`.`teacher` ON
                            `user`.`member`.`uid`=`user`.`teacher`.`uid`
                        WHERE 1=1
                            AND `user`.`teacher`.`end`>=NOW()
                            AND `user`.`teacher`.`class_code` IN ('{$tmp_arry_class_code}')
                ";
                $db_results=db_result($conn_type='pdo',$conn_mssr_country,$sql,array(),$arry_conn_mssr_country);
                if(!empty($db_results)){
                    foreach($db_results as $db_result){
                        $rs_uid =(int)$db_result['uid'];
                        $rs_name=trim($db_result['name']);
                        $arry_forum_friend[(int)$rs_uid]=$rs_name;
                    }
                }
                $sql="
                    SELECT
                    ...
                    WHERE 1=1
                        AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`group_id` IN (
                            SELECT
                                `mssr_forum_global`.`mssr_forum_group_user_rev`.`group_id`
                            FROM `mssr_forum_global`.`mssr_forum_group_user_rev`
                            WHERE 1=1
                                AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_id`={$sess_user_id}
                        )
                        ...
                        AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_id`<>{$sess_user_id}
                ";
                $db_results=db_result($conn_type='pdo','',$sql,array(),$arry_conn_mssr_tw);
                if(!empty($db_results)){
                    foreach($db_results as $db_result){
                        $rs_user_id=(int)$db_result['user_id'];
                        $rs_user_country_code=trim($db_result['user_country_code']);
                        $rs_arry_conn_mssr_country_code="arry_conn_mssr_{$rs_user_country_code}";
                        $rs_arry_conn_mssr_country_code=$$rs_arry_conn_mssr_country_code;
                        $sql="
                            SELECT `user`.`member`.`uid`, `user`.`member`.`name`
                            FROM `user`.`member`
                            WHERE 1=1
                                AND `user`.`member`.`uid`={$rs_user_id}
                        ";
                        $db_results2=db_result($conn_type='pdo','',$sql,array(),$rs_arry_conn_mssr_country_code);
                        if(!empty($db_results2)){
                            $arry_forum_friend[(int)$db_results2[0]['uid']]=trim($db_results2[0]['name']);
                        }
                    }
                }
            }
            //echo "<Pre>";print_r($arry_forum_friend);echo "</Pre>";
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    `mssr_forum_global`.`mssr_forum_group_booklist`.`book_sid`,
                    `mssr_forum_global`.`mssr_forum_group_booklist`.`country_code`
                FROM `mssr_forum_global`.`mssr_forum_group_booklist`
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_group_booklist`.`group_id`={$get_group_id}
                ORDER BY `mssr_forum_global`.`mssr_forum_group_booklist`.`keyin_cdate` DESC
            ";
            $group_book_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
            if(!empty($group_book_results)){
                foreach($group_book_results as $inx=>$group_book_result){
                    $rs_book_sid=trim($group_book_result['book_sid']);
                    $rs_book_country_code=trim($group_book_result['country_code']);
                    $rs_arry_conn_country="arry_conn_mssr_{$rs_book_country_code}";
                    $rs_arry_conn_country=$$rs_arry_conn_country;
                    $arry_book_infos=get_book_info('',$rs_book_sid,$array_filter=array('book_name'),$rs_arry_conn_country);
                    if(empty($arry_book_infos))continue;
                    $rs_book_name=(trim($arry_book_infos[0]['book_name']));
                    $rs_book_name=str_replace("'","",$rs_book_name);
                    $arry_group_booklist[$rs_book_sid]=$rs_book_name;
                    $group_book_results[$inx]['book_name']=$rs_book_name;
                }
            }
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                FROM `mssr_forum_global`.`mssr_forum_group`
                    ...
                    INNER JOIN `user`.`member` ON
                    `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_id`=`user`.`member`.`uid`
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`group_id`={$get_group_id}
                ORDER BY `mssr_forum_global`.`mssr_forum_group_user_rev`.`keyin_cdate` DESC
            ";
            ...
            foreach($group_user_results as $group_user_result){
                ...
                $rs_user_country_code=trim($group_user_result['user_country_code']);
                if(in_array($rs_user_country_code,array('sg','hk'))){
                    $tmp_user_id[]=$rs_user_id;
                }
            }
            ...
            if($tmp_user_id!==''){
                ...
                if(!empty($db_results)){
                    foreach($db_results as $db_result){
                        ...
                        if($rs_user_sex===1)$rs_user_img='../img/default/user_boy.png';
                        if($rs_user_sex===2)$rs_user_img='../img/default/user_girl.png';
                        foreach($group_user_results as $inx=>$group_user_result){
                            $group_user_id=(int)$group_user_result['user_id'];
                            if($rs_user_id===$group_user_id){
                                //echo "<Pre>";print_r($group_user_id);echo "</Pre>";
                                $group_user_results[$inx]['name']   =$rs_user_name;
                                $group_user_results[$inx]['sex']    =$rs_user_sex;
                                $group_user_results[$inx]['account']=$rs_user_account;
                            }
                            if(array_key_exists($group_user_id,$arry_forum_friend)){
                                unset($arry_forum_friend[$group_user_id]);
                            }
                        }
                    }
                }
            }
            if($sess_user_id===5090){
                //echo "<Pre>";print_r($group_user_results);echo "</Pre>";
                //echo "<Pre>";print_r($arry_forum_friend);echo "</Pre>";
            }
        ...
        //-----------------------------------------------
            ...
            $best_article_category_results=[];
            //$sql="
            //    SELECT
            //        `mssr_forum_global`.`mssr_forum_best_article_category`.`cat_id`,
            //        `mssr_forum_global`.`mssr_forum_best_article_category`.`cat_name`
            //    FROM  `mssr_forum_global`.`mssr_forum_best_article_category`
            //    WHERE 1=1
            //        AND `mssr_forum_global`.`mssr_forum_best_article_category`.`group_id` ={$get_group_id}
        ...
        //-----------------------------------------------
            ...
            if(isset($sess_user_id)){
                $sql="
                    ...
                    ORDER BY `mssr`.`mssr_rec_book_cno`.`keyin_cdate` DESC
                ";
                $sess_user_book_results=db_result($conn_type='pdo',$conn_mssr_country,$sql,array(),$arry_conn_mssr_country);
            }
        ...
        //-----------------------------------------------
            ...
            //$sql="
            //    SELECT `mssr_forum_global`.`mssr_forum_group_report_log`.`group_id`
            //    FROM `mssr_forum_global`.`mssr_forum_group_report_log`
            //    WHERE 1=1
            //        AND `mssr_forum_global`.`mssr_forum_group_report_log`.`user_id` ={$sess_user_id}
            //        AND `mssr_forum_global`.`mssr_forum_group_report_log`.`group_id`={$get_group_id}
            //    LIMIT 1;
            //";
        ...
        //-----------------------------------------------
            ...
            //        AND `mssr_forum_global`.`mssr_forum_track_group`.`group_id`= {$get_group_id}
            //";
            ...
            //            AND `mssr_forum_global`.`mssr_forum_blacklist_group_school`.`group_id`   =  {$get_group_id    }
            //    ";
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    `mssr_forum_global`.`mssr_forum_style_group_rev`.`style_id`,
                    `mssr_forum_global`.`mssr_forum_style_group_rev`.`style_from`
                FROM `mssr_forum_global`.`mssr_forum_style_group_rev`
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_style_group_rev`.`group_id`={$get_group_id}
            ";
                ...
                <span class="jumbotron_name">
                    ...
                    if(!empty($group_user_results)){
                        ...
                        foreach($group_user_results as $group_user_result):
                            ...
                            $rs_user_name        =trim($group_user_result['name']);
                            $rs_user_country_code=trim($group_user_result['user_country_code']);
                            $rs_arry_conn_country="arry_conn_mssr_{$rs_user_country_code}";
                            $rs_arry_conn_country=$$rs_arry_conn_country;
                ...
                <div class="group_lefe_side col-xs-12 col-sm-10 col-md-10 col-lg-10">
                    <ul id="myTab" class="nav nav-tabs" role="tablist">
                        ...
                        <?php if(1===1):?>
                            ...
                            <?php if($user_type!==0 && $user_state!==0):?>
                                <li role="presentation" class="hidden-xs"><a href="#add_article" id="profile-tab" role="tab" data-toggle="tab" aria-controls="profile">
                                    發文
                                </a></li>
                            <?php endif;?>
                            <li role="presentation" class="<?php if($tab===4)echo 'active';?> hidden-xs"><a href="#book" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">
                                小組書單
                            </a></li>
                            ...
                            <li role="presentation" class="dropdown hidden-sm hidden-md hidden-lg">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                                    ...
                                    <li><a href="#book" tabindex="-1" role="tab" class="<?php if($tab===4)echo 'active';?>" id="dropdown1-tab" data-toggle="tab" aria-controls="dropdown1">小組書單</a></li>
                                    <li><a href="#friend" tabindex="-1" role="tab" class="<?php if($tab===5)echo 'active';?>" id="dropdown1-tab" data-toggle="tab" aria-controls="dropdown1">小組成員</a></li>
                                </ul>
                            </li>
                        <?php endif;?>
                    </ul>
                            ...
                            <table class="group_lefe_side_tab1 table table-striped">
                                <?php if(!empty($article_reply_results)):?>
                                    <thead class=""><tr class="second_tr" align="left">
                                        ...
                                        <td width="250px"><span>發表時間</span></td>
                                        <td width="50px" class="hidden-xs"><span>讚 </span></td>
                                        <td width="50px" class="hidden-xs"> <span>回應    </span></td>
                                    </tr></thead>
                                    <tbody>
                                        <?php
                                            $cno=0;
                                            ...
                                            //echo "<Pre>";print_r($rs_article_id);echo "</Pre>";
                                            if(!in_array($rs_article_id, $tmp_article_id)){
                                                $tmp_article_id[]=$rs_article_id;
                                            }else{
                                                continue;
                                            }
                                        ...
                                        <tr align="left">
                                            ...
                                            <td class="hidden-xs" style="border:0px;">
                                                <?php echo htmlspecialchars($reply_article_cno);?>
                                            </td>
                                        </tr>
                                        <?php $cno++;}endforeach;?>
                                    </tbody>
                                ...
                                <div class="group_lefe_side_tab2 row">
                                    <?php
                                        ...
                                        foreach($group_book_results as $group_book_result):
                                            $rs_book_sid=trim($group_book_result['book_sid']);
                                            $rs_country_code=trim($group_book_result['country_code']);
                                            $rs_book_name   =trim($group_book_result['book_name']);
                                            $rs_arry_conn_country="arry_conn_mssr_{$rs_country_code}";
                                            $rs_arry_conn_country=$$rs_arry_conn_country;
                                            if($rs_book_sid!==''){
                                                if(mb_strlen($rs_book_name)>20){
                                                    $rs_book_name=mb_substr($rs_book_name,0,20)."..";
                            ...
                            <div class="group_lefe_side_tab3 row">
                                ...
                                if(!empty($group_user_results)){
                                    ...
                                    foreach($group_user_results as $group_user_result):
                                        ...
                                        $rs_arry_conn_country="arry_conn_mssr_{$rs_user_country_code}";
                                        $rs_arry_conn_country=$$rs_arry_conn_country;
                                        $rs_user_sex    =(int)$group_user_result['sex'];
                                        $rs_user_name   =trim($group_user_result['name']);
                                        $rs_user_account=trim($group_user_result['account']);
                                ...
                                <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                                    <div class="thumbnail">
                                        <a href="user.php?user_id=<?php echo $rs_user_id;?>&tab=1&account=<?php echo $rs_user_account;?>" onclick="block_ui('網頁讀取中...');">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="article" aria-labelledBy="profile-tab">
                            <table class="group_lefe_side_tab1 table table-striped table_article">
                                <thead class="hidden-xs"><tr class="second_tr" align="left">
                                    <!-- <td width="220"><span>討論書籍</span></td> -->
                                    <td width="">   <span>文章標題</span></td>
                                    <td width="200"><span>姓名    </span></td>
                                    <td width="200"><span>時間    </span></td>
                                    <td width="50"> <span>讚      </span></td>
                                    <td width="50"> <span>回應    </span></td>
                                </tr></thead>
                                <tbody>
                                <?php if(!empty($article_reply_results)){
                                    foreach($article_reply_results as $article_reply_result):
                                        ...
                                        $rs_user_account=trim($rs_user_account);
                                        ...
                                        $a_href_3="user.php?user_id={$rs_user_id}&tab=1&account={$rs_user_account}";
                                ...
                                <tr align="left">
                                    ...
                                    <!-- <td class="hidden-xs" style="border:0px;"><a href="<?php //echo $a_href_1;?>"><?php echo htmlspecialchars($rs_book_name);?></a></td> -->
                                    <td class="hidden-xs" style="border:0px;"><a href="<?php echo $a_href_2;?>" target="_blank"><?php echo htmlspecialchars($rs_article_title);?></a></td>
                                    <td class="hidden-xs" style="border:0px;"><a href="<?php echo $a_href_3;?>" onclick="block_ui('網頁讀取中...');"><?php echo htmlspecialchars($rs_user_name);?></a></td>
                                    <td class="hidden-xs" style="border:0px;"><?php echo htmlspecialchars($rs_keyin_cdate);?></td>
                                    ...
                                    <td class="hidden-sm hidden-md hidden-lg" style="border:0px;<?php if(isset($inx)&&$inx===0)echo 'position:relative;top:-5px;';?>">
                                        ...
                                        <span style="position:relative;top:5px;">
                                            <a href="<?php echo $a_href_1;?>"><?php echo htmlspecialchars($rs_book_name);?></a>
                                            &nbsp;&nbsp;|&nbsp;&nbsp;
                                            <a href="<?php echo $a_href_3;?>" onclick="block_ui('網頁讀取中...');"><?php echo htmlspecialchars($rs_user_name);?></a>
                                        </span>
                                    </td>
                                    <!-- 討論,小解析度,end -->
...
?>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="add_article" aria-labelledBy="profile-tab">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <?php if($user_type!==0 && $user_state!==0 && !empty($arry_group_booklist)):?>
                                        <div class="row eagle_lv_5" style="border-right:1px solid #eeeeee;">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg12">
                                                <form id="Form1"  name="Form1" method="post" onsubmit="return false;">
                        ...
                        <!-- 書單 -->
                        <div role="tabpanel" class="tab-pane fade <?php if($tab===4)echo 'in active';?>" id="book" aria-labelledBy="profile-tab">
                            <div class="group_lefe_side_tab2 row">
                                <?php if($user_type!==0 && $user_state!==0 && $sess_school_code!=='plkcjy'):?>
                                ...
                                <?php if($sess_school_code==='plkcjy' && !in_array('i_s',$arry_user_status)):?>
                                    <div class="input-group" style="position:relative;padding:10px 20px 20px 15px;">
                                        <input type="text" class="group_booklist_book_name form-control" name="group_booklist_book_name" placeholder="請選擇或輸入一本讀過的書籍來建立小組書單">
                                        <input type="hidden" class="group_booklist_book_sid form-control" name="group_booklist_book_sid" value="">
                                        <div class="input-group-btn">
                        ...
                        <div role="tabpanel" class="tab-pane fade <?php if($tab===5)echo 'in active';?>" id="friend" aria-labelledBy="profile-tab">
                            <div class="group_lefe_side_tab3 row">
                                <?php if(in_array($sess_user_lv,array(1,2,3,99))):?>
                                    <div class="input-group" style="position:relative;padding:10px 20px 20px 15px;">
                                        <input type="text" class="group_user_name form-control" name="group_user_name" placeholder="請選擇或輸入一位人員來加入小組">
                                        <input type="hidden" class="group_user_id form-control" name="group_user_id" value="0">
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                選擇人員 <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                <?php
                                        ...
                                        <div class="input-group-btn">
                                            <button type="button" class="form-control btn btn-default btn-xs" style="position:relative;margin:0 5px;"
                                            onclick="add_join_us_group(this);void(0);">送出</button>
                                        </div>
                                    </div>
                                <?php endif;?>
...
//-------------------------------------------------------
    ...
    foreach($arry_my_borrow as $rs_book_sid=>$rs_book_name):
        ...
        $rs_book_name=addslashes(trim($rs_book_name));
    ?>
    ...
    function add_join_us_group(obj){
    //邀請人員加入小組
        ...
        if(trim($group_user_name)===''){
            arry_err.push('請選擇或輸入一位人員來邀請加入小組');
        }else{
        ...
        for(key in arry_group_user_info){
            if(arry_group_user_info[key]==$group_user_id){
                group_user_name=key;
            }
        }
            ...
            if(!confirm('你確定要送出嗎?')){
                ...
                //參數設置
                    ...
                    data       :{
                        ...
                        friend_name :(trim(group_user_name                      )),
                        method      :encodeURI(trim('add_join_us_group'         )),
                        send_url    :encodeURI(trim(send_url                    ))
                    },
    ...
    var article_content_old_val='';
    var article_content_new_val='';
    $(".article_content").keyup(function(){
        article_content_new_val=$(this).val();
        chk_article_content_val();
    });
    $(".article_content").keydown(function(){
        article_content_old_val=$(this).val();
        chk_article_content_val();
    });
    function chk_article_content_val(){
        //console.log(article_content_old_val.length);
        //console.log(article_content_new_val.length);
        if(parseInt(article_content_new_val.length) - (article_content_old_val.length) > 100){
            alert('請勿大量複製貼上!')
            $(".article_content").val(article_content_old_val);
            article_content_old_val=article_content_old_val;
            article_content_new_val=article_content_old_val;
        }
    }
