    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    ...
                    IFNULL((
                        ...
                        WHERE 1=1
                            AND `user`.`student`.`uid` = `mssr_forum_global`.`mssr_forum_article`.`user_id`
                            AND NOW() BETWEEN `user`.`semester`.`start` AND `user`.`semester`.`end`
                ...
                WHERE 1=1
                    ...
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_id`   ={$get_article_id}
            ";
            ...
            if(empty($article_results)){
                ...
                $rs_article_keyin_cdate =trim($article_results[0]['keyin_cdate']);
                ...
                $rs_article_school_code =trim($article_results[0]['school_code']);
                ...
                if(isset($file_server_enable)&&($file_server_enable)){
                    ...
                    //}
                    if(@getimagesize("http://".$arry_ftp1_info['host']."/mssr/info/user/{$rs_article_user_id}/forum/user_sticker/1.jpg")){
                        $rs_article_img="http://".$arry_ftp1_info['host']."/mssr/info/user/{$rs_article_user_id}/forum/user_sticker/1.jpg";
                    }
                }else{
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    ...
                    IFNULL((
                        ...
                        FROM `user`.`student`
                            ...
                            `user`.`class`.`semester_code`=`user`.`semester`.`semester_code`
                        WHERE 1=1
                            AND `user`.`student`.`uid` = `mssr_forum_global`.`mssr_forum_reply`.`user_id`
                            AND NOW() BETWEEN `user`.`semester`.`start` AND `user`.`semester`.`end`
                        GROUP BY `user`.`semester`.`school_code`
                        LIMIT 1
                    ),'') AS `school_code`,
                    ...
                    `mssr_forum_global`.`mssr_forum_reply`.`reply_like_cno`,
                    `mssr_forum_global`.`mssr_forum_reply`.`reply_report_cno`,
                ...
                WHERE 1=1
                    ...
                    AND `mssr_forum_global`.`mssr_forum_reply`.`article_id` ={$get_article_id}
                ORDER BY `mssr_forum_global`.`mssr_forum_reply`.`keyin_cdate` ASC
            ";
        ...
        //-----------------------------------------------
            ...
            if(isset($sess_user_id)){
                $sql="
                    ...
                    WHERE 1=1
                        ...
                        AND `mssr_forum_global`.`mssr_forum_track_article`.`article_id`={$rs_article_id}
                        AND `mssr_forum_global`.`mssr_forum_track_article`.`group_id`  ={$get_group_id }
                ";
            ...
            if(isset($sess_user_id)){
                $sql="
                    SELECT `mssr_forum_global`.`mssr_forum_article_report_log`.`user_id`
                    FROM  `mssr_forum_global`.`mssr_forum_article_report_log`
                    WHERE 1=1
                        AND `mssr_forum_global`.`mssr_forum_article_report_log`.`user_id`   ={$sess_user_id }
                        AND `mssr_forum_global`.`mssr_forum_article_report_log`.`article_id`={$rs_article_id}
                ";
            ...
            if(isset($sess_user_id)){
                $sql="
                    SELECT `mssr_forum_global`.`mssr_forum_article_like_log`.`user_id`
                    FROM  `mssr_forum_global`.`mssr_forum_article_like_log`
                    WHERE 1=1
                        AND `mssr_forum_global`.`mssr_forum_article_like_log`.`user_id`   ={$sess_user_id }
                        AND `mssr_forum_global`.`mssr_forum_article_like_log`.`article_id`={$rs_article_id}
                ";
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="view_article" aria-labelledBy="home-tab">
                                ...
                                <div class="media">
                                    ...
                                    <h4 class="media-heading">
                                        ...
                                        <?php if(isset($sess_user_id)):?>
                                            ...
                                            <?php if((in_array('i_t',$arry_user_status)&&$rs_article_school_code===$sess_school_code)||in_array('i_a',$arry_user_status)):?>
                                            ...
                                            <?php if((in_array('i_t',$arry_user_status)&&$rs_article_school_code!==$sess_school_code)||in_array('i_a',$arry_user_status)):?>
                                                <button type="button" class="btn_blacklist_article btn btn-default btn-xs pull-right hidden-xs"
                                                article_id=<?php echo $rs_article_id;?>>遮蔽文章</button>
                                            <?php endif?>
                                        ...
                                        <?php if(isset($sess_user_id)):?>
                                            <div class="btn-group pull-right hidden-sm hidden-md hidden-lg">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <?php if((in_array('i_t',$arry_user_status)&&$rs_article_school_code!==$sess_school_code)||in_array('i_a',$arry_user_status)):?>
                                                        <li><a href="javascript:void(0);" class="btn_blacklist_article"
                                                        article_id=<?php echo $rs_article_id;?>>遮蔽文章</a></li>
                                                    <?php endif?>
                                        ...
                                        <div><?php echo htmlspecialchars($rs_article_keyin_cdate);?>&nbsp;#1</div>
                        ...
                        <?php if(!empty($reply_results)){
                            foreach($reply_results as $inx=>$reply_result):
                                ...
                                $rs_reply_keyin_cdate   =trim($reply_result['keyin_cdate']);
                                ...
                                $rs_reply_school_code   =trim($reply_result['school_code']);
                                ...
                                if(!empty($db_results)){
                                    ...
                                    if(isset($file_server_enable)&&($file_server_enable)){
                                        ...
                                        //}
                                        if(@getimagesize("http://".$arry_ftp1_info['host']."/mssr/info/user/{$rs_reply_user_id}/forum/user_sticker/1.jpg")){
                                            $rs_reply_img="http://".$arry_ftp1_info['host']."/mssr/info/user/{$rs_reply_user_id}/forum/user_sticker/1.jpg";
                                        }
                                    }else{
                                ...
                                if(isset($sess_user_id)){
                                    $sql="
                                        SELECT `mssr_forum_global`.`mssr_forum_reply_report_log`.`user_id`
                                        FROM  `mssr_forum_global`.`mssr_forum_reply_report_log`
                                        WHERE 1=1
                                            AND `mssr_forum_global`.`mssr_forum_reply_report_log`.`user_id` ={$sess_user_id }
                                            AND `mssr_forum_global`.`mssr_forum_reply_report_log`.`reply_id`={$rs_reply_id  }
                                    ";
                                ...
                                if(isset($sess_user_id)){
                                    $sql="
                                        SELECT `mssr_forum_global`.`mssr_forum_reply_like_log`.`user_id`
                                        FROM  `mssr_forum_global`.`mssr_forum_reply_like_log`
                                        WHERE 1=1
                                            #AND `mssr_forum_global`.`mssr_forum_reply_like_log`.`user_id` ={$sess_user_id }
                                            AND `mssr_forum_global`.`mssr_forum_reply_like_log`.`reply_id`={$rs_reply_id  }
                                    ";
                                ...
                                <div class="media">
                                    ...
                                    <h4 class="media-heading">
                                        ...
                                        <?php if(isset($sess_user_id)):?>
                                            ...
                                            <?php if((in_array('i_t',$arry_user_status)&&$rs_reply_school_code===$sess_school_code)||in_array('i_a',$arry_user_status)):?>
                                            ...
                                            <?php if((in_array('i_t',$arry_user_status)&&$rs_reply_school_code!==$sess_school_code)||in_array('i_a',$arry_user_status)):?>
                                                <button type="button" class="btn_blacklist_reply btn btn-default btn-xs pull-right hidden-xs"
                                                reply_id=<?php echo $rs_reply_id;?>>遮蔽回覆</button>
                                            <?php endif?>
                                        ...
                                        <?php if(isset($sess_user_id)):?>
                                            <div class="btn-group pull-right hidden-sm hidden-md hidden-lg">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <?php if((in_array('i_t',$arry_user_status)&&$rs_reply_school_code!==$sess_school_code)||in_array('i_a',$arry_user_status)):?>
                                                        <li><a href="javascript:void(0);" class="btn_blacklist_reply"
                                                        reply_id=<?php echo $rs_reply_id;?>>遮蔽回覆</a></li>
                                                    <?php endif?>
                                        ...
                                        <div><?php echo htmlspecialchars($rs_reply_keyin_cdate);?>&nbsp;#<?php echo ($pinx*$psize)-$psize+2;?></div>
                                    </h4>
                                    <div class="pull-right media-body">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg12">
                                                            <form id="Form1" name="Form1" method="post" onsubmit="return false;">
                                                                <div class="div_textarea form-group" style="margin-top:15px;">
                                                                    <textarea class="form-control" id="reply_content[]" name="reply_content[]" rows="6" placeholder=""></textarea>
                                                                </div>
                                                                ...
                                                                <div class="form-group hidden">
                                                                    ...
                                                                    <input type="text" class="form-control" name="reply_from" value="<?php echo $get_from;?>">
...
//-------------------------------------------------------
    ...
    $('.btn_blacklist_reply').click(function(){
    //遮蔽回覆

        if(!confirm('你確定要遮蔽回覆嗎?')){
            return false;
        }
        ...
        //參數設置
            ...
            data       :{
                ...
                method      :encodeURI(trim('blacklist_reply'   )),
                send_url    :encodeURI(trim(send_url            ))
            },
    ...
    $('.btn_blacklist_article').click(function(){
    //遮蔽文章

        if(!confirm('你確定要遮蔽文章嗎?')){
            return false;
        }
        ...
        //參數設置
            ...
            data       :{
                ...
                method      :encodeURI(trim('blacklist_article' )),
                send_url    :encodeURI(trim(send_url            ))
            },
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                FROM `mssr_forum_global`.`mssr_forum_group`
                    INNER JOIN `mssr_forum_global`.`mssr_forum_article` ON
                    `mssr_forum_global`.`mssr_forum_group`.`group_id`=`mssr_forum_global`.`mssr_forum_article`.`group_id`
                WHERE 1=1
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_id`  ={$get_article_id}
                    AND `mssr_forum_global`.`mssr_forum_article`.`article_from`={$get_from      }
            ";
        ...
        //-----------------------------------------------
            ...
            if(empty($article_results)){
                ...
                $rs_article_user_sex    =(int)($article_results[0]['sex']);
                $rs_article_school_code =trim($article_results[0]['school_code']);
                $rs_user_country_code   =trim($article_results[0]['user_country_code']);
                $rs_book_country_code   =trim($article_results[0]['book_country_code']);
                ...
                $sql="
                    ...
                    FROM `user`.`member`
                    WHERE 1=1
                        AND `user`.`member`.`uid`={$rs_article_user_id}
                ";
                $db_results=db_result($conn_type='pdo','',$sql,array(0,1),$rs_arry_conn_country);
                if(!empty($db_results)){
                    $rs_article_user_account =trim($db_results[0]['account']);
                    $rs_article_user_name    =trim($db_results[0]['name']);
                    $rs_article_user_sex     =(int)($db_results[0]['sex']);
                }
                ...
                $rs_arry_conn_country=$$rs_arry_conn_country;
                $arry_book_infos=get_book_info('',$rs_article_book_sid,$array_filter=array('book_name'),$rs_arry_conn_country);
                if(!empty($arry_book_infos)){$rs_article_book_name=trim($arry_book_infos[0]['book_name']);}else{}
                $rs_article_book_img='../img/default/book.png';
                if(file_exists("../../../info/book/{$rs_article_book_sid}/img/front/simg/1.jpg")){
                    $rs_article_book_img="../../../info/book/{$rs_article_book_sid}/img/front/simg/1.jpg";
                ...
                $sql="
                    ...
                    WHERE 1=1
                        AND `mssr_forum_global`.`mssr_forum_best_article_category_rev`.`article_id`={$rs_article_id}
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                $pnos  =($numrow>0)?ceil($numrow/$psize):0;
                $pinx  =($pinx>$pnos)?$pnos:$pinx;
                ...
                if($numrow!==0){
                    ...
                    $reply_results=$arrys_chunk[$pinx-1];
                    $tmp_user_id=[];
                    foreach($reply_results as $reply_result){
                        $rs_user_country_code=trim($reply_result['user_country_code']);
                        if(in_array($rs_user_country_code,array('sg','hk'))){
                            $tmp_user_id[]=(int)$reply_result['user_id'];
                        }
                    }
                    ...
                    if($tmp_user_id!==''){
                        ...
                        ";
                        $tmp_results=db_result($conn_type='pdo','',$sql,array(),$arry_conn_mssr_hk);
                        if(!empty($tmp_results)){
                            foreach($tmp_results as $tmp_result){
                                $rs_user_id=(int)$tmp_result['uid'];
                                $rs_user_name=trim($tmp_result['name']);
                                $rs_user_account=trim($tmp_result['account']);
                                $rs_user_sex =(int)$tmp_result['sex'];
                                foreach($reply_results as $inx=>$reply_result){
                                    $rs_reply_user_id=(int)$reply_result['user_id'];
                                    if($rs_user_id===$rs_reply_user_id){
                                        $reply_results[$inx]['name']=$rs_user_name;
                                        $reply_results[$inx]['account']=$rs_user_account;
                                        $reply_results[$inx]['sex']=$rs_user_sex;
                                    }
                                }
                            }
                        }
        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT `mssr_forum_global`.`mssr_forum_article_like_log`.`user_id`,
                       `mssr_forum_global`.`mssr_forum_article_like_log`.`user_country_code`
                FROM  `mssr_forum_global`.`mssr_forum_article_like_log`
                WHERE 1=1
                    #AND `mssr_forum_global`.`mssr_forum_article_like_log`.`user_id`   ={$sess_user_id }
                    AND `mssr_forum_global`.`mssr_forum_article_like_log`.`article_id`={$rs_article_id}
                    #AND `mssr_forum_global`.`mssr_forum_article_like_log`.`user_country_code`='{$conn_country_code}'
            ";
            $like_article_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
            $like_article_cno    =count($like_article_results);
            if(!empty($like_article_results)){
                foreach($like_article_results as $like_article_result){
                    if((int)$like_article_result['user_id']===$sess_user_id && $like_article_result['user_country_code']===$conn_country_code){
                        $btn_like_article_html=trim('收回讚');
                    }
                }
            }
            $btn_like_article_html.="({$like_article_cno})";
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="view_article" aria-labelledBy="home-tab">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="media">
                                    <a class="pull-left" href="user.php?user_id=<?php echo $rs_article_user_id;?>&tab=1&account=<?php echo $rs_article_user_account;?>">
                                        <img class="media-object" src="<?php echo $rs_article_img;?>" alt="Media">
                                    </a>
                                    <h4 class="media-heading">
                                        <?php echo htmlspecialchars($rs_article_user_name);?>
                                        ...
                                        <?php if($sess_user_id===$rs_article_user_id || in_array('i_t',$arry_user_status)):?>
                                            <button type="button" class="btn_edit_article btn btn-default btn-xs pull-right hidden-xs"
                                            article_id=<?php echo $rs_article_id;?>
                                            onclick="location.href='forum.php?method=edit_article&article_id=<?php echo $rs_article_id;?>&pinx=<?php echo $pinx;?>&psize=<?php echo $psize;?>';"
                                            >編輯</button>
                        ...
                        <?php if(!empty($reply_results)){
                            foreach($reply_results as $inx=>$reply_result):
                                ...
                                $rs_reply_school_code   =trim($reply_result['school_code']);
                                $rs_user_country_code   =trim($reply_result['user_country_code']);
                                $rs_book_country_code   =trim($reply_result['book_country_code']);
                                $rs_reply_user_sex      =(int)$reply_result['sex'];
                                $rs_reply_user_account  =trim($reply_result['account']);
                                ...
                                $rs_arry_conn_country="arry_conn_mssr_{$rs_book_country_code}";
                                $rs_arry_conn_country=$$rs_arry_conn_country;
                                $arry_book_infos=get_book_info('',$rs_reply_book_sid,$array_filter=array('book_name'),$rs_arry_conn_country);
                                if(!empty($arry_book_infos)){$rs_reply_book_name=trim($arry_book_infos[0]['book_name']);}else{continue;}
                                $rs_reply_book_img='../img/default/book.png';
                                ...
                                $sql="
                                    SELECT `mssr_forum_global`.`mssr_forum_reply_like_log`.`user_id`,
                                           `mssr_forum_global`.`mssr_forum_reply_like_log`.`user_country_code`
                                    FROM `mssr_forum_global`.`mssr_forum_reply_like_log`
                                    WHERE 1=1
                                        AND `mssr_forum_global`.`mssr_forum_reply_like_log`.`reply_id`={$rs_reply_id  }
                                ";
                                ...
                                if(!empty($like_reply_results)){
                                    foreach($like_reply_results as $like_reply_result){
                                        if((int)$like_reply_result['user_id']===$sess_user_id && $like_reply_result['user_country_code']===$conn_country_code){
                                            $btn_like_reply_html=trim('收回讚');
                                        }
                                    }
                                }
                                $btn_like_reply_html.="({$like_reply_cno})";
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="media">
                                    <a class="pull-left" href="user.php?user_id=<?php echo $rs_reply_user_id;?>&tab=1&account=<?php echo $rs_reply_user_account;?>">
                                        <img class="media-object" src="<?php echo $rs_reply_img;?>" alt="Media">
                                    </a>
                                    <h4 class="media-heading">
                                        <?php echo htmlspecialchars($rs_reply_user_name);?>
                                        ...
                                        <?php if($sess_user_id===$rs_reply_user_id || in_array('i_t',$arry_user_status)):?>
                                            <button type="button" class="btn_edit_reply btn btn-default btn-xs pull-right hidden-xs"
                                            reply_id=<?php echo $rs_reply_id;?>
                                            onclick="location.href='forum.php?method=edit_reply&reply_id=<?php echo $rs_reply_id;?>&pinx=<?php echo $pinx;?>&psize=<?php echo $psize;?>';"
                                            >編輯</button>
                        ...
                        <div id="reply_article_row" class="row">
                            <div id="reply_article" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg12">
                                                    ...
                                                    <div class="row reply_eagle" style="position:relative;margin-top:0px;">
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg12">
                                                            <form id="Form1" name="Form1" method="post" onsubmit="return false;">
                                                                <div class="div_textarea form-group" style="margin-top:15px;">
                                                                    <textarea class="form-control reply_content" id="reply_content[]" name="reply_content[]" rows="6" placeholder=""></textarea>
                                                                </div>
                                                                <div class="row chosen" style="position:relative;margin-bottom:15px;">
                                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg12">
                                                                        <select class="form-control book_sid" id="book_sid" name="book_sid" style="margin-bottom:0px;">
                                ...
                                <?php else:?>
                                    <div id="reply_article_row" class="row" style="margin-bottom:20px;">
                                        <div id="reply_article" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <h4 style="border-bottom:1px solid #428bca;margin-top:10px;padding:10px 0;color:#428bca;">發表回覆</h4>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg12">
...
//-------------------------------------------------------
    ...
    var reply_content_old_val='';
    var reply_content_new_val='';
    $(".reply_content").keyup(function(){
        reply_content_new_val=$(this).val();
        chk_article_content_val();
    });
    $(".reply_content").keydown(function(){
        reply_content_old_val=$(this).val();
        chk_article_content_val();
    });
    function chk_article_content_val(){
        //console.log(reply_content_old_val.length);
        //console.log(reply_content_new_val.length);
        if(parseInt(reply_content_new_val.length) - (reply_content_old_val.length) > 100){
            alert('請勿大量複製貼上!')
            $(".reply_content").val(reply_content_old_val);
            reply_content_old_val=reply_content_old_val;
            reply_content_new_val=reply_content_old_val;
        }
    }
