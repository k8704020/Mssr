        ...
        //-----------------------------------------------
            ...
            $sql="
                SELECT
                    ...
                    `mssr_forum_global`.`mssr_forum_article`.`keyin_mdate`,
                    `mssr_forum_global`.`mssr_forum_article`.`article_category`,
                    `mssr_forum_global`.`mssr_forum_article`.`article_from`,
            ...
            if(empty($db_results)){
                ...
                //---------------------------------------
                    ...
                    $sql="
                        SELECT
                            `mssr_forum_global`.`mssr_forum_article_eagle_rev`.`eagle_code`
                        FROM `mssr_forum_global`.`mssr_forum_article_eagle_rev`
                        WHERE 1=1
                            AND `mssr_forum_global`.`mssr_forum_article_eagle_rev`.`article_id`={$get_article_id}
                    ";
        ...
        //-----------------------------------------------
            ...
            $sql="
                ...
                WHERE 1=1
                    ...
                    AND `mssr_forum_global`.`mssr_forum_reply`.`reply_id`       ={$get_reply_id}
...
<?php function add_group_teacher() {?>
<?php
//-------------------------------------------------------
//add_group_teacher 區塊 -- 開始
//-------------------------------------------------------
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <form id="Form1" name="Form1" method="post" onsubmit="return false;">
                    <h3 style='color:#ec6c01;font-weight:bold;'>讓我們開始建立聊書小組...</h3>
                    <hr></hr>
                    <div style='font-size:15px;color:#999999;display:none;'>
                        <span class='hidden-xs'>小組類型：</span>
                       <label class="checkbox-inline">
                          <input type="radio" name="group_type" value="1" checked>
                          公開小組
                    ...
                    <div class="input-group" style="position:relative;margin-top:25px;display:none;">
                        <input type="text" class="form-control friend_name" name="friend_name[]" placeholder="請選擇或輸入第一位好友來聯署建立">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                選擇好友 <span class="caret"></span>
                    ...
                    <div class="input-group" style="position:relative;margin:25px 0;display:none;">
                        <input type="text" class="form-control friend_name" name="friend_name[]" placeholder="請選擇或輸入第二位好友來聯署建立">
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                選擇好友 <span class="caret"></span>
                    ...
                    <div class="form-group hidden">
                        <input type="hidden" class="form-control" name="friend_id[]" value="0">
                        <input type="hidden" class="form-control" name="friend_id[]" value="0">
                        <input type="hidden" class="form-control" name="method" value="add_group_teacher">
                        <input type="hidden" class="form-control" name="send_url" value="#">
                    </div>
                </form>
            </div>
