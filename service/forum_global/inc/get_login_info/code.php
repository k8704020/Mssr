...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            $_cookie_info=0;
            if(isset($_COOKIE['mssr_forum_global']['uid'])&&(trim($_COOKIE['mssr_forum_global']['uid'])!=='')){
                $_cookie_info=(int)$_COOKIE['mssr_forum_global']['uid'];
            }
            $_session_info=0;
            if(isset($_SESSION['mssr_forum_global']['uid'])&&(trim($_SESSION['mssr_forum_global']['uid'])!=='')){
                $_session_info=(int)$_SESSION['mssr_forum_global']['uid'];
            }
        ...
        //-----------------------------------------------
            ...
            if((isset($_SESSION['mssr_forum_global'][0]['name']))||(trim($_SESSION['mssr_forum_global'][0]['name'])!=='')){
                $login_flag=true;
            }
//echo "<Pre>";
//print_r($_COOKIE['mssr_forum_global']);
//echo "</Pre>";
//echo "<Pre>";
//print_r($_SESSION['mssr_forum_global']);
//echo "</Pre>";
//echo "<Pre>";
//print_r($_cookie_info);
//echo "</Pre>";
//echo "<Pre>";
//print_r($_session_info);
//echo "</Pre>";
//echo "<Pre>";
//print_r($login_flag);
//echo "</Pre>";
...
//die();
            ...
            if(empty($arrys_login_info)){
                ...
                if(!$login_flag){
                    if(isset($_SESSION['mssr_forum_global']['uid'])&&isset($_SESSION['mssr_forum_global']['country_code'])){
                        $tmp_uid=$_SESSION['mssr_forum_global']['uid'];
                        $tmp_country_code=$_SESSION['mssr_forum_global']['country_code'];
                        $sql="
                            SELECT `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_id`
                            FROM `mssr_forum_global`.`mssr_forum_group_user_rev`
                            WHERE 1=1
                                AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_id`={$tmp_uid}
                                AND `mssr_forum_global`.`mssr_forum_group_user_rev`.`user_country_code`='{$tmp_country_code}'
                        ";
                    ...
                    //回填, 登入資訊
                    //if(isset($arrys_login_info[0]['country_code'])){
                    //    if($arrys_login_info[0]['country_code']!=='hk')$arrys_login_info[0]['country_code']='hk';
                    //}
                    $_SESSION['mssr_forum_global'][0]=$arrys_login_info[0];
        ...
        //-----------------------------------------------
            ...
            return $_SESSION['mssr_forum_global'];
    }
?>