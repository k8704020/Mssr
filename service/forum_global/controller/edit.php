...
//die();
                ...
                //---------------------------------------
                    ...
                    $sql="
                        ...
                        UPDATE `mssr_forum_global`.`mssr_forum_article_detail` SET
                            `article_title`   = '{$article_title  }',
                            `article_content` = '{$article_content}',
                            `keyin_ip`        = '{$keyin_ip       }'
                        WHERE 1=1
                            AND `mssr_forum_global`.`mssr_forum_article_detail`.`article_id`={$article_id}
                        LIMIT 1;

                        # for mssr_forum_article_detail_log
                        INSERT IGNORE INTO `mssr_forum_global`.`mssr_forum_article_detail_log` SET
                        ...
                        DELETE FROM `mssr_forum_global`.`mssr_forum_article_eagle_rev`
                        WHERE 1=1
                            AND `mssr_forum_global`.`mssr_forum_article_eagle_rev`.`article_id`={$article_id};
                    ";
                    //echo "<Pre>";
                    //print_r($sql);
                    //echo "</Pre>";
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $psize=(isset($_POST['psize']))?(int)$_POST['psize']:5;
                    ...
                    //-----------------------------------
                        ...
                        $sql="
                            ...
                            WHERE 1=1
                                ...
                                AND `mssr_forum_global`.`mssr_forum_reply`.`article_id`     ={$article_id}
                                AND `mssr_forum_global`.`mssr_forum_reply`.`reply_id`       ={$reply_id  }
                        ";
                        $db_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(0,1),$arry_conn_mssr);
                        if(empty($db_results)){
                            $msg="發生嚴重錯誤";
                ...
                //---------------------------------------
                    ...
                    $sql="
                        ...
                        UPDATE `mssr_forum_global`.`mssr_forum_reply_detail` SET
                            `reply_content` = '{$reply_content  }',
                            `keyin_ip`      = '{$keyin_ip       }'
                        WHERE 1=1
                            AND `mssr_forum_global`.`mssr_forum_reply_detail`.`article_id`={$article_id}
                            AND `mssr_forum_global`.`mssr_forum_reply_detail`.`reply_id`  ={$reply_id  }
                        LIMIT 1;

                        # for mssr_forum_reply_detail_log
                        INSERT IGNORE INTO `mssr_forum_global`.`mssr_forum_reply_detail_log` SET
                            `article_id`        =  {$article_id     } ,
                            `reply_id`          =  {$reply_id       } ,
                            `log_id`            = NULL                ,
                            `reply_content`     = '{$reply_content  }',
                ...
                //---------------------------------------
                    ...
                    $jscript_back="
                        <script>
                            alert('{$msg}');
                            location.href='../view/reply.php?get_from={$get_from}&article_id={$article_id}&pinx={$pinx}&psize={$psize}';
                        </script>
                    ";
                    die($jscript_back);
            }
