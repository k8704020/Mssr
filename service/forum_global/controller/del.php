...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            function blacklist_reply($send_url,$arrys_sess_login_info){
            //-------------------------------------------
            //函式: blacklist_reply()
            //用途: 遮蔽回覆
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $reply_id =(int)$reply_id;
                    $sess_school_code=(isset($sess_school_code))?trim($sess_school_code):'';
                ...
                //---------------------------------------
                    ...
                    $sql="
                        # for mssr_forum_blacklist_reply_school
                        INSERT IGNORE INTO `mssr_forum`.`mssr_forum_blacklist_reply_school` SET
        ...
        //-----------------------------------------------
        //函式: blacklist_article()
        //用途: 遮蔽文章
        //-----------------------------------------------

            function blacklist_article($send_url,$arrys_sess_login_info){
            //-------------------------------------------
            //函式: blacklist_article()
            //用途: 遮蔽文章
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $sql="
                        # for mssr_forum_blacklist_article_school
                        INSERT IGNORE INTO `mssr_forum`.`mssr_forum_blacklist_article_school` SET
                            `school_code`   ='{$sess_school_code}'  ,
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $sql="
                        ...
                        DELETE FROM `mssr_forum_global`.`mssr_forum_group_booklist`
                        WHERE 1=1
                            AND `group_id`=  {$group_id}
