        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    global $arry_conn_user_tw;
                    global $arry_conn_mssr_hk;
                    global $arry_conn_user_hk;
                ...
                //echo "</Pre>";
                    ...
                    if((isset($_SESSION['mssr_forum_global']))||(!empty($_SESSION['mssr_forum_global']))){
                        $url=str_repeat("../",1).'view/index.php';
                        header("Location:{$url}");
                        die();
                    }
                ...
                //---------------------------------------
                    ...
                    //-----------------------------------
                        ...
                        //建立連線
                        $conn_user_tw=conn($db_type='mysql',$arry_conn_user_tw);
                        $conn_user_hk=conn($db_type='mysql',$arry_conn_user_hk);
                    ...
                    //-----------------------------------
                        ...
                        //處理
                        $_user_uid=mysql_prep($user_uid);
                        $_user_pwd=mysql_prep($user_pwd);

                        $sql ="
                            SELECT *
                            FROM `user`.`member`
                            WHERE 1=1
                                AND `user`.`member`.`account` ='{$_user_uid}'
                                AND `user`.`member`.`password`='{$_user_pwd}'
                                AND `user`.`member`.`permission` <> 'x'
                        ";
                        $db_results_tw=db_result($conn_type='pdo',$conn_user_tw,$sql,array(0,1),$arry_conn_user_tw);

                        $sql ="
                            SELECT `user`.`member`.*,`user`.`school`.`country_code`
                            FROM `user`.`member`
                        ...
                        ";
                        $db_results_hk=db_result($conn_type='pdo',$conn_user_hk,$sql,array(0,1),$arry_conn_user_hk);

                        if(empty($db_results_tw)&&empty($db_results_hk)){
                            die($jscript_back);
                        }
                ...
                //---------------------------------------
                    ...
                    $db_result_tw=$db_results_tw[0];
                    $db_result_hk=$db_results_hk[0];
                    foreach($db_result_tw as $field_name=>$field_value){
                        if($field_name==='uid'){
                            $_SESSION['mssr_forum_global'][$field_name]=$field_value;
                            $_SESSION['mssr_forum_global']['country_code']='tw';
                        }
                    }

                    foreach($db_result_hk as $field_name=>$field_value){
                        if($field_name==='uid'){
                            $_SESSION['mssr_forum_global'][$field_name]=$field_value;
                            $_SESSION['mssr_forum_global']['country_code']=$db_result_hk['country_code'];
                        }
                    }
//echo "<Pre>";
//print_r($_POST);
...
//echo "</Pre>";
//echo "<Pre>";
//print_r($db_results_tw);
//echo "</Pre>";
//echo "<Pre>";
//print_r($db_results_hk);
//echo "</Pre>";
//echo "<Pre>";
//print_r($_SESSION['mssr_forum_global']);
//echo "</Pre>";
//die();
                //---------------------------------------
                //重導頁面
