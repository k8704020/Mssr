                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header' style='background-color:#428bca;color:#ffffff;'>
                                            ...
                                            <h4 class='modal-title' id='myModalLabel'><span id='add_friend_title''>邀請當你的好友</span></h4>
                                        </div>
                                        <div class='modal-body'>
                                            <textarea class='form-control add_friend_content' id='add_friend_content' name='add_friend_content' rows='2' placeholder='跟朋友說說話吧!'
                                            maxlength='100'
