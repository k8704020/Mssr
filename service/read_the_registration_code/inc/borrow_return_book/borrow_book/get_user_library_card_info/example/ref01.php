...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        require_once(str_repeat("../",1)."code.php");
 		...
 		//使用者主索引
        $user_id='';
        $array_filter=array('card_number');

        $get_user_library_card_info=get_user_library_card_info($conn='',$user_id,$array_filter,$arry_conn_mssr);
        echo "<pre>";
        print_r($get_user_library_card_info);
        echo "</pre>";
?>