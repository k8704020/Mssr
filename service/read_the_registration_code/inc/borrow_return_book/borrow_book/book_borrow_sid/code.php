...
//-------------------------------------------------------
    ...
    function book_borrow_sid($create_by,$encode){
    //---------------------------------------------------
    //函式: book_borrow_sid()
    //用途: 借閱識別碼
    //---------------------------------------------------
    ...
    //
    //---------------------------------------------------
    //字首: mbb + create_by(建立者) + YYYYMMDDhhiiss + 亂數組成，共25碼，
    //      mbb + 1 + 20130101000000 + 0000001
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            if($size>0){
                $book_borrow_sid=$prefix.$create_by.$datetime.$rnd;
            }else{
                $book_borrow_sid=$prefix.$create_by.$datetime;
            }

            return "{$book_borrow_sid}";
    }
?>