            ...
            <tr>
                <td height="426px" valign='top' align="center">
                    ...
                    <div style="margin-bottom:50px;margin-top:50px;">
                        <h1 class='fc_blue0'><b>申請轉為正式帳號後，即可列印帳號卡，使用帳號卡借還書</b></h1>
                    </div>

                    <img src="../../../img/account_card1.png" width="auto" height="175" border="0" alt="account_card"/>
                    <img src="../../../img/account_card2.png" width="auto" height="175" border="0" alt="account_card"/>
                    <img src="../../../img/description_account_card.png" width="auto" height="auto" border="0" alt="account_card"/>

                    <!-- 資料列表 結束 -->
                </td>
                <td align="right" valign="top" width="100px">
                    <input type="button" value="返回" class="ibtn_gr9030" style="position:relative;right:5px;cursor:pointer;"
                    onclick="location.href='loginF.php'">
