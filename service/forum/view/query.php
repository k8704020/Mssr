            ...
            switch($search_type){
                ...
                case 1:
                    ...
                    $sql="
                        ...
                        LIMIT 25
                    ";
                    $prefix_tmp_wall_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
                    if(!empty($prefix_tmp_wall_results)){
                        foreach($prefix_tmp_wall_results as $prefix_tmp_wall_result){
                            $arry_uid[]=(int)$prefix_tmp_wall_result['uid'];
                        }
                    ...
                    if(!empty($prefix_tmp_wall_results)){
                        $sql="
                            ...
                            WHERE 1=1
                                AND `user`.`member`.`uid` IN ({$list_uid})
                            ...
                            LIMIT 25
                        ";
                        $tmp_wall_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
                        if(!empty($tmp_wall_results)){
                            foreach($tmp_wall_results as $tmp_wall_result){
                                $query_wall_results[]=$tmp_wall_result;
                            }
                        }
                    }
                    if(!empty($prefix_tmp_wall_results)){
                ...
                case 2:
                    ...
                    if(!empty($rs_arry_book_sid))$rs_book_sid_list="'".implode("','",$rs_arry_book_sid)."'";
                ...
                <?php if(!empty($query_wall_results)):?>
                        ...
                        foreach($query_wall_results as $query_wall_result):
                            ...
                            if(isset($file_server_enable)&&($file_server_enable)){
                                if(@getimagesize("http://".$arry_ftp1_info['host']."/mssr/info/user/{$rs_user_id}/forum/user_sticker/1.jpg")){
                                    $user_img="http://".$arry_ftp1_info['host']."/mssr/info/user/{$rs_user_id}/forum/user_sticker/1.jpg";
                                }
                            }else{
                                if(file_exists("../../../info/user/{$rs_user_id}/forum/user_sticker/1.jpg")){
                                    $user_img="../../../info/user/{$rs_user_id}/forum/user_sticker/1.jpg";
                                }
                            }
                        ...
                        <div class="media" style="overflow:visible;">
                            ...
                            <div class="media-body" style="overflow:visible;">
                                <h5 class="media-heading">
                                    ...
                                    <?php if($rs_school_name!=='')echo '，'.htmlspecialchars($rs_school_name);?>
                                ...
                                <p>
                                    ...
                                    <?php if($btn_add_friend_show):?>
                                        ...
                                        <button class="btn btn-default btn-xs pull-left" data-toggle="modal" data-target="#modal_dialog_add_friend"
                                        style="position:relative;margin:0 1px;"
                                        onclick="
                                        $('#add_friend_title').text('邀請<?php echo htmlspecialchars($rs_user_name);?>當你的書友');
                                        $('.btn_add_friend').attr('friend_id',<?php echo (int)$rs_user_id;?>);
                                        void(0);"
                                        <?php if($btn_add_friend_disabled)echo 'disabled="disabled"';?>>
                    ...
                    <?php
                        foreach($query_wall_results as $query_wall_result):
                            ...
                            if(@getimagesize("http://".$arry_ftp1_info['host']."/mssr/info/forum/group/{$rs_group_id}/group_sticker/1.jpg")){
                                $group_img="http://".$arry_ftp1_info['host']."/mssr/info/forum/group/{$rs_group_id}/group_sticker/1.jpg";
                            }
                    ?>
                        <div class="media">
                            <a class="pull-left" href="article.php?get_from=2&group_id=<?php echo addslashes($rs_group_id);?>">
                                <img class="media-object" src="<?php echo $group_img;?>" width="64" height="64" alt="Media">
                            </a>
                            <div class="media-body">
                                <h5 class="media-heading">
                    ...
                    <?php
                        foreach($query_wall_results as $query_wall_result):
                            ...
                            $rs_article_keyin_cdate =trim($query_wall_result['keyin_cdate']);
