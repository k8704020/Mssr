                    ...
                    if($no===1){
                        ...
                        if(isset($file_server_enable)&&($file_server_enable)){
                            ...
                            foreach($sess_user_book_results as $sess_user_book_result){
                                ...
                                foreach($arry_img as $path){
                                    ...
                                    if(is_url_exist("http://".$arry_ftp1_info['host']."/mssr/info/user/{$sess_user_id}/book/{$rs_books_sid}/draw/bimg/{$path}")){
                        ...
                        if(isset($file_server_enable)&&($file_server_enable)){
                            ...
                            foreach($sess_user_book_results as $sess_user_book_result){
                                ...
                                //$arry_ftp_file=ftp_nlist($ftp_conn,$ftp_path);
                                if(is_url_exist("http://".$arry_ftp1_info['host']."/mssr/info/user/{$sess_user_id}/book/{$rs_books_sid}/record/1.mp3")){
                                                ...
                                                <div class='media' style='margin:10px 0;display:none;'>
                                                    ...
                                                    <div class='media-body'>
                                                        <h4 class='media-heading hidden-xs' style='position:relative;left:0px;'>
                                                            ...
                                                            <p style='font-size:10pt;' class='pull-right hidden-xs'>{$rs_keyin_cdate} | 讚({$rs_like_article_cno}) | 看({$rs_article_view_cno})</p>
                                                        </h4>
                                            ...
                                            <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                <div class='media' style='margin:10px 0;display:none;'>
                                                    ...
                                                    <div class='media-body'>
                                                        <h4 class='media-heading hidden-xs' style='position:relative;left:0px;'>
                                                            <span style='color:#324fe1;'><b>
                                                                你的書友【<a href='user.php?user_id={$rs_user_id}&tab=1' style='color:#324fe1;'>{$rs_user_name}</a>】
                                                                在 {$rs_content_1}
                                                            </b></span>
                                                            <p style='font-size:10pt;' class='pull-right hidden-xs'>{$rs_keyin_cdate} | 讚({$rs_like_article_cno}) | 看({$rs_article_view_cno})</p>
                                                        </h4>
                                ...
                                foreach($arrys_member_other as $key1=>$arry_member_other){
                                    ...
                                    if($key1===0 && !empty($arry_member_other)){
                                        $json_html.="
                                            <table class='table'>
                                                <thead>
                                                    <tr><td class='text-center'>共同書友</td></tr>
                                                </thead>
                                                <tbody>
                                        ";
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    $rs_cat_id       =trim($_POST[trim('rs_cat_id        ')]);
                        ...
                        //書籍
                            ...
                            if(!empty($article_results)){
                                ...
                                foreach($article_results as $inx=>$article_result){
                                    ...
                                    $json_html[].="<tr align='left' style='background-color:{$tr_color};'>
                                            <!-- 討論,大解析度,start -->
                                            <!-- <td class='hidden-xs'><a href='{$a_href_1}'><span style='position:relative;left:8px;'>{$rs_book_name}         </span></a></td> --> <!-- 修改，多顯示一個書名欄位，導致版面錯誤 -->
                                            <td class='hidden-xs' style='border:0px;'><a href='{$a_href_2}' target='_blank'>{$rs_article_title}</a></td>
                                            <td class='hidden-xs' style='border:0px;'><a href='{$a_href_3}'>{$rs_user_name}</a></td>
                                            <td class='hidden-xs' style='border:0px;'>{$rs_keyin_mdate}</td>
                                            <td class='hidden-xs' style='border:0px;'>{$rs_article_like_cno}</td>
                                            <td class='hidden-xs' style='border:0px;'>{$reply_article_cno}</td>
                                            <!-- 討論,大解析度,end -->
                        ...
                        //小組
                            ...
                            if ($rs_cat_id != 0) {
                                $sql="
                                    ...
                                    WHERE 1=1
                                        ...
                                        AND `mssr_forum`.`mssr_forum_article`.`article_type` =2 -- 文章類型
                                        AND `mssr_forum`.`mssr_forum_article`.`article_state`=1 -- 文章狀態
                            ...
                            if(!empty($article_results)){
                                ...
                                foreach($article_results as $inx=>$article_result){
                                    ...
                                    $rs_reply_id        =(int)$rs_reply_id;
                                    $rs_like_cno        =(int)$rs_like_cno;
                                    $rs_article_like_cno=(int)$rs_like_cno;
                                    ...
                                    $json_html[].="<tr align='left' style='background-color:{$tr_color};'>
                                            <!-- 討論,大解析度,start -->
                                            <td class='hidden-xs' style='border:0px;'><a href='{$a_href_1}'>{$rs_book_name}</a></td>
                                            <td class='hidden-xs' style='border:0px;'><a href='{$a_href_2}' target='_blank'>{$rs_article_title}</a></td>
                                            <td class='hidden-xs' style='border:0px;'><a href='{$a_href_3}'>{$rs_user_name}</a></td>
                                            <td class='hidden-xs' style='border:0px;'>{$rs_keyin_mdate}</td>
                                            <td class='hidden-xs' style='border:0px;'>{$rs_article_like_cno}</td>
