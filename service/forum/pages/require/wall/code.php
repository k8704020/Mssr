...
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            global $rs_group_id;
            global $rs_user_id;
            global $rs_like_article_cno;
            global $rs_article_view_cno;
        ...
        //-----------------------------------------------
            ...
            $rs_like_article_cno=(int)$rs_like_article_cno;
            $rs_article_view_cno=(int)$rs_article_view_cno;
...
//                <div class='media-body'>
//                    <h4 class='media-heading' style='position:relative;left:0px'>
//                        你的書友『<a href='user.php?user_id={$rs_user_id}&tab=1'>{$rs_user_name}</a>』
//                        <br>在 {$rs_content_1}
//                    </h4>
//                    <p style='position:relative;top:5px;'>
//                        <a target='_blank' href='reply.php?get_from={$get_from}&article_id={$rs_article_id}'>
