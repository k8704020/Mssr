    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
				...
				$curdate=date("Y-m-d");
				$predate=date("Y-m-d",strtotime('-6 day'));
                ...
                $sql="
                    ...
                    WHERE 1=1
                        ...
                        AND `mssr_forum`.`mssr_forum_user_request`.`request_read` =2
						AND `mssr_forum`.`mssr_forum_user_request`.`keyin_cdate` BETWEEN '{$predate} 00:00:00' AND '{$curdate} 23:59:59'
                ";
                $db_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
                if(!empty($db_results)){
                    foreach($db_results as $inx=>$db_result){
            ...
            //-------------------------------------------
                ...
                $sql="
                    SELECT
                        ...
                        `mssr_forum`.`mssr_forum_friend`.`content`,
                        `mssr_forum`.`mssr_forum_friend`.`friend_state`,
                        `mssr_forum`.`mssr_forum_friend`.`message_state`,
                        `mssr_forum`.`mssr_forum_friend`.`keyin_mdate`
                    FROM `mssr_forum`.`mssr_forum_friend`
                    WHERE 1=1
                        AND `mssr_forum`.`mssr_forum_friend`.`user_id` = {$user_id}
                        ...
                        AND `mssr_forum`.`mssr_forum_friend`.`message_state` = 2
                ";
                $db_results=db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
                if(!empty($db_results)){
                    foreach($db_results as $inx=>$db_result){
                        ...
                        $arrys_msg[$rs_time]['request_friend_success'][trim('user_sex')] =$rs_user_sex;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('friend_sex')] =$rs_friend_sex;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('user_name')] =$rs_user_name;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('friend_name')] =$rs_friend_name;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('create_by')] =$rs_create_by;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('user_id')] =$rs_user_id;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('friend_id')] =$rs_friend_id;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('content')] =$rs_content;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('friend_state')] =$rs_friend_state;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('message_state')] =$rs_message_state;
                        $arrys_msg[$rs_time]['request_friend_success'][trim('keyin_mdate')] =$rs_keyin_mdate;
                    }
                }
			...
			//-------------------------------------------
				...
				$sql="
					SELECT
						`mssr_forum`.`mssr_forum_report_message`.`message_id`,
						`mssr_forum`.`mssr_forum_report_message`.`user_id`,
					...
					WHERE 1=1
						...
						AND `mssr_forum`.`mssr_forum_report_message`.`message_status` = 1
				";
				$db_results = db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
				if (!empty($db_results)) {
					foreach ($db_results as $inx=>$db_result) {
						...
						$rs_article_title = trim($rs_article_title);
						$rs_request_from_name = '聊書系統';
						$rs_request_to_name = '聊書系統';

						$arrys_msg[$rs_time]['report_message'][trim('request_from_sex')] = $rs_request_from_sex;
						$arrys_msg[$rs_time]['report_message'][trim('request_to_sex')] = $rs_request_to_sex;
						$arrys_msg[$rs_time]['report_message'][trim('request_from_name')] = $rs_request_from_name;
						$arrys_msg[$rs_time]['report_message'][trim('request_to_name')] = $rs_request_to_name;
						$arrys_msg[$rs_time]['report_message'][trim('request_from')] = $rs_request_from;
						$arrys_msg[$rs_time]['report_message'][trim('request_to')] = $rs_request_to;
						$arrys_msg[$rs_time]['report_message'][trim('request_id')] = $rs_request_id;
						$arrys_msg[$rs_time]['report_message'][trim('request_state')] = $rs_request_state;
						$arrys_msg[$rs_time]['report_message'][trim('request_read')] = $rs_request_read;
						$arrys_msg[$rs_time]['report_message'][trim('keyin_cdate')] = $rs_keyin_cdate;
						$arrys_msg[$rs_time]['report_message'][trim('rev_id')] = $rs_rev_id;
						$arrys_msg[$rs_time]['report_message'][trim('message_id')] = $rs_message_id;
						$arrys_msg[$rs_time]['report_message'][trim('article_id')] = $rs_article_id;
						$arrys_msg[$rs_time]['report_message'][trim('article_type')] = $rs_article_type;
						$arrys_msg[$rs_time]['report_message'][trim('article_title')] = $rs_article_title;
					}
				}
