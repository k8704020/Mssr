<?php
//-------------------------------------------------------
//函式: get_blacklist_group_school()
//用途: 提取學校小組黑名單資訊
//-------------------------------------------------------

    function get_blacklist_group_school($school_code,$group_id,$arry_conn){
    //---------------------------------------------------
    //函式: get_blacklist_group_school()
    //用途: 提取學校小組黑名單資訊
    //---------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        //-----------------------------------------------
            ...
            if(!isset($school_code)||(trim($school_code)==='')){
                $err='GET_BLACKLIST_GROUP_SCHOOL:NO SCHOOL_CODE';
                die($err);
            }else{
            ...
            if(!isset($group_id)||(int)($group_id)===0){
                $err='GET_BLACKLIST_GROUP_SCHOOL:NO GROUP_ID';
                die($err);
            }else{
            ...
            if(!isset($arry_conn)||(empty($arry_conn))){
                $err='GET_BLACKLIST_GROUP_SCHOOL:NO ARRY_CONN';
                die($err);
            }
        ...
        //-----------------------------------------------
            ...
            //-------------------------------------------
                ...
                try{
                    ...
                    $err ='GET_BLACKLIST_GROUP_SCHOOL:CONNECT FAIL';
                    die($err);
                }
