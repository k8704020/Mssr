	...
	//-----------------------------------------------------------------	
		...
		function show_total_mission(){	
			...
			for(var x=0; x<task_number; x++){
					var i = 0;//紀錄>第幾樓的任務
					var add ="";
					add += "<li><div id='tab_div_"+x+"' style='display:none'><img src='img/mission_icon/align.png' style='float:left;vertical-align:middle;margin-left:3px;margin-top:8px;margin-right:1px'><a href='#tab"+x+"' style='color:black'>"+task_topic[x]+"</a></div></li>";
					$(".tabs").append(add);
					add ="";
				...
				for(var y=0; y<friend_number; y++){
					if(y==0){//自己的任務
						if(mission_state[x][y] != 4){//自己的任務>篩選掉(沒接到的任務)
							...
							add += "</tr>";
							add += "<tr>";
							add += "<td  style='border-bottom-style:solid;border-left-style:solid;border-top-style:solid;border-right-style:solid;width:33.3%;background-Color:#F0F8FF;border-bottom-color:#BBBB00;'><span id='state_"+x+"_1' style='text-align:center;'>第一步：閱讀與發文</span></td>";
							add += "<td   style='border-bottom-style:solid;border-left-style:solid;border-top-style:solid;border-right-style:solid;width:33.3%;background-Color:#F0F8FF;border-bottom-color:#BBBB00;'><span id='state_"+x+"_2' style='text-align:center;'>第二步：經營討論</span></td>";
							add += "<td  style='border-bottom-style:solid;border-left-style:solid;border-top-style:solid;border-right-style:solid;width:33.3%;background-Color:#F0F8FF;border-bottom-color:#BBBB00;'><span id='state_"+x+"_3' style='text-align:center;'>第三步：傳遞任務</span></td>";
							add += "</tr>";
							add += "<tr>";
							add += "<td class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;border-left-style:solid;border-right-style:solid;width:33.3%;'>&nbsp;&nbsp;<span id='span_step1_"+x+"_"+y+"' style='height:72px;line-height:72px;' name="+x+" class='new_button'></span><img src='img/mission_icon/write.png'></td>";
							add += "<td class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;border-left-style:solid;border-right-style:solid;width:33.3%;'>&nbsp;&nbsp;<span id='span_step2_"+x+"_"+y+"' style='height:72px;line-height:72px;' name="+x+" class='new_button'></span><img src='img/mission_icon/discuss_talk.png'></td>";
							add += "<td class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;border-left-style:solid;border-right-style:solid;width:33.3%;'>&nbsp;&nbsp;<span id='span_step3_"+x+"_"+y+"' style='height:72px;line-height:72px;' name="+x+" class='new_button'></span><img src='img/mission_icon/deliver_mission.png'></td>";
							add += "</tr>";
							add += "<tr>";
							add += "<td class='mission_step1' style='border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-bottom-color:#BBBB00;width:33.3%;'><img src='img/mission_icon/article.png'>&nbsp;標題：<a id='href_article"+x+"_"+y+"' href='../_dev_group_mission.php?get_from=3&group_task_id="+task_id[x]+"&article_id="+article_id[x][y]+"' target='_blank'>"+article_title[x][y]+"<a><span id='span_article"+x+"_"+y+"'></span></td>";
							add += "<td class='mission_step1' style='border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-bottom-color:#BBBB00;width:33.3%;'><img src='img/mission_icon/like.png'>&nbsp;討論串按讚數：&nbsp;"+like_cno[x][y]+"&nbsp;個</td>";
							add += "<td class='mission_step1' style='border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-bottom-color:#BBBB00;width:33.3%;'><img src='img/mission_icon/deliver.png'>&nbsp;任務已傳給：&nbsp;"+deliver_cno[x]+"&nbsp;人</td>";
							add += "</tr>";
							add += "<tr>";
							add += "<td class='mission_step1' style='border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-bottom-color:#BBBB00;width:33.3%'><img src='img/mission_icon/book.png'>&nbsp;書籍：<a id='href_book"+x+"' href='../article.php?get_from=1&book_sid="+book_id[x]+"' target='_blank'><span style='word-break: break-all;'>"+get_book_name[x]+"</span></a><span id='span_book"+x+"'></span></td>";
							add += "<td class='mission_step1' style='border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-bottom-color:#BBBB00;width:33.3%;'><img src='img/mission_icon/reply.png'>&nbsp;文章被回覆數：&nbsp;"+article_reply_cno[x][y]+"&nbsp;個</td>";
							add += "<td class='mission_step1' style='border-left-style:solid;border-right-style:solid;border-bottom-style:solid;border-bottom-color:#BBBB00;width:33.3%;'><img src='img/mission_icon/money.png'>&nbsp;&nbsp;<span id='span_reward"+x+"_"+y+"'>累積獎勵</span>：&nbsp;"+get_potential_score[x][y]+" 分&nbsp;<span id='span_explain"+x+"_"+y+"'></span></td>";
							add += "</table>";	
							add += "</div>";
							$("#tab"+x).append(add);
						...
						if(mission_state[x][y]!= 0 && mission_state[x][y]!= 3 && mission_state[x][y]!= 4){//朋友的任務>篩選掉(1.沒回應 2.已拒絕 3.沒接到任務)
							...
							add += "</tr>";
							add += "<tr>";
							add += "<td class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;width:50%'><img src='img/mission_icon/like.png'>&nbsp;&nbsp;討論串按讚數：&nbsp;"+like_cno[x][y]+"&nbsp;個&nbsp;&nbsp;</td>";
							add += "<td class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;width:50%'><img src='img/mission_icon/reply.png'>&nbsp;&nbsp;文章被回覆數：&nbsp;"+article_reply_cno[x][y]+"&nbsp;個</td>";
							//add += "<td><a id='href_link"+x+"' href='#'><div name="+task_id[x]+" value="+x+" class='m-button' style='float:right;margin-right:20px;width:100px' ><span name='check_mission'>查看任務狀況</span></div></td>";
							add += "</tr>";
							add += "<tr>";
					...
					//調整>顯示狀況
					//----------------------------------------------------					
 					if(mission_state[x][y]==1||mission_state[x][y]==2){//當自已或朋友有該任務時，任務頁籤將顯示出來
						$("#tab_div_"+x).css({"display":""});
					}  
					
					if(article_id[x][y]==0){//當有顯示的任務中，有未完成發文者
						$("#href_article"+x+"_"+y).remove();						
						$("#span_article"+x+"_"+y).text("還沒有發表文章");
					...
					if(mission_state[x][y]==1){//任務已完成
						if(y==0){
							...
							$("#span_reward"+x+"_"+y).text("朋友的獲得獎勵");
						}					
						$("#span_state_"+x+"_"+y).text("『 任務已完成 』 (點擊可查看狀況)");
					...
					//-------------------------------------
						...
						if(y!=0){//朋友的任務
							$("#span_reward"+x+"_"+y).text("朋友累積的任務獎勵");
						}
					...
					//任務未回應
					//-------------------------------------	
					else if(mission_state[x][y]==0){
						$("#span_state_"+x+"_"+y).text("『 未回應任務 』");
					}	
		...
		//接收到任務，且未回應任務
		//-----------------------------------------------------------------------
		function none_reply_mission(){//學生已接收任務，但是未回應(x:任務編號; y:任務主題; z:傳遞人名字; w:傳遞人uid)
		$("#mission_content").empty();
		var i = 0;
		for(var x=0; x<task_number; x++){//如果有接收到任務且未回應			
			if(mission_state[x][0]==0 && i==0){
				i = 1;
				var add ="";
