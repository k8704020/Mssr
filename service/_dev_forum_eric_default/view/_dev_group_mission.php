                        ...
                        if(!empty($article_results)){
                            foreach($article_results as $article_result):
                                ...
                                foreach($db_results as $db_result){
                                    ...
                                    if(in_array($rs_class_code, $arry_1) || in_array($rs_class_code, $arry_2) || in_array($rs_school_code, $arry_3) || in_array($rs_school_code, $arry_4) || in_array($rs_school_code, $arry_5)){
                                        $continue=true;
                                        break;
                                    }
                                }
