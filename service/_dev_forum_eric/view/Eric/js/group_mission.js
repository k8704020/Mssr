			...
			"success": function(data){
				...
				//-----------------------------------------
					if(Date.parse(new Date()).valueOf() > Date.parse(end_time).valueOf()){//時間到後，即放棄任務
						...
						add += "<tr>";
						add += "<td rowspan='2' style='background-Color:#CCEEFF;border-bottom-style:dashed;border-top-style:dashed;border-left-style:dashed;'><img src='img/mission_icon/target.png'></td>";
				...
				//-----------------------------------------	
					if(Date.parse(new Date()).valueOf() > Date.parse(end_time).valueOf()){//時間到後，自動提交任務
						...
						add += "<tr><td colspan='3'><div id='div-alert'class='font-MJ' style='color:red;font-size:16px;'><img src='img/mission_icon/back.png'>&nbsp;<a href='#' id='back_achieve_total'>[返回任務總覽頁面]</a></div></td></tr>";
						add += "<tr>";
						add += "<td rowspan='7' style='width:140px;background-Color:#CCEEFF;'><div class='circle'><div class='inner'>第二步</div></div></td>";
						add += "<td colspan='2' class='mission_step1' style='background-Color:#FFFFBB;color:black;'><img src='img/mission_icon/topic.png'>&nbsp;&nbsp;主題：『"+y+"』</td>";
						add += "</tr>";
						add += "<tr><td colspan='2' class='mission_step1' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/article.png'>&nbsp;&nbsp;文章標題：「"+article_title+"」&nbsp;─&nbsp;點此前往&nbsp;[<a href='../_dev_group_mission.php?get_from=3&group_task_id="+x+"&article_id="+article_id+"' target='_blank'>文章討論頁面</a>]</td></tr>";
						add += "<tr><td colspan='2' class='mission_step2' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/one.png'>&nbsp;&nbsp;邀請朋友一同參與討論&nbsp;─&nbsp;點此前往&nbsp;[<a href='../_dev_group_mission.php?get_from=3&group_task_id="+x+"&article_id="+article_id+"&request_article=1' target='_blank'>邀請朋友討論頁面</a>]</td></tr>";
						add += "<tr><td colspan='2' class='mission_step2' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/two.png'>&nbsp;&nbsp;"+step_content[0]+"[<span style='color:red'>"+article_like_cno+"</span>]個 ("+score_content[0]+")<td></tr>";
						add += "<tr><td colspan='2' class='mission_step2' style='border-bottom-style:solid;border-bottom-color:#BBBB00;'><img src='img/mission_icon/three.png'>&nbsp;&nbsp;"+step_content[1]+"[<span style='color:red'>"+article_reply_cno+"</span>]個 ("+score_content[1]+")</td></tr>";
