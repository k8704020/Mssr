<?php
    ...
    //---------------------------------------------------
		...
		$sql="
			SELECT 
				...
				where 1=1 
					...
					'gdc_2015_2_3_5_1','gps_2015_2_3_2_1','gps_2015_2_3_3_1','cyc_2015_2_4_1_3','jdy_2015_2_4_1_2','jdy_2015_2_4_2_2','smb_2015_2_3_4_1','cjh_2015_2_4_1_2','nep_2015_2_4_1_1','nep_2015_2_4_2_1','nsa_2015_2_4_3_1','zbq_2015_2_3_2_2','zbq_2015_2_3_3_2','zbq_2015_2_4_2_2','zbq_2015_2_4_3_2','pqr_2015_2_3_2_1','pqr_2015_2_5_4_1','wbp_2015_2_3_10_1','wbp_2015_2_3_2_1','wbp_2015_2_3_8_1','ctc_2015_2_3_10_1','lrb_2015_2_4_3_2','bnr_2015_2_4_3_1','bnr_2015_2_4_5_1','ctc_2015_2_3_8_1','ctc_2015_2_4_2_1','bts_2015_2_4_1_2','dsg_2015_2_5_1_2','pqr_2015_2_4_5_1'
		...
		$sql="			
			...
			FROM `mssr_forum`.`dev_article_group_mission_rev` AS am
				INNER JOIN `mssr_forum`.`mssr_forum_article` AS a ON ( am.`article_id` = a.`article_id` )
				INNER JOIN `mssr_forum`.`mssr_forum_article_eagle_rev` AS ae ON ( ae.`article_id` = am.`article_id` )
			WHERE 1=1
			...
			group by am.`article_id`
		";
		$get_article_eagle_data = db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
		$k = 0;
		foreach($get_article_eagle_data as $key => $get_article_eagle_data){
			$k++;
		}
		echo "鷹架發文篇數：".$k;
		echo "</br>";
		...
		$sql="
			...
			Group by r.`user_id`			
		";
		$get_reply_eagle_data = db_result($conn_type='pdo',$conn_mssr,$sql,array(),$arry_conn_mssr);
		$w = 0;
		foreach($get_reply_eagle_data as $key => $get_reply_eagle_data){
			$reply_eagle_array[$key] = $get_reply_eagle_data['cno'];
			$w++;
		}	
		$reply_eagle_cno = 0;
		for($j=0; $j<count($reply_eagle_array); $j++){
			
			$reply_eagle_cno+=$reply_eagle_array[$j];
		}		
		...
		echo "</br>";
		echo "這些發文產生了多少鷹架回文：".$reply_eagle_cno;
		echo "</br>";
		//-------------------------------------------------
		//按讚->發文
