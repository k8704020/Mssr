    ...
    //---------------------------------------------------
		...
		$sql="
			...
			FROM `mssr_forum`.`dev_complete_mission_log` as a
				...
				LEFT JOIN  `user`.`school` AS sch1 ON ( sch1.`school_code` = sem1.`school_code` )
			WHERE 
				a.`group_task_id` =6 and a.`deliver_uid`=5030
				and sem1.`semester_code` like '%2015_2%'
				and p.`status` in ('i_s','i_t')
				AND c1.`class_code` in(				'gdc_2015_2_3_5_1','gps_2015_2_3_2_1','gps_2015_2_3_3_1','gps_2015_2_3_5_1','cyc_2015_2_4_1_3','cyc_2015_2_4_2_3','jdy_2015_2_4_1_2','jdy_2015_2_4_2_2','smb_2015_2_3_4_1','cjh_2015_2_3_1_2','cjh_2015_2_4_1_2','cjh_2015_2_5_1_2','nep_2015_2_4_1_1','nep_2015_2_4_2_1','nsa_2015_2_4_3_1','zbq_2015_2_3_1_2','zbq_2015_2_3_2_2','zbq_2015_2_3_3_2','zbq_2015_2_4_2_2','zbq_2015_2_4_3_2','pqr_2015_2_3_2_1','pqr_2015_2_4_1_1','pqr_2015_2_5_4_1','pqr_2015_2_3_3_1','wbp_2015_2_3_10_1','wbp_2015_2_3_2_1','wbp_2015_2_3_8_1','ctc_2015_2_3_10_1','lrb_2015_2_4_3_2' 
				)
				GROUP BY a.`master_ctask_id`
		";
		...
		$sql="
			...
			FROM `mssr_forum`.`dev_complete_mission_log` as a
				...
				LEFT JOIN  `user`.`school` AS sch1 ON ( sch1.`school_code` = sem1.`school_code` )
			WHERE 
				a.`group_task_id` =6 and a.`deliver_uid` in ($output1)
				and sem1.`semester_code` like '%2015_2%' 
				and p.`status` in ('i_s','i_t') 
			GROUP BY a.`master_ctask_id`
		";
		...
		$sql="
			...
			FROM `mssr_forum`.`dev_complete_mission_log` as a
				...
				LEFT JOIN  `user`.`school` AS sch1 ON ( sch1.`school_code` = sem1.`school_code` )
			WHERE 
				a.`group_task_id` =6 and a.`deliver_uid` in ($output2)
				and sem1.`semester_code` like '%2015_2%' 
				and p.`status` in ('i_s','i_t') 
			GROUP BY a.`master_ctask_id`
		";
