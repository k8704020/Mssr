            ...
            <div class="user_lefe_side col-xs-12 col-sm-10 col-md-10 col-lg-10">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    ...
                    <?php if($sess_user_id===$user_id):?>
                        ...
                        <?php endif;?>
                    <?php endif;?>
					<li role="presentation" class="<?php if($tab===9)echo 'active';?> achievement"><a href="#achievement" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">
                        個人成就
					</a></li>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-2 book_thumbnail_col" book_sid='<?php echo addslashes($rs_book_sid);?>'>
                                    ...
                                    >
                                        ...
                                        <a href="article.php?get_from=1&book_sid=<?php echo addslashes($rs_book_sid);?>">
                                            ...
                                            <div class="caption" style="width:90px;"><?php echo htmlspecialchars($rs_book_name);?></div>
                                        </a>
                                    </div>
                                </div>
                                <?php endforeach;}?>
...
//-------------------------------------------------------
    ...
    $('.group_mission').click(function(){
        ...
        var _html='';
        _html+='<div id="All-div">';
            _html+='<iframe src="Eric/main_group_mission.php" name="mainframe" width="100%" height="850px" marginwidth="0" marginheight="0" scrolling="No" frameborder="0" id="mainframe" ></iframe>';
        _html+='</div>';
        $('#group_mission').html(_html);
    });

	$(".achieve-button").click(function(){
 	  /*function show_achievement($(this).val());
		alert($(this).val()); */
	});

	function show_achievement(i){
