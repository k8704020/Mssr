                    ...
                    ?>
                        <div class="row">
                            ...
                            style="border:1px solid #e7e7e7;background-color:#ffeaea;padding:10px;">
                                ...
                                <p><u><strong><a href='_dev_group_mission.php?get_from=3&group_task_id=<?php echo $rs_group_task_id;?>'>點我前往參加</a></strong></u></p>
                            </div>
                        </div>
                    <?php endforeach;?>
                <?php endif;?>
                ...
                <?php if(isset($wall_results)&&!empty($wall_results)):?>
                    ...
                    foreach($wall_results as $rs_time=>$wall_result):
                        ...
                        if($rs_group_id!==0){
                            ...
                            if(!empty($db_results)){
                                if((int)($db_results[0]['group_state'])!==1)continue;
                            }
                        }
