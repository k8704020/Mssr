<?php
//-------------------------------------------------------
//函式: get_class_user_read_frequency_detail_info()
//用途: 取得班級人員閱讀次數
//日期: 2015年07月30日
//作者: mssr_team@cl_ncu
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        function get_class_user_read_frequency_detail_info($arry_class_code,$start_time,$end_time){
        //-----------------------------------------------
        //函式: get_class_user_read_frequency_detail_info()
        //用途: 取得班級人員閱讀次數
        //-----------------------------------------------
        ...
        //-----------------------------------------------
            ...
            //$end_time         結束時間
                ...
                if(!isset($arry_class_code)||(!is_array($arry_class_code))||(empty($arry_class_code))){
                    $err='GET_CLASS_USER_READ_FREQUENCY_DETAIL_INFO:NO ARRY_CLASS_CODE';
                    die($err);
                }else{
                ...
                if(!isset($start_time)||(trim($start_time)==='')){
                    $err='GET_CLASS_USER_READ_FREQUENCY_DETAIL_INFO:NO START_TIME';
                    die($err);
                }else{
                ...
                if(!isset($end_time)||(trim($end_time)==='')){
                    $err='GET_CLASS_USER_READ_FREQUENCY_DETAIL_INFO:NO END_TIME';
                    die($err);
                }else{
                ...
                try{
                    ...
                    $err ='GET_CLASS_USER_READ_FREQUENCY_DETAIL_INFO:CONNECT FAIL';
                    die($err);
                }
            ...
            //$end_time         結束時間
                ...
                $arry_class_user_read_frequency_detail=array();
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    if(empty($db_results)){
                        $err='GET_CLASS_USER_READ_FREQUENCY_DETAIL_INFO:CLASS_CODE ERROR';
                        die($err);
                    }
                ...
                //---------------------------------------
                    ...
                    foreach($arry_uid as $rs_uid){
                        ...
                        $arry_class_user_read_frequency_detail[$rs_uid]=count($db_results);
                    }


                    //回傳
                    return $arry_class_user_read_frequency_detail;
        }
?>