<?php
//-------------------------------------------------------
//函式: get_class_user_rec_group_detail_info()
//用途: 取得班級人員推薦本數
//日期: 2015年07月30日
//作者: mssr_team@cl_ncu
//-------------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        function get_class_user_rec_group_detail_info($arry_class_code,$start_time,$end_time){
        //-----------------------------------------------
        //函式: get_class_user_rec_group_detail_info()
        //用途: 取得班級人員推薦本數
        //-----------------------------------------------
        ...
        //-----------------------------------------------
            ...
            //$end_time         結束時間
                ...
                if(!isset($arry_class_code)||(!is_array($arry_class_code))||(empty($arry_class_code))){
                    $err='GET_CLASS_USER_REC_GROUP_DETAIL_INFO:NO ARRY_CLASS_CODE';
                    die($err);
                }else{
                ...
                if(!isset($start_time)||(trim($start_time)==='')){
                    $err='GET_CLASS_USER_REC_GROUP_DETAIL_INFO:NO START_TIME';
                    die($err);
                }else{
                ...
                if(!isset($end_time)||(trim($end_time)==='')){
                    $err='GET_CLASS_USER_REC_GROUP_DETAIL_INFO:NO END_TIME';
                    die($err);
                }else{
                ...
                try{
                    ...
                    $err ='GET_CLASS_USER_REC_GROUP_DETAIL_INFO:CONNECT FAIL';
                    die($err);
                }
            ...
            //$end_time         結束時間
                ...
                $arry_class_user_rec_group_detail=array();
            ...
            //-------------------------------------------
                ...
                //---------------------------------------
                    ...
                    if(empty($db_results)){
                        $err='GET_CLASS_USER_REC_GROUP_DETAIL_INFO:CLASS_CODE ERROR';
                        die($err);
                    }
                ...
                //---------------------------------------
                    ...
                    foreach($arry_uid as $rs_uid){
                        ...
                        $sql="
                            ...
                            WHERE 1=1
                                AND `mssr`.`mssr_rec_book_cno`.`keyin_cdate` BETWEEN '{$start_time}' AND '{$end_time}'
                                AND `mssr`.`mssr_rec_book_cno`.`user_id` = {$rs_uid}
                        ...
                        $arry_class_user_rec_group_detail[$rs_uid]=count($db_results);
                    }


                    //回傳
                    return $arry_class_user_rec_group_detail;
        }
?>