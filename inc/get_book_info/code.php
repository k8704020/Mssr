...
//-------------------------------------------------------
    ...
    function get_book_info($conn='',$book_sid,$array_filter=array(),$arry_conn){
    //---------------------------------------------------
    //函式: get_book_info()
    //用途: 提取書本資訊
    //---------------------------------------------------
    ...
    //---------------------------------------------------
        ...
        if(preg_match("/^mbc/i",$book_sid)){
            switch(empty($array_filter)){
                ...
                default:
                    foreach($array_filter as $inx=>$filter)if(trim($filter)==='book_library_code')unset($array_filter[$inx]);
